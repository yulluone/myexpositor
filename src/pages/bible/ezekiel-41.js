...
export default function Ezekiel41() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos9622173">
        CHAPTER 41
      </h3>
      <h3 className="calibre_17">(574 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE MEASURING OF THE TEMPLE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Afterward He brought me to the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And the breadth of the Door was ten
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/john-10" scrollToId="#filepos12511514">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 10:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. The Holy Place was sixty feet long and thirty feet wide. This
                was the same dimensions as Solomons Temple.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Then went He inward, and measured the
          post of the Door, two cubits; and the Door, six cubits; and the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                only once a year; therefore, Christ, it seems, went in Alone,
                leaving Ezekiel outside.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The height of the Door is six cubits; this refers to Christ as
                the Door to Salvation, i.e., mans approach to God, since six is
                mans number; the width of the Door is seven cubits, which
                portrays Gods Perfect Salvation in Christ, Gods Number being
                seven, which speaks of perfection.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos9624774">
        <span className="bold1">
          <sup className="calibre7">4</sup>So He measured the length thereof,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                At Solomons Temple, the Altar was thirty feet long and thirty
                feet wide, the same size as the Most Holy Place. However, in the
                Millennial Temple, the Altar will be smaller than the Most Holy
                Place, only eighteen feet square.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Solomons Altar was larger because it represented a price yet to
                be paid, while the Altar in the Millennial Temple is smaller,
                thereby representing a price already paid [
                <ScrollLink href="/chronicles2-04" scrollToId="#filepos4689100">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Chron. 4:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/ezekiel-43" scrollToId="#filepos9655369">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ezek. 43:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>After He measured the wall of the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                the True Temple. In other words, this House is secure, whereas
                the house built by man fell!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And the side Chambers were three, one
          over another, and thirty in order; and they entered into the wall
          which was of the House for the side Chambers round about, that they
          might have hold, but they had not hold in the wall of the House.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And there was an enlarging, and a
          winding about still upward to the side Chambers: for the winding about
          of the House went still upward round about the House: therefore the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>I saw also the height of the House
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>The thickness of the wall, which was
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                structure of Salvation and the reign of Christ as being
                absolutely secure and eternal in its consequence.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And between the Chambers was the
          wideness of twenty cubits round about the House on every side.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And the doors of the side Chambers
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now the building that was before the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Chambers, stood; it was most likely devoted to less sacred
                purposes. Actually, behind Solomons Temple lay a similar space [
                <ScrollLink href="/kings2-23" scrollToId="#filepos4335070">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Ki. 23:11</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/chronicles1-26" scrollToId="#filepos4626018">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Chron. 26:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>So He measured the House, an hundred
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Also the breadth of the face of the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Calvary for the human family in order that men may be Saved.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And He measured the length of the
          building over against the separate place which was behind it, and the
      ...
      <p className="calibre_20">
        <span className="bold1">DETAILS ABOUT THE INTERIOR OF THE TEMPLE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">16</sup>The door posts, and the narrow
      ...
      <p className="calibre_21" id="filepos9631018">
        <span className="bold1">
          <sup className="calibre7">17</sup>To that above the door, even unto
          the inner House, and without, and by all the wall round about within
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Christ, when God became Man in order to become the Last Adam,
                and to redeem humanity.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And it was made with Cherubims and
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/kings1-06" scrollToId="#filepos3765036">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 6:29</span>
                    </span>
                  </span>
                </ScrollLink>
                ], the wainscotting was adorned with artistic coverings of
                Cherubims and Palm Trees, a Palm Tree and a Cherub standing
                alternately. As the wood denoted Christs humanity, likewise, the
                Cherubims denote His Holiness. The Palm Trees denote the lifting
                of the curse from the Earth and from man, with harmony now
                prevailing, typifying rest)
              </span>
            </span>
          </span>
          ;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>So that the face of a man was toward
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The phrase, And the face of a young lion toward the Palm Tree on
                the other side, refers to Christ coming as a Lion from the Tribe
                of Judah [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>From the ground unto above the door
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ], the Holy of Holies will be the symbols.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>The posts of the Temple were
          squared, and the face of the Sanctuary; the appearance of the one as
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                now, in the Kingdom Age, are reality, hence, the appearance of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>The Altar of wood was three cubits
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                of the Holy of Holies, exactly where it sat in the Tabernacle
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And the Temple and the Sanctuary had
          two doors.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And the doors had two leaves apiece,
          two turning leaves; two leaves for the one door, and two leaves for
          the other door.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And there were made on them, on the
          doors of the Temple, Cherubims and Palm Trees, like as were made upon
          the walls; and there were thick planks upon the face of the Porch
          without.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And there were narrow windows and
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                longer necessary. The implication is this: the abundance of gold
                made Solomons Temple beautiful; however, Christ will so far
                eclipse the luster of mere gold that even if gold were present,
                it would not be noticed for the Glory of the Lord.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_912"></div>
    </div>
  );
}
