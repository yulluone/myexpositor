...
export default function Ezra10() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos5117605">
        CHAPTER 10
      </h3>
      <h3 className="calibre_17">(457 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">REPENTANCE RESULTS IN SEPARATION FROM SIN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now when Ezra had prayed, and when he
          had confessed, weeping and casting himself down before the House of
          God, there assembled unto him out of Israel a very great congregation
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And Shechaniah the son of Jehiel, one
          of the sons of Elam, answered and said unto Ezra, We have trespassed
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Now therefore let us make a Covenant
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Arise; for this matter belongs unto
          you{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos5119701">
        <span className="bold1">
          <sup className="calibre7">5</sup>Then arose Ezra, and made the Chief
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Then Ezra rose up from before the
          ...
          water: for he mourned because of the transgression of them who had
          been carried away{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And they made proclamation throughout
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And that whosoever would not come
          within three days, according to the counsel of the princes and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Then all the men of Judah and
      ...
      <p className="calibre_21" id="filepos5121893">
        <span className="bold1">
          <sup className="calibre7">10</sup>And Ezra the Priest stood up, and
          said unto them, You have transgressed, and have taken strange wives,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Now therefore make confession unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Then all the congregation answered
          and said with a loud voice, As you have said, so must we do.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>But the people are many, and it is a
          time of much rain, and we are not able to stand without, neither is
          this a work of one day or two: for we are many who have transgressed
          in this thing{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Let now our rulers of all the
          congregation stand, and let all them who have taken strange wives in
          our cities come at appointed times, and with them the elders of every
          city, and the judges thereof, until the fierce wrath of our God for
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                which would have given them a claim to remain, which would
                extend to the mothers as well)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Only Jonathan the son of Asahel and
          Jahaziah the son of Tikvah were employed about this matter: and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And the children of the captivity
          did so. And Ezra the Priest, with certain chief of the fathers, after
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And they made an end with all the
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">18</sup>And among the sons of the Priests
          there were found who had taken strange wives: namely, of the sons of
          Jeshua the son of Jozadak, and his brethren; Maaseiah, the Eliezer,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And they gave their hands that they
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And of the sons of Immer; Hanani,
          and Zebadiah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And of the sons of Harim; Maaseiah,
          and Elijah, and Shemaiah, and Jehiel, and Uzziah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And of the sons of Pashur; Elioenai,
          Maaseiah, Ishmael, Nethaneel, Jozabad, and Elasah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Also of the Levites; Jozabad, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>Of the singers also; Eliashib: and
          of the porters; Shallum, and Telem, and Uri.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>Moreover of Israel: of the sons of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And of the sons of Elam; Mattaniah,
          Zechariah, and Jehiel, and Abdi, and Jeremoth, and Eliah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And of the sons of Zattu; Elioenai,
          Eliashib, Mattaniah, and Jeremoth, and Zabad, and Aziza.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>Of the sons also of Bebai;
          Jehohanan, Hananiah, Zabbai, and Athlai.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>And of the sons of Bani; Meshullam,
          Malluch, and Adaiah, Jashub, and Sheal, and Ramoth.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And of the sons of Pahath-moab;
          Adna, and Chelal, Benaiah, Maaseiah, Mattaniah, Bezaleel, and Binnui,
          and Manasseh.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And of the sons of Harim; Eliezer,
          Ishijah, Malchiah, Shemaiah, Shimeon,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>Benjamin, Malluch, and Shemariah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>Of the sons of Hashum; Mattenai,
          Mattathah, Zabad, Eliphelet, Jeremai, Manasseh, and Shimei.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>Of the sons of Bani; Maadai, Amram,
          and Uel,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>Benaiah, Bedeiah, Chelluh,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">36</sup>Vaniah, Meremoth, Eliashib,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">37</sup>Mattaniah, Mattenai, and Jaasau,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">38</sup>And Bani, and Binnui, Shimei,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">39</sup>And Shelemiah, and Nathan, and
          Adaiah,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">40</sup>Machnadebai, Shashai, Sharai,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">41</sup>Azareel, and Shelemiah, Shemariah,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">42</sup>Shallum, Amariah, and Joseph.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">43</sup>Of the sons of Nebo; Jeiel,
          Mattithiah, Zabad, Zebina, Jadau, and Joel, Benaiah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">44</sup>All these had taken strange wives:
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                awful sin really is, and of any description.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_459"></div>
    </div>
  );
}
