...
export default function Ephesians6() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14067096">
        CHAPTER 6
      </h3>
      <h3 className="calibre_17">(A.D. 64)</h3>
      <p className="calibre_20">
        <span className="bold1">DUTIES OF CHILDREN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Children, obey your parents in the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>That it may be well with you, and you
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/deuteronmy-05" scrollToId="#filepos2176567">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 5:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                ...
                ], as should be obvious, failure to obey carries a penalty)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">4</sup>And, you Fathers, provoke not your
          children to wrath{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">SERVANTS AND MASTERS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>With good will doing service, as to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Knowing that whatsoever good thing
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And, you masters, do the same things
      ...
      <p className="calibre_20">
        <span className="bold1">SPIRITUAL WARFARE</span>
      </p>
      <p className="calibre_18" id="filepos14071734">
        <span className="bold1">
          <sup className="calibre7">10</sup>Finally, my Brethren, be strong in
          the Lord{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14072573">
        <span className="bold1">
          <sup className="calibre7">12</sup>For we wrestle not against flesh and
          blood{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">RESOURCES</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">13</sup>Wherefore take unto you the whole
          Armour of God{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Stand therefore, having your loins
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And your feet shod with the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Above all, taking the Shield of
          Faith{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14075012">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14075455">
        <span className="bold1">
          <sup className="calibre7">18</sup>Praying always with all prayer and
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/luke-18" scrollToId="#filepos12108457">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lk. 18:1-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">21</sup>But that you also may know my
          affairs,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Whom I have sent unto you for the
          same purpose, that you might know our affairs, and{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">tha</span>
            </span>
          </span>{" "}
          t he might comfort your hearts.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Peace{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>Grace{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">be</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1222"></div>
    </div>
  );
}
