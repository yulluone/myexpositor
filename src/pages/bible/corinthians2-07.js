...
export default function Corinthians207() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13837187">
        CHAPTER 7
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">A HOLY MINISTRY</span>
      </p>
      <p className="calibre_18" id="filepos13837366">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], which refers to looking to the Cross, and looking to the
                Cross exclusively)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">PAULS JOY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          ...
          ; we have wronged no man, we have corrupted no man, we have defrauded
          no man.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>I speak not{" "}
          <span className="italic1">
            <span>
          ...
          : for I have said before, that you are in our hearts to die and live
          with{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">you</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Great{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>For, when we were come into
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Nevertheless God, Who comforts those
          who are cast down{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And not by his coming only, but by
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For though I made you sorry with a
          Letter{" "}
          <span className="italic1">
            <span>
          ...
          : for I perceive that the same Epistle has made you sorry, though{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Now I rejoice, not that you were made
      ...
      <p className="calibre_21" id="filepos13844995">
        <span className="bold1">
          <sup className="calibre7">12</sup>Wherefore, though I wrote unto you,{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">I did it</span>
            </span>
          </span>{" "}
          not for his cause who had done the wrong, nor for his cause who
          suffered wrong{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], and his father who had been wronged, the husband of the woman
                in question)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Therefore we were comforted in your
          comfort{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          : yes, and exceedingly the more joyed we for the joy of Titus, because
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>For if I have boasted any thing to
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">I made</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And his inward affection is more
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>I rejoice therefore that I have
          confidence in you in all{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">things.</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1200"></div>
    </div>
  );
}
