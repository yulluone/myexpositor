...
export default function Ephesians1() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13992475">
        CHAPTER 1
      </h3>
      ...
      <p className="calibre_20">
        <span className="bold1">SPIRITUAL BLESSINGS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Having predestinated us unto the
      ...
      <p className="calibre_21" id="filepos13995969">
        <span className="bold1">
          <sup className="calibre7">6</sup>To the praise of the Glory of His
          Grace{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13996322">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Having made known unto us the mystery
          of His Will{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos13997742">
        <span className="bold1">
          <sup className="calibre7">10</sup>That in the dispensation of the
          fulness of times{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>That we should be to the praise of
          His Glory{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">trusted,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>Wherefore I also, after I heard of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>That the God of our Lord Jesus
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>The eyes of your understanding being
          enlightened{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And what{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos14003710">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Far above all principality, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And has put all{" "}
          <span className="italic1">
            <span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1217"></div>
    </div>
  );
}
