...
export default function Corinthians203() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13794254">
        CHAPTER 3
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Do we begin again to commend
          ourselves?{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>You are our Epistle written in our
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">Forasmuch as you are</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And such trust have we through Christ
          to God-ward{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Not that we are sufficient of
      ...
      <p className="calibre_20">
        <span className="bold1">NEW TESTAMENT</span>
      </p>
      <p className="calibre_18" id="filepos13796789">
        <span className="bold1">
          <sup className="calibre7">6</sup>Who also has made us able Ministers
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>How shall not the ministration of the
      ...
      <p className="calibre_20">
        <span className="bold1">GLORY AND RIGHTEOUSNESS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">9</sup>For if the ministration of
          condemnation{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                false teachers had come from Jerusalem, attempting to extol the
                so-called virtues of the Law; in other words, they were trying
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>For even that which was made
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>For if that which is done away{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">TRANSFORMATION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13800454">
        <span className="bold1">
          <sup className="calibre7">13</sup>And not as Moses,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          : for until this day remains the same veil untaken away in the reading
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">veil</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>But even unto this day, when Moses
          is read{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Nevertheless when it shall turn to
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1196"></div>
    </div>
  );
}
