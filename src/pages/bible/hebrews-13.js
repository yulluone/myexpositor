...
export default function Hebrews13() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14594276">
        CHAPTER 13
      </h3>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Be not forgetful to entertain
          strangers{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos14595613">
        <span className="bold1">
          <sup className="calibre7">4</sup>Marriage{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos14596058">
        <span className="bold1">
          <sup className="calibre7">5</sup>
          <span className="italic1">
            <span>
              <span className="calibre_19">Let your</span>
            </span>
          </span>{" "}
          conversation{" "}
          <span className="italic1">
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/colossians-3" scrollToId="#filepos14167229">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Col. 3:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/joshua-01" scrollToId="#filepos2472626">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Josh. 1:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/chronicles1-28" scrollToId="#filepos4648381">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Chron. 28:20</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>So that we may boldly say, The Lord{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/psalm-118" scrollToId="#filepos6526619">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 118:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_20">
        <span className="bold1">MINISTERS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>Remember them which have the rule
          over you{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">JESUS CHRIST</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">8</sup>Jesus Christ the same yesterday, and
          today, and forever.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Be not carried about with divers and
          strange doctrines.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">ALTARS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14600059">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14600754">
        <span className="bold1">
          <sup className="calibre7">12</sup>Wherefore Jesus also, that He might
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                this point also [
                <ScrollLink href="/matthew-27" scrollToId="#filepos11311307">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 27:32</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/john-19" scrollToId="#filepos12700663">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 19:20</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Let us go forth therefore unto Him
          without the camp{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos14602305">
        <span className="bold1">
          <sup className="calibre7">15</sup>By Him therefore let us offer the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                fact that this will never change, meaning the Cross will ever
                abide as the foundation of all things pertaining to God)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>But to do good and to communicate
          forget not{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                others. This brings grief to the True Preacher.)
              </span>
            </span>
          </span>
        </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/romans-15" scrollToId="#filepos13519823">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 15:30</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/ephesians-6" scrollToId="#filepos14075455">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Eph. 6:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/colossians-4" scrollToId="#filepos14178019">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Col. 4:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink
                  ...
                  scrollToId="#filepos14230208"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Thess. 5:25</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink
                  ...
                  scrollToId="#filepos14249409"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Thess. 3:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>But I beseech{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_18" id="filepos14606342">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Make you perfect in every good work
          to do His Will{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And I beseech you, Brethren, suffer
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Know ye that{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">our</span>
            </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                know two things extensively so, and I speak of the Law of Moses
                and the Cross of Christ. Only Paul fit this description.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>Grace{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">be</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1284"></div>
    </div>
  );
}
