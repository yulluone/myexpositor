...
export default function Exodus06() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos743068">
        CHAPTER 6
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(1619 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">THE COVENANT</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then the LORD said unto Moses, Now
          shall you see what I will do to Pharaoh: for with a strong hand shall
          He{" "}
      ...
      <p className="calibre_21" id="filepos743997">
        <span className="bold1">
          <sup className="calibre7">2</sup>And God spoke unto Moses, and said
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                outcome of good over evil and, instead of being harassed by the
                fiery darts which the Evil One now hurls against us, we ought to
                rest on the assuring Promise that The God of Peace shall bruise
                Satan under your feet shortly [
                <ScrollLink href="/romans-16" scrollToId="#filepos13529111">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 16:20</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And I appeared unto Abraham, unto
      ...
      <p className="calibre_21" id="filepos745250">
        <span className="bold1">
          <sup className="calibre7">4</sup>And I have also established My
          Covenant with them{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And I have also heard the groaning of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ,{" "}
                <ScrollLink href="/" scrollToId="#filepos746703">
                  <span className="calibre_19">
                    <span>
                ...
                ]; and seven times He utters the great words, I will, [
                <ScrollLink href="/" scrollToId="#filepos746703">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Vss. 6-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; and three times He declares, I have, [
                <ScrollLink href="/" scrollToId="#filepos745250">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Vss. 4-5</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21" id="filepos746703">
        <span className="bold1">
          <sup className="calibre7">6</sup>Wherefore say unto the Children of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                not yield to the Band-Aids of man; they will only yield to a
                superior force, and the only superior force in the universe is
                the Lord Jesus Christ; the Source of deliverance is always
                Christ, while the Means of deliverance is always the Cross [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And I will take you to Me for a
          people, and I will be to you a God: and you shall know that I am the
          LORD your God, which brings you out from under the burdens of the
          Egyptians.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/exodus-12" scrollToId="#filepos822857">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">12:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/exodus-12" scrollToId="#filepos827316">
                  <span className="calibre_19">
                    <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And I will bring you in unto the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And Moses spoke so unto the Children
          of Israel: but they hearkened not unto Moses for anguish of spirit,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                be cheered even by the gracious Promises and Assurances which
                Moses was commissioned to give. The Samaritan version of this
                account says: And they said to Moses, Let us alone, let us serve
                the Egyptians; for it is better for us to serve the Egyptians
                than die in a wilderness.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Lest we think of the Israelites too harshly, we should look at
                ourselves. As evidenced here, the Promises of God do not mean a
                problem-free environment. The Lord allows the problems to teach
                us trust and obedience. But all too often we allow the problems
                to stop us from receiving Gods best.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And the LORD spoke unto Moses,
          saying,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Go in, speak unto Pharaoh king of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                beginning does not mean they arent going to yield. We are to
                stand our ground, keep believing that what Jesus did at the
                Cross is sufficient, which it most certainly is, and keep
                commanding the Evil One to go.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And Moses spoke before the LORD,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                doing our very best in any service we have to do for God. His
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the LORD spoke unto Moses and
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Promises of God, and command Satan to leave that which God has
                promised to us. All of this is a perfect example to us.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">GENEALOGIES</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">14</sup>These be the heads of their fathers
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And the sons of Simeon; Jemuel, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And these are the names of the sons
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>The sons of Gershon; Libni, and
          Shimi, according to their families.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And the sons of Kohath; Amram, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And the sons of Merari; Mahali and
          Mushi: these are the families of Levi according to their generations.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Amram took him Jochebed his
          fathers sister to wife; and she bore him Aaron and Moses: and the
          years of the life of Amram were an hundred and thirty and seven years.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And the sons of Izhar; Korah, and
          Nepheg, and Zichri.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And the sons of Uzziel; Mishael, and
          Elzaphan, and Zithri.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And Aaron took him Elisheba,
          daughter of Amminadab, sister of Naashon, to wife; and she bore him
          Nadab, and Abihu, Eleazar, and Ithamar.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And the sons of Korah; Assir, and
          Elkanah, and Abiasaph: these are the families of the Korhites.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And Eleazar Aarons son took him one
          of the daughters of Putiel to wife; and she bore him Phinehas: these
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                records the names of those whom Pharaoh declared to be his
                slaves.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>These are that Aaron and Moses, to
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/exodus-05" scrollToId="#filepos732147">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">5:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>These are they which spoke to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And it came to pass on the day when
          the LORD spoke unto Moses in the land of Egypt,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>That the LORD spoke unto Moses,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And Moses said before the LORD,
      ...
      <div className="mbp_pagebreak" id="calibre_pb_70"></div>
    </div>
  );
}
