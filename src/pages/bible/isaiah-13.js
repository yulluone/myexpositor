...
export default function Isaiah13() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7410427">
        CHAPTER 13
      </h3>
      <h3 className="calibre_17">(712 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE DOOM OF BABYLON PREDICTED</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>The burden of Babylon, which Isaiah
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Jerusalem, which is the Messiahs city.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Lift you up a banner upon the high
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>I have commanded My sanctified ones,
          I have also called My mighty ones for My anger, even them who rejoice
          in My highness.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>The noise of a multitude in the
          mountains, like as of a great people; a tumultuous noise of the
          kingdoms of nations gathered together: the LORD of Hosts musters the
          Host of the battle.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>They come from a far country, from
          the end of the Heaven, even the LORD, and the weapons of His
      ...
      <p className="calibre_20">
        <span className="bold1">JUDGMENT IN THE DAY OF THE LORD</span>
      </p>
      <p className="calibre_18" id="filepos7412562">
        <span className="bold1">
          <sup className="calibre7">6</sup>Howl you; for the day of the LORD is
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Therefore shall all hands be faint,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And they shall be afraid: pangs and
          sorrows shall take hold of them; they shall be in pain as a woman who
          travails: they shall be amazed one at another; their faces shall be as
          flames.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Thess. 5:2-3</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21" id="filepos7413841">
        <span className="bold1">
          <sup className="calibre7">9</sup>Behold, the day of the LORD comes,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>For the stars of heaven and the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/matthew-24" scrollToId="#filepos11231340">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 24:29</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And I will punish the world for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>I will make a man more precious than
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Therefore I will shake the heavens,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                wrath and anger will most definitely be directed toward the
                Earth.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And it shall be as the chased roe,
          and as a sheep that no man takes up: they shall every man turn to his
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Everyone who is found shall be
          thrust through; and everyone who is joined unto them shall fall by the
          sword.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Their children also shall be dashed
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Behold, I will stir up the Medes
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Their bows also shall dash the young
      ...
      <p className="calibre_20">
        <span className="bold1">FINAL DESOLATION OF BABYLON</span>
      </p>
      <p className="calibre_18" id="filepos7418438">
        <span className="bold1">
          <sup className="calibre7">19</sup>And Babylon, the glory of kingdoms,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                relate to the judgment described in{" "}
                <ScrollLink href="/revelation-16" scrollToId="#filepos15060152">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rev. 16:6</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/revelation-18" scrollToId="#filepos15089681">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">18:1-2</span>
                    </span>
                  </span>
                </ScrollLink>
                ; therefore, this Passage does not refer to the invasion by the
                Medes.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>It shall never be inhabited, neither
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], the area shall never be inhabited again. This could not be
                said of the destruction of Babylon in the past; in fact, the
                city continued for several centuries.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>But wild beasts of the desert shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And the wild beasts of the islands
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], there will be certain openings in the Earth where men can
                actually see into eternal Hell. Some have suggested that this
                spot [Babylon] so long used as a site of rebellion against God
                will be one of those openings.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                If so, the words, satyrs and dragons, could refer to demon
                spirits which, at that time, will be visible as one looks down
                into these openings.)
              </span>
            </span>
          </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_755"></div>
    </div>
  );
}
