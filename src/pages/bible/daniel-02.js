...
export default function Daniel02() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos9751475">
        CHAPTER 2
      </h3>
      <h3 className="calibre_17">(603 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">
          NEBUCHADNEZZARS DREAM; HIS WISE MEN CALLED
        </span>
      </p>
      <p className="calibre_18" id="filepos9751689">
        <span className="bold1">
          <sup className="calibre7">1</sup>And in the second year of the reign
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                period took place. The dream which troubled him was sent by the
                Lord.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Then the king commanded to call the
          magicians, and the astrologers, and the sorcerers, and the Chaldeans,
          for to show the king his dreams. So they came and stood before the
          king.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And the king said unto them, I have
          dreamed a dream, and my spirit was troubled to know the dream.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">NEBUCHADNEZZARS DEMAND</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">4</sup>Then spoke the Chaldeans to the king
          in Syriack, O king, live for ever: tell your servants the dream, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>The king answered and said to the
          Chaldeans, The thing is gone from me: if you will not make known unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>But if you show the dream, and the
          interpretation thereof, you shall receive of me gifts and rewards and
          great honour: therefore sh ow me the dream, and the interpretation
          thereof.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>They answered again and said, Let the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>The king answered and said, I know of
          certainty that you would gain the time, because you see the thing is
          gone from me.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>But if you will not make known unto
          me the dream, there is but one decree for you: for you have prepared
          lying and corrupt words to speak before me, till the time be changed:
          therefore tell me the dream, and I shall know that you can show me the
      ...
      <p className="calibre_20">
        <span className="bold1">INABILITY OF THE WISE MEN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>The Chaldeans answered before the
          king, and said, There is not a man upon the earth who can show the
          kings matter: therefore there is no king, lord, nor ruler, who asked
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And it is a rare thing that the king
          requires, and there is none other who can show it before the king,
      ...
      <p className="calibre_20">
        <span className="bold1">NEBUCHADNEZZARS DECREE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>For this cause the king was angry
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the decree went forth that the
      ...
      <p className="calibre_20">
        <span className="bold1">
          DANIELS OFFER TO INTERPRET THE DREAM AND HIS PRAYER FOR HELP
        </span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">14</sup>Then Daniel answered with counsel
          and wisdom to Arioch the captain of the kings guard, which was gone
          forth to slay the wise men of Babylon:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>He answered and said to Arioch the
          kings captain, Why is the decree so hasty from the king? Then Arioch
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Then Daniel went in, and desired of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Then Daniel went to his house, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>That they would desire mercies of
      ...
      <p className="calibre_20">
        <span className="bold1">THE DREAM REVEALED TO DANIEL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>Then was the secret revealed unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Daniel answered and said, Blessed be
      ...
      <p className="calibre_21" id="filepos9759145">
        <span className="bold1">
          <sup className="calibre7">21</sup>And He changes the times and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>He reveals the deep and secret
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                enlightenment [
                <ScrollLink href="/timothy1-6" scrollToId="#filepos14323302">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Tim. 6:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>I thank You, and praise You, O Thou
          God of my fathers, Who has given me wisdom and might, and has made
          known unto me now what we desired of You: for You have now made known
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">24</sup>Therefore Daniel went in unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>Then Arioch brought in Daniel before
          the king in haste, and said thus unto him, I have found a man of the
          captives of Judah, who will make known unto the king the
          interpretation.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>The king answered and said to
          Daniel, whose name was Belteshazzar, Are you able to make known unto
          me the dream which I have seen, and the interpretation thereof?
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>Daniel answered in the presence of
          the king, and said, The secret which the king has demanded cannot the
          wise men, the astrologers, the magicians, the soothsayers, sh ow unto
          the king{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>But there is a God in Heaven Who
          reveals secrets, and makes known to the king Nebuchadnezzar what shall
          be in the latter days. Your dream, and the visions of your head upon
          your bed, are these{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                evidently have not read this Verse)
              </span>
            </span>
          </span>
          ;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>As for you, O king, your thoughts
          came into your mind upon your bed, what should come to pass hereafter:
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>But as for me, this secret is not
          revealed to me for any wisdom that I have more than any living, but
          for their sakes who shall make known the interpretation to the king,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                And that you might know the thoughts of your heart, presents the
                beginning of the appeal of the Holy Spirit to this heathen
                Monarch, which quite possibly ultimately resulted in his
                Salvation.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>You, O king, saw, and behold a great
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                and terrible things often exist side by side. When Christ sets
                up His Millennial Kingdom, only that which is excellent will
                exist.
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The great image would portray all the World Empires for the
                future, at least as they related to Israel.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>This images head was of fine gold,
          his breast and his arms of silver, his belly and his thighs of brass,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>His legs of iron, his feet part of
      ...
      <p className="calibre_21" id="filepos9765091">
        <span className="bold1">
          <sup className="calibre7">34</sup>You saw till that a Stone was cut
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                destroys the popular belief that Christianity will take over the
                world, with the Gospel gradually conquering all of mankind.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Actually, Bible Christianity ultimately will cover the entirety
                of the Earth, but only after the Second Coming, even as this
                Verse proclaims.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos9765906">
        <span className="bold1">
          <sup className="calibre7">35</sup>Then was the iron, the clay, the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                After the Second Coming, Christ will set up His Kingdom of
                Righteousness, with Israel then being the predominant nation in
                the world, and remaining that way forever. Hence, the promises
                made to the Patriarchs and Prophets of old will be fulfilled in
                totality.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">36</sup>This is the dream; and we will tell
          the interpretation thereof before the king.
        </span>
      </p>
      <p className="calibre_21" id="filepos9767065">
        <span className="bold1">
          <sup className="calibre7">37</sup>You, O king, are a king of kings:
          for the God of Heaven has given you a kingdom, power, and strength,
          and glory.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos9767485">
        <span className="bold1">
          <sup className="calibre7">38</sup>And wheresoever the children of men
          dwell, the beasts of the field and the fowls of the heaven has He
          given into your hand, and has made you ruler over them all. You are
          this head of gold.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">
          BREAST AND ARMS OF SILVER: MEDO-PERSIA; BELLY AND THIGHS OF BRASS:
          GRECIA
        </span>
      </p>
      <p className="calibre_18" id="filepos9768057">
        <span className="bold1">
          <sup className="calibre7">39</sup>And after you shall arise another
          kingdom inferior to you, and another third kingdom of brass, which
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                glory, not in strength. The third kingdom mentioned here is the
                Grecian Empire, which will proclaim the rise of Alexander the
                Great. It would come about in a little over two hundred years
                from this time.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">LEGS OF IRON: ROME</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">40</sup>And the fourth kingdom shall be
          strong as iron: forasmuch as iron breaks in pieces and subdues all
          things: and as iron that breaks all these, shall it break in pieces
          and bruise.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">41</sup>And whereas you saw the feet and
          toes, part of the potters clay, and part of iron, the kingdom shall be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">42</sup>And as the toes of the feet were
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">43</sup>And whereas you saw iron mixed with
      ...
      <p className="calibre_18" id="filepos9770850">
        <span className="bold1">
          <sup className="calibre7">44</sup>And in the days of these kings shall
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos9765091">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 34</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/" scrollToId="#filepos9765906">
                  <span className="calibre_19">
                    <span>
                ...
                . It portrays the Coming of the Lord and the Millennial Kingdom,
      ...
      <p className="calibre_21" id="filepos9771544">
        <span className="bold1">
          <sup className="calibre7">45</sup>Forasmuch as you saw that the Stone
          ...
          has made known to the king what shall come to pass hereafter: and the
      ...
      <p className="calibre_20">
        <span className="bold1">DANIEL PROMOTED</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">46</sup>Then the king Nebuchadnezzar fell
          upon his face, and worshipped Daniel, and commanded that they should
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">47</sup>The king answered unto Daniel, and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                greatest, at least as it regards the revealing of secrets.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">48</sup>Then the king made Daniel a great
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">49</sup>Then Daniel requested of the king,
      ...
      <div className="mbp_pagebreak" id="calibre_pb_923"></div>
    </div>
  );
}
