...
export default function Exodus15() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos891076">
        CHAPTER 15
      </h3>
      ...
      <h3 className="calibre_17">THE SONG OF MOSES</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then sang Moses and the Children of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/revelation-15" scrollToId="#filepos15051714">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Revelation 15:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ; this song portrayed in this Chapter is the oldest song of
                praise in existence; its theme is Jehovah Jesus; it begins with
                Redemption, and ends with Glory)
              </span>
            </span>
          </span>
          , I will sing unto the LORD, for He has triumphed gloriously: the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos902097">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Vs. 20</span>
                    </span>
                  </span>
                </ScrollLink>
                ], proclaims at least one of the greatest, if not the greatest,
                means of praise and worship found in the Bible. We know this,
                simply because the Book of Psalms, which contains 150 songs, is
                the longest Book in the Bible. By devoting this much space to
                music and singing, the Holy Spirit is telling us here of its
                value, as it regards the worship of the Lord.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos892764">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos893591">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Pharaohs chariots and his host has He
      ...
      <p className="calibre_21" id="filepos894588">
        <span className="bold1">
          <sup className="calibre7">5</sup>The depths have covered them: they
      ...
      <p className="calibre_21" id="filepos894836">
        <span className="bold1">
          <sup className="calibre7">6</sup>Your Right Hand, O LORD, is become
          glorious in power: Your Right Hand, O LORD, has dashed in pieces the
          enemy.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And in the greatness of Your
          Excellency You have overthrown them who rose up against You: You sent
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                them as stubble, is present tense, and concerns the victory over
                the Egyptians. So, in this Verse, we have an account not only of
                what the Lord has done regarding the Egyptians, but the Promise
                that He will fight thusly for us as well!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And with the blast of Your Nostrils
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Still others have asked the question, Are we justified in taking
                literally the strong expressions of a highly wrought poetical
                description?
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                We definitely are justified. It is the Holy Spirit Who gave
                Moses these very words, and, to be sure, the description in no
                way stretches the truth as it regards what God has done, and,
                above all, what He can do.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>The enemy said, I will pursue, I will
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>You did blow with Your Wind, the Sea
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                water to part, now this new wind, and that which had been
                devised by the Lord, must have arisen contrary to the former
                wind, blowing from the northwest or the north, and thus produced
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Who is like unto You, O LORD, among
          the gods?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>You stretched out Your Right Hand,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>You in Your Mercy have led forth the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Then the dukes of Edom shall be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Fear and dread shall fall upon them;
          by the greatness of Your Arm they shall be as still as a stone; till
          Your People pass over, O LORD, till the people pass over, which You
          have purchased.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]. As these enemy nations feared Israel, likewise, all fallen
                angels and demon spirits, even Satan himself, greatly fear the
                Child of God who understands and knows that he has passed over
                into the inheritance, purchased for us by the Lord Jesus
                Christ.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>You shall bring them in, and plant
          them in the mountain of Your Inheritance, in the place, O LORD, which
          You have made for You to dwell in, in the Sanctuary, O LORD, which
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                has always strained toward this conclusion.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>The LORD shall reign forever and
          ever.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">THE SONG OF MIRIAM</span>
      </p>
      <p className="calibre_18" id="filepos901600">
        <span className="bold1">
          <sup className="calibre7">19</sup>For the horse of Pharaoh went in
      ...
      <p className="calibre_21" id="filepos902097">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Miriam the Prophetess, the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/micah-06" scrollToId="#filepos10363512">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mic. 6:4</span>
                    </span>
                  </span>
                </ScrollLink>
                ] as having had a share in the deliverance of Israel, with her
                claiming the prophetic gift in{" "}
                <ScrollLink href="/numbers-12" scrollToId="#filepos1829847">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Numbers 12:2</span>
                    </span>
                  </span>
                </ScrollLink>
                . Her claim appears to be allowed both in the present Passage,
                and in{" "}
                <ScrollLink href="/numbers-12" scrollToId="#filepos1831654">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Numbers 12:6-8</span>
                    </span>
                  </span>
                </ScrollLink>
                , where the degree of her inspiration, however, is placed below
                that of Moses.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos903132">
        <span className="bold1">
          <sup className="calibre7">21</sup>And Miriam answered them, Sing ye to
          the LORD, for He has triumphed gloriously; the horse and his rider has
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos901600">
                  <span className="calibre_19">
                    <span>
                ...
                . This would have been quite a moment, with all of these women,
                led by Miriam, answering each Verse. Thus, we see how the Lord
                uses the women here in praise and worship, with Miriam also
                being used as a Prophetess.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE BITTER WATERS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">22</sup>So Moses brought Israel from the Red
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And when they came to Marah, they
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                brought us into the place of testing. Further, and we must
                understand, God always has in view our ultimate good. The bitter
                waters of Marah typify life and its disappointments.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos904866">
        <span className="bold1">
          <sup className="calibre7">24</sup>And the people murmured against
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                brought upon us by the Lord portray what is in us. Regrettably,
                it doesnt take much to bring out the unbelief.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos905370">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/acts-05" scrollToId="#filepos12841210">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 5:30</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/acts-10" scrollToId="#filepos12955813">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">10:39</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/acts-13" scrollToId="#filepos13002537">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">13:29</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
      ...
      <p className="calibre_21" id="filepos907139">
        <span className="bold1">
          <sup className="calibre7">26</sup>And said, If you will diligently
          hearken to the Voice of the LORD your God, and will do that which is
          right in His Sight, and will give ear to His Commandments, and keep
          all His Statutes, I will put none of these diseases upon you, which I
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                them perpetually. Looking to Him, we can claim this blessing. As
                well, the healing Promised here has to do not only with physical
                diseases but, as well, of emotional and spiritual diseases. The
                Cross is to be put into the bitter waters of these problems,
                whatever they might be. They can then be made sweet. The name
                LORD, in the Hebrew, as used here, is Jehovah-Ropheka, which
                means Jehovah, the Healer. Jehovah has proven Himself as the
                Deliverer of Israel, and now He proclaims Himself as their
                Healer.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And they came to Elim, where were
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Israel and, futuristically, the Twelve Apostles, on which, in a
                sense, the New Covenant would be built, because they were
                eyewitnesses of Christ, regarding His Life, Ministry,
                Crucifixion, Resurrection, Ascension and, by faith, His
                Exaltation)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/luke-10" scrollToId="#filepos11929093">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lk. 10:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/matthew-11" scrollToId="#filepos10996649">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 11:28</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; as long as the Doctrine is Jesus Christ and Him Crucified,
                which speaks of the foundation, Typed by the twelve wells of
                water, and the Ministry, Typed by the threescore and ten Palm
                Trees, Christ will be found in all His Glory, and will be to the
                Believer what He desires to be)
              </span>
            </span>
          </span>
        </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_79"></div>
    </div>
  );
}
