...
export default function Acts05() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos12827509">
        CHAPTER 5
      </h3>
      <h3 className="calibre_17">(A.D. 33)</h3>
      <p className="calibre_20">
        <span className="bold1">ANANIAS AND SAPPHIRA</span>
      </p>
      <p className="calibre_18" id="filepos12827693">
        <span className="bold1">
          <sup className="calibre7">1</sup>But a certain man named Ananias, with
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And kept back{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos12828587">
        <span className="bold1">
          <sup className="calibre7">3</sup>But Peter said, Ananias, why has
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>While it remained, was it not your
      ...
      <p className="calibre_21" id="filepos12829787">
        <span className="bold1">
          <sup className="calibre7">5</sup>And Ananias hearing these words fell
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And the young men arose, wound him
          up, and carried{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And it was about the space of three
          hours after, when his wife, not knowing what was done, came in.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And Peter answered unto her, Tell me
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Then Peter said unto her, How is it
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Then fell she down straightway at
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And great fear came upon all the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                , we are made to realize that God is to be feared as well as
                praised; also, if it is to be known, the same Judgment is
                happening presently, but not so dramatic; the Holy Spirit is the
                same, so the results have to be the same)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_18" id="filepos12832954">
        <span className="bold1">
          <sup className="calibre7">12</sup>And by the hands of the Apostles
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And of the rest does no man join
          himself to them{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And Believers were the more added to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Insomuch that they brought forth the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>There came also a multitude{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">out</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_18">
        <span className="bold1">
          ...
          , and all they who were with him, (which is the sect of the
      ...
      <p className="calibre_21" id="filepos12835789">
        <span className="bold1">
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>But the Angel of the Lord by night
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/hebrews-01" scrollToId="#filepos14424107">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 1:14</span>
                    </span>
                  </span>
                </ScrollLink>
                ]
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Go, stand and speak in the Temple to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And when they heard{" "}
          <span className="italic1">
            <span>
          ...
          . But the High Priest came, and they who were with Him, and called the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>But when the officers came, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Saying, The prison truly found we
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>Now when the High Priest and the
      ...
      <p className="calibre_20">
        <span className="bold1">ON TRIAL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">25</sup>Then came one and told them, saying,
          Behold, the men whom you put in prison are standing in the Temple, and
          teaching the people{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>Then went the Captain with the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And when they had brought them, they
          set{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">them</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>Saying, Did not we straitly Command
          you that you should not teach in this Name? and, behold, You have
      ...
      <p className="calibre_21" id="filepos12840614">
        <span className="bold1">
          <sup className="calibre7">29</sup>Then Peter and the{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">other</span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                men, all circumstances, and all time)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21" id="filepos12841210">
        <span className="bold1">
          <sup className="calibre7">30</sup>The God of our fathers raised up
          Jesus{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>Him has God exalted with his Right
          Hand{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/ephesians-1" scrollToId="#filepos14003710">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Eph. 1:20</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>And we are His witnesses of these
          things{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>When they heard{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">that,</span>
            </span>
      ...
      <p className="calibre_20">
        <span className="bold1">GAMALIEL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">34</sup>Then stood there up one in the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>And said unto them, You men of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">36</sup>For before these days rose up
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">37</sup>After this man rose up Judas of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">38</sup>And now I say unto you, Refrain from
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">39</sup>But if it be of God, you cannot
          overthrow it{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/acts-04" scrollToId="#filepos12817451">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 4:17-18</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_20">
        <span className="bold1">REJOICING</span>
      </p>
      <p className="calibre_18" id="filepos12847236">
        <span className="bold1">
          <sup className="calibre7">41</sup>And they departed from the presence
          of the Council{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1132"></div>
    </div>
  );
}
