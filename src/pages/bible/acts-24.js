...
export default function Acts24() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13201136">
        CHAPTER 24
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">PAUL BEFORE FELIX</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And after five days Ananias the High
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And when he was called forth,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>We accept{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Notwithstanding, that I be not
          further tedious unto you, I pray you that you would hear us of your
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>For we have found this man a
          pestilent{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Who also has gone about to profane
          the Temple{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>But the Chief Captain Lysias came{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">upon us,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Commanding his accusers to come unto
          you: by examining of whom yourself may take knowledge of all these
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And the Jews also assented, saying
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>Then Paul, after that the Governor
          ...
          , Forasmuch as I know that you have been of many years a judge unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Because that you may understand,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And they neither found me in the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Neither can they prove the things
      ...
      <p className="calibre_21" id="filepos13206736">
        <span className="bold1">
          <sup className="calibre7">14</sup>But this I confess unto you, that
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">toward</span>
            </span>
          </span>{" "}
          men{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Now after many years I came to bring
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Whereupon certain Jews from Asia
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>Who ought to have been here before
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Or else let these same{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Except it be for this one voice,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And when Felix heard these things,
          ...
          , When Lysias the Chief Captain shall come down, I will know the ut
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And he commanded a Centurion to keep
          Paul, and to let{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">him</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And after certain days, when Felix
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-12" scrollToId="#filepos12973976">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 12:1-2</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , Go your way for this time; when I have a convenient season, I will
          call for you{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>He hoped also that money should have
      ...
      <p className="calibre_20">
        <span className="bold1">SILENCE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1151"></div>
    </div>
  );
}
