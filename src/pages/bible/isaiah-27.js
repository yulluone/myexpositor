...
export default function Isaiah27() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7545196">
        CHAPTER 27
      </h3>
      <h3 className="calibre_17">(712 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">SATAN DEFEATED AT ARMAGEDDON</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>In that day the LORD with His sore
          and great and strong sword shall punish Leviathan the piercing
          serpent, even Leviathan that crooked serpent; and He shall kill the
      ...
      <p className="calibre_20">
        <span className="bold1">A MILLENNIAL SONG</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">2</sup>In that day sing you unto her, A
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>I the LORD do keep it; I will water
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Fury is not in Me: who would set the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                effect, it will be a pure Vineyard.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Or let him take hold of My strength,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>He shall cause them who come of Jacob
          to take root: Israel shall blossom and bud, and fill the face of the
          world with fruit.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Has He smitten him, as He smote those
          who smote him? or is he dead according to the slaughter of them who
          are killed by Him?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>In measure, when it shoots forth, you
          will debate with it: he stays his rough wind in the day of the east
          wind.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                destruction. The rough wind was tempered as well as the
                tempestuous and violent east wind.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Israel is the mystery people of the ages. By all logical
                accounts, they should have gone into the dark night long ago;
                nevertheless, despite the ferocious attacks by the enemy, they
                have remained a viable people. It is because of this one Verse!)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos7549244">
        <span className="bold1">
          <sup className="calibre7">9</sup>By this therefore shall the iniquity
          of Jacob be purged; and this is all the fruit to take away his sin;
          when he makes all the stones of the Altar as chalkstones that are
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                This is not necessarily the expiation of guilt by the Atonement
                of Christ, for that has already been done, but it is the purging
                of a branch already in the True Vine [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Yet the defenced city shall be
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                years later. Jerusalem was destroyed again in A.D. 70. And even
                though it was inhabited, and has been from then until now,
                still, for the last 2,000 years, as far as God is concerned,
                spiritually it is left like a wilderness.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>When the boughs thereof are
          withered, they shall be broken off: the women come, and set them on
          fire: for it is a people of no understanding: therefore He Who made
          them will not have mercy on them, and He Who formed them will show
          them no favour.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">ISRAEL WILL BE REGATHERED TO MOUNT ZION</span>
      </p>
      <p className="calibre_18" id="filepos7551567">
        <span className="bold1">
          <sup className="calibre7">12</sup>And it shall come to pass in that
          day, that the LORD shall beat off from the channel of the river unto
          the stream of Egypt, and you shall be gathered one by one, O you
          Children of Israel.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                migration of Jews from all over the world to Israel, and with
                great joy.)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                outcasts will finally come home!)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_769"></div>
    </div>
  );
}
