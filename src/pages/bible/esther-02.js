...
export default function Esther02() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos5276893">
        CHAPTER 2
      </h3>
      <h3 className="calibre_17">(518 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE SEARCH FOR A NEW QUEEN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>After these things, when the wrath of
          king Ahasuerus was appeased, he remembered Vashti, and what she had
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Then said the kings servants who
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And let the king appoint officers in
          all the provinces of his kingdom, that they may gather together all
          the fair young virgins unto Shushan the palace, to the house of the
          women, unto the custody of Hege the kings chamberlain, keeper of the
          women; and let their things for purification be given them:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And let the maiden which pleases the
          king be queen instead of Vashti. And the thing pleased the king; and
          he did so.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">ESTHERS ANCESTRY</span>
      </p>
      <p className="calibre_18" id="filepos5278260">
        <span className="bold1">
          <sup className="calibre7">5</sup>Now in Shushan the palace there was a
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                exiled in some other part of Babylonia, of which the exact
                location is unknown)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Who had been carried away from
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Jerusalem was then burned and the Temple completely destroyed
                all under Nebuchadnezzar.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>So it came to pass, when the kings
          ...
          , that Esther was brought also unto the kings house, to the custody of
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          things for purification, with such things as belonged to her, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Esther had not showed her people nor
          her kindred{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And Mordecai walked every day before
          the court of the womens house, to know how Esther did, and what should
          become of her.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">ESTHER CHOSEN TO BE QUEEN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now when every maids turn was come
          to go in to king Ahasuerus, after that she had been twelve months,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                [a years purification was considered necessary before any maiden
                could approach the king]
              </span>
            </span>
          </span>
          ;)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Then thus came every maiden unto the
          king; whatsoever she desired was given her to go with her out of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>In the evening she went, and on the
          morrow she returned into the second house of the women, to the custody
          of Shaashgaz, the kings chamberlain, which kept the concubines: she
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Now when the turn of Esther, the
          daughter of Abihail the uncle of Mordecai, who had taken her for his
          daughter, was come to go in unto the king, she required nothing but
          ...
          . And Esther obtained favour in the sight of all them who looked upon
          her{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos5284034">
        <span className="bold1">
          <sup className="calibre7">16</sup>So Esther was taken unto king
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                , coupled with this Verse, proclaim to us that four years had
                elapsed between the degradation of Vashti and the enthronement
                of Esther)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And the king loved Esther above all
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of Judah in particular, and the Israelites in general, so as to
                make impossible the advent of the promised Redeemer.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                He was defeated by the hidden Hand of God. The judgment
                threatened in{" "}
                <ScrollLink href="/deuteronmy-31" scrollToId="#filepos2428950">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 31:1618</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                I will hide My Face came to pass; but, though Israel proved
                faithless to Him, He abode faithful to her, for He could not
                deny Himself and, though He hid Himself, yet was the Lords care
                over them as real as ever Williams.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Then the king made a great feast
      ...
      <p className="calibre_20">
        <span className="bold1">MORDECAI SAVES THE KINGS LIFE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>And when the virgins were gathered
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Esther had not yet shown her kindred
          nor her people{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos5287100">
        <span className="bold1">
          <sup className="calibre7">21</sup>In those days, while Mordecai sat in
          the kings gate, two of the kings chamberlains, Bigthan and Teresh, of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And when inquisition was made of the
      ...
      <div className="mbp_pagebreak" id="calibre_pb_478"></div>
    </div>
  );
}
