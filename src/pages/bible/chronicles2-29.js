...
export default function Chronicles229() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos4934383">
        CHAPTER 29
      </h3>
      <h3 className="calibre_17">(726 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">HEZEKIAH REIGNS OVER JUDAH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Hezekiah began to reign when he was
          five and twenty years old, and he reigned nine and twenty years in
          Jerusalem. And his mothers name was Abijah, the daughter of Zechariah.
        </span>
      </p>
      <p className="calibre_21" id="filepos4934810">
        <span className="bold1">
          <sup className="calibre7">2</sup>And he did that which was right in
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Gods eyes, making their own eyes the yardstick)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">REVIVAL UNDER HEZEKIAH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">3</sup>He in the first year of his reign, in
          the first month, opened the doors of the House of the LORD, and
          repaired them.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                House was no longer in use. He began to repair things.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And said unto them, Hear me, you
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Regarding our lives, when given the opportunity, the Holy Spirit
                will always clean us up. Paul said: Let us cleanse ourselves
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>For our fathers have trespassed, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Also they have shut up the doors of
          the porch{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Wherefore the wrath of the LORD was
          upon Judah and Jerusalem, and He has delivered them to trouble, to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For, lo, our fathers have fallen by
          the sword, and our sons and our daughters and our wives are in
          captivity for this{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Now it is in my heart to make a
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>My sons, be not now negligent: for
          the LORD has chosen you to stand before Him, to serve Him, and that
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>Then the Levites arose, Mahath the
          son of Amasai, and Joel the son of Azariah, of the sons of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And of the sons of Elizaphan;
          Shimri, and Jeiel: and of the sons of Asaph; Zechariah, and Mattaniah:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And of the sons of Heman; Jehiel,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                already by hundreds of millions of people for nearly 2,800
                years)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And they gathered their brethren,
          and sanctified themselves, and came, according to the commandment of
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-19" scrollToId="#filepos959982">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 19:22</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                ...
                ; nothing can be spiritually cleansed, unless it is done
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And the Priests went into the inner
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Spiritually, revival must begin in the inner part, which means
                the heart. It is unthinkable that the Temple was in this
                condition, but sadly it was. Is it possible that the modern
                Church is in the same condition now as the Temple of old?)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Now they began on the first day of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Then they went in to Hezekiah the
          king, and said, We have cleansed all the House of the LORD, and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>Moreover all the vessels, which king
          Ahaz in his reign did cast away in his transgression, have we prepared
          and sanctified, and behold, they are before the Altar of the LORD.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">TEMPLE WORSHIP IS RESTORED</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">20</sup>Then Hezekiah the king rose early,
          and gathered the rulers of the city, and went up to the House of the
          LORD.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And they brought seven bullocks, and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Hezekiah to institute seven sacrifices each of the various
                animals. Seven signifies perfection, universality, and totality.
                It is Gods number. It means that Israel was to have a complete
                cleansing. While the Temple could be cleansed of debris, it took
                the shed Blood of the Lamb to properly cleanse from sin. We as
                Believers can prepare the way, but only the Blood can cleanse [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>So they killed the bullocks, and the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/leviticus-04" scrollToId="#filepos1310285">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lev. 4:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/leviticus-04" scrollToId="#filepos1316538">
                  <span className="calibre_19">
                    <span>
                ...
                ,{" "}
                <ScrollLink href="/leviticus-04" scrollToId="#filepos1323243">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">30</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/leviticus-05" scrollToId="#filepos1331829">
                  <span className="calibre_19">
                    <span>
                ...
                ;{" "}
                <ScrollLink href="/leviticus-08" scrollToId="#filepos1381675">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">8:14-15</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/hebrews-09" scrollToId="#filepos14519765">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 9:12-14</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/hebrews-09" scrollToId="#filepos14525725">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">19-22</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And they brought forth the he goats
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                victim, which was a Type of Christ taking our sins on the Cross
                [
                <ScrollLink href="/isaiah-53" scrollToId="#filepos7917676">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isa. 53:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; this is what Paul was speaking of when he mentioned the
      ...
      <p className="calibre_21" id="filepos4947129">
        <span className="bold1">
          <sup className="calibre7">25</sup>And he set the Levites in the House
          of the LORD with cymbals, with psalteries, and with harps, according
          to the commandment of David, and of Gad the kings Seer, and Nathan the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The Bible does not distinguish between a Seer and a Prophet.
                Sometimes both designations are used for the same individual [
                <ScrollLink href="/chronicles1-21" scrollToId="#filepos4578951">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Chron. 21:9</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/" scrollToId="#filepos4947129">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Chron. 29:25</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And the Levites stood with the
          instruments of David, and the Priests with the trumpets.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And Hezekiah commanded to offer the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And all the congregation worshipped,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>And when they had made an end of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>Moreover Hezekiah the king and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>Then Hezekiah answered and said, Now
          you have consecrated yourselves unto the LORD, come near and bring
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>And the number of the Burnt
          Offerings, which the congregation brought, was threescore and ten
          bullocks, an hundred rams, and two hundred lambs: all these were for a
          Burnt Offering to the LORD.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>And the consecrated things were six
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>But the Priests were too few, so
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>And also the Burnt Offerings were in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">36</sup>And Hezekiah rejoiced, and all the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/hebrews-04" scrollToId="#filepos14451568">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 4:7</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <div className="mbp_pagebreak" id="calibre_pb_440"></div>
    </div>
  );
}
