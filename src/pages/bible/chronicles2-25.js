...
export default function Chronicles225() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos4897716">
        CHAPTER 25
      </h3>
      <h3 className="calibre_17">(827 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">AMAZIAH REIGNS OVER JUDAH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Amaziah was twenty and five years old
          when he began to reign, and he reigned twenty and nine years in
          Jerusalem. And his mothers name was Jehoaddan of Jerusalem.
        </span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Now it came to pass, when the kingdom
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>But he killed not their children, but
      ...
      <p className="calibre_20">
        <span className="bold1">AMAZIAH DEFEATS EDOM</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>Moreover Amaziah gathered Judah
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>He hired also an hundred thousand
          mighty men of valour out of Israel for an hundred talents of silver.
        </span>
      </p>
      <p className="calibre_21" id="filepos4899763">
        <span className="bold1">
          <sup className="calibre7">7</sup>But there came a man of God to him,
          saying, O king, let not the army of Israel go with you; for the LORD
      ...
      <p className="calibre_21" id="filepos4900056">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                and{" "}
                <ScrollLink href="/" scrollToId="#filepos4900056">
                  <span className="calibre_19">
                    <span>
                ...
                may be translated: Under no circumstances take Israel, and if
                you do take them, no matter how much you prepare, yet know that
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And Amaziah said to the man of God,
          But what shall we do for the hundred talents which I have given to the
          army of Israel? And the man of God answered, The LORD is able to give
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                the Lord brushes it aside as if nothing)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Then Amaziah separated them, to wit,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And Amaziah strengthened himself,
          and led forth his people, and went to the valley of salt, and smote of
          the children of Seir ten thousand.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And other ten thousand left alive
          did the children of Judah carry away captive, and brought them unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>But the soldiers of the army which
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">14</sup>Now it came to pass, after that
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Wherefore the anger of the LORD was
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Believers who will forsake the Presence of God for other
                things.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , and said, I know that God has determined to destroy you, because you
          have done this, and have not hearkened unto my counsel.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">AMAZIAH MAKES WAR ON ISRAEL</span>
      </p>
      <p className="calibre_18" id="filepos4904791">
        <span className="bold1">
          <sup className="calibre7">17</sup>Then Amaziah king of Judah took
          advice{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          , and sent to Joash, the son of Jehoahaz, the son of Jehu, king of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And Joash king of Israel sent to
          Amaziah king of Judah, saying, The thistle that was in Lebanon sent to
          the cedar that was in Lebanon, saying, Give your daughter to my son to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>You say, Lo, you have smitten the
          Edomites; and your heart lifts you up to boast: abide now at home; why
          should you meddle to your hurt, that you should fall, even you, and
          Judah with you?
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">AMAZIAH IS DEFEATED</span>
      </p>
      <p className="calibre_18" id="filepos4906042">
        <span className="bold1">
          <sup className="calibre7">20</sup>But Amaziah would not hear; for it
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>So Joash the king of Israel went up;
          and they saw one another in the face, both he and Amaziah king of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And Judah was put to the worse
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And Joash the king of Israel took
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And he took all the gold and the
          silver, and all the vessels that were found in the House of God with
          Obed-edom, and the treasures of the kings house, the hostages also,
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/samuel2-06" scrollToId="#filepos3444787">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Sam. 6:10</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/chronicles1-13" scrollToId="#filepos4507309">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Chron. 13:13</span>
                    </span>
                  </span>
                </ScrollLink>
                ], who was a custodian of the treasures in the House of God)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">DEATH OF AMAZIAH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">25</sup>And Amaziah the son of Joash king of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>Now the rest of the acts of Amaziah,
          first and last, behold, are they not written in the book of the kings
          of Judah and Israel?
        </span>
      </p>
      <p className="calibre_21" id="filepos4908372">
        <span className="bold1">
          <sup className="calibre7">27</sup>Now after the time that Amaziah did
          turn away from following the LORD they made a conspiracy against him
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And they brought him upon horses,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Judah. It seems that idol-worship and pride were the cause of
                Amaziahs fall. To be sure, idol-worship and pride are the cause
                of the fall of many Believers.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_436"></div>
    </div>
  );
}
