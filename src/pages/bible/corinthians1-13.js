...
export default function Corinthians113() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13697730">
        CHAPTER 13
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Though I speak with the tongues of
          men and of Angels{" "}
            ...
            <span>
              <span className="calibre_19">
                ...
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 14:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And though I have{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">the Gift of</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21" id="filepos13699365">
        <span className="bold1">
          <sup className="calibre7">3</sup>And though I bestow all my goods to
          feed{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">the poor,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">CHARACTERISTICS</span>
      </p>
      <p className="calibre_18" id="filepos13699972">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">ETERNAL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>But when that which is perfect is
          come{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>When I was a child, I spoke as a
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/john1-4" scrollToId="#filepos14827280">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Jn. 4:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1188"></div>
    </div>
  );
}
