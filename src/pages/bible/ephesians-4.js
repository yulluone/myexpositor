...
export default function Ephesians4() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14030595">
        CHAPTER 4
      </h3>
      <h3 className="calibre_17">(A.D. 64)</h3>
      <p className="calibre_20">
        <span className="bold1">OUR DAILY WALK</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          ...
          , beseech you that you walk worthy of the vocation wherewith you are
          called{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Cross, thereby ever making the Cross the Object of our Faith)
              </span>
            </span>
          </span>
          ,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>With all lowliness and meekness, with
      ...
      <p className="calibre_21" id="filepos14032044">
        <span className="bold1">
          <sup className="calibre7">3</sup>Endeavouring to keep the unity of the
          Spirit{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]; this means that Faith in things other than the Cross is not
                of the Holy Spirit, but rather of spirits)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos14033221">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">THE GIFT OF CHRIST</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>But unto every one of us is given
          Grace{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos14035095">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/psalm-068" scrollToId="#filepos6104594">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 68:18</span>
                    </span>
                  </span>
                </ScrollLink>
                )
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                but when Jesus died on the Cross, the sin debt was paid, and now
                He makes all of these His Captives)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>He Who descended is the same also
          Who ascended{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos14036926">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                leaders of the Church, and do so through the particular Message
                given to them by the Lord for the Church)
              </span>
            </span>
          </span>
          ; and some, Prophets{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">PURPOSE OF THE GIFTS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Till we all come in the unity of the
          Faith{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>That we{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">henceforth</span>
            </span>
          </span>{" "}
          be no more children{" "}
          <span className="italic1">
      ...
      <p className="calibre_20">
        <span className="bold1">MORAL STANDARDS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">17</sup>This I say therefore, and testify in
          the Lord{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/romans-06" scrollToId="#filepos13350311">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 6:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Cross, the Object of ones Faith [
      ...
      <p className="calibre_21" id="filepos14045979">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/romans-06" scrollToId="#filepos13352786">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 6:11</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Christ and Him Crucified is a lie)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>Be ye angry, and sin not: let not
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                by the Holy Spirit; meaning for Him to work, we must ever have
                the Cross as the Object of our Faith)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>Let no corrupt communication proceed
          out of your mouth{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And grieve not the Holy Spirit of
          God{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>Let all bitterness, and wrath, and
      ...
      <p className="calibre_21" id="filepos14050279">
        <span className="bold1">
          <sup className="calibre7">32</sup>And be you kind one to another,
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1220"></div>
    </div>
  );
}
