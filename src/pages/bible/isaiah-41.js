...
export default function Isaiah41() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7738135">
        CHAPTER 41
      </h3>
      <h3 className="calibre_17">(712 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE SOVEREIGNTY OF GOD OVER THE NATIONS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Keep silence before Me, O islands;
          and let the people renew their strength: let them come near; then let
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Who raised up the righteous man from
          the east, called him to his foot, gave the nations before him, and
          made him rule over kings? He gave them as the dust to his sword, and
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                that this righteous man is Abraham, My friend. He was called
                from the east in Righteousness to Jehovahs foot; for God said to
                him, Walk before Me and be thou perfect [
                <ScrollLink href="/genesis-17" scrollToId="#filepos212024">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 17:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. He made him ruler over kings; for they became as dust to his
                sword and as stubble to his bow.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>He pursued them, and passed safely;
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/genesis-14" scrollToId="#filepos177470">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 14:1-3</span>
                    </span>
                  </span>
                </ScrollLink>
                . His passing safely by the way that he had not gone with his
                feet refers to him refusing to take anything from the king of
                Sodom [
                <ScrollLink href="/genesis-14" scrollToId="#filepos187449">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 14:21-24</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. He won the battle with the four kings with his feet. He won
                the battle with the king of Sodom with his spirit. All by the
                Power of the Holy Spirit, the latter victory was greater even
                that the former!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Who has wrought and done it, calling
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                him [
                <ScrollLink href="/hebrews-07" scrollToId="#filepos14489155">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 7:10</span>
                    </span>
                  </span>
                </ScrollLink>
                ].
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                I, Jehovah, the first, and with the Last I Am. This glorious
                title occurs three times in Isaiah and three times in the Book
                of Revelation.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>The isles saw it, and feared; the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                , and the seven nations of idolaters in Canaan, and their appeal
                to their idols for salvation from the victorious soldiers of
                Joshua. Rahab declared that the hearts of the inhabitants of the
                land were melting with terror [
                <ScrollLink href="/joshua-02" scrollToId="#filepos2484767">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Josh. 2:9-11</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. Thus, again, the folly of idolatry is evidenced.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>They helped every one his neighbour;
      ...
      <p className="calibre_21" id="filepos7742258">
        <span className="bold1">
          <sup className="calibre7">7</sup>So the carpenter encouraged the
          goldsmith, and he who smooths with the hammer him who smote the anvil,
          saying, It is ready for the sodering: and he fastened it with nails,
      ...
      <p className="calibre_20">
        <span className="bold1">ISRAEL IS GODS SOVEREIGN CHOICE</span>
      </p>
      <p className="calibre_18" id="filepos7742887">
        <span className="bold1">
          <sup className="calibre7">8</sup>But you, Israel, are My servant,
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/" scrollToId="#filepos7742887">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 8 through 20</span>
                    </span>
                  </span>
                </ScrollLink>
                , the existence and love of an irresistible Power of the God of
                Israel are set out. The name Israel means Prince with God, while
                Jacob means schemer. Gods ever purpose was to change Jacob, the
                schemer into Israel, the Prince with God, which He did!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>You whom I have taken from the ends
          of the Earth, and called you from the chief men thereof, and said unto
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>Fear you not; for I am with you: be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Behold, all they who were incensed
          against you shall be ashamed and confounded: they shall be as nothing;
          and they who strive with you shall perish.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>You shall seek them, and shall not
          find them, even them who contended with you: they who war against you
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Isaiah is saying that all who trust the Lord will be
                vindicated.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For I the LORD your God will hold
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                a little child, thereby giving it protection, the Lord promises
                to do the same for Israel, and for us!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Fear not, you worm Jacob, and you
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The Passage, worm Jacob, is given here so that Israel will
                recognize that such is done, not because they are good, but
                because God is good.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Behold, I will make you a new sharp
          threshing instrument having teeth: you shall thresh the mountains, and
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Promise that God made to the Patriarchs and Prophets will be
                brought to pass.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>You shall fan them, and the wind
          shall carry them away, and the whirlwind shall scatter them: and you
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>When the poor and needy seek water,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                will hear their cries, and that thirst will be forever slaked.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>I will open rivers in the high
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                How so much, and so often, does man attempt to make the
                wilderness fertile, but fail he does, as fail he must! Only
                Christ can do such!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>I will plant in the wilderness the
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/isaiah-61" scrollToId="#filepos8034865">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">61:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>That they may see, and know, and
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">21</sup>Produce your cause, says the LORD;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Let them bring them forth, and sh ow
          us what shall happen: let them show the former things, what they be,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                idol-gods and their votaries to give any clear prediction of
                future events.
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The Bible alone proclaims future events, which means all the
                other so-called holy books are mere works of mens hands idols.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Show the things that are to come
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>Behold, you are of nothing, and your
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                worships, and idolatry and obscenity are one. As the false god
                is abomination, so the True God, the Messiah, is Righteousness;
                not only Righteous, but Righteousness itself.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>I have raised up one from the north,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ;{" "}
                <ScrollLink href="/daniel-01" scrollToId="#filepos9751068">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Dan. 1:21</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/daniel-06" scrollToId="#filepos9836509">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">6:28</span>
                    </span>
                  </span>
                </ScrollLink>
                ; Ezra, Chpt.{" "}
                <ScrollLink href="/ezra-01" scrollToId="#filepos5037985">
                  <span className="calibre_19">
                    <span>
                ...
                ]. This Prophecy was fulfilled about 140 years later. Abraham
                was the man from the east, Cyrus, the man from the north; both
                are types of the Son of Man, Who, in His Second Advent, will
                destroy all idols and all idolaters.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>Who has declared from the beginning,
          that we may know? and before time, that we may say, He is righteous?
          Yes, there is none who shows, yes, there is none who declares, yes,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Verse closes with the statement that not one of the countless
                idols that men worship could declare anything, or reveal
                anything, or could even utter one word. They were all dumb!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>The first shall say to Zion, Behold,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>For I beheld, and there was no man;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Let it ever be understood that outside of the Bible there is no
                counselor.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>Behold, they are all vanity; their
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                through them, against the idols.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_783"></div>
    </div>
  );
}
