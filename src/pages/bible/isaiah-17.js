...
export default function Isaiah17() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7450058">
        CHAPTER 17
      </h3>
      <h3 className="calibre_17">(741 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">AN ORACLE CONCERNING THE RUIN OF DAMASCUS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>The burden of Damascus. Behold,
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/kings2-16" scrollToId="#filepos4229209">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Ki. 16:5-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>The cities of Aroer are forsaken:
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>The fortress also shall cease from
          Ephraim, and the kingdom from Damascus, and the remnant of Syria: they
          shall be as the glory of the children of Israel, says the LORD of
          Hosts.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                In effect, when the Lord speaks of the remnant of Syria being as
                the glory of the Children of Israel, He is using irony.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And in that day it shall come to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And it shall be as when the
          harvestman gathers the corn, and reaps the ears with his arm; and it
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Yet gleaning grapes shall be left in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>At that day shall a man look to his
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And he shall not look to the altars,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>In that day shall his strong cities
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Because you have forgotten the God
          of your Salvation, and have not been mindful of the Rock of your
          strength, therefore shall you plant pleasant plants, and shall set it
          with strange slips{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>In the day shall you make your plant
          to grow, and in the morning shall you make your seed to flourish: but
      ...
      <p className="calibre_21" id="filepos7454885">
        <span className="bold1">
          <sup className="calibre7">12</sup>Woe to the multitude of many people,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                refer to the coming Tribulation, the rise of the Antichrist, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>The nations shall rush like the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And behold at eveningtide trouble;
          and before the morning he is not. This is the portion of them who
      ...
      <div className="mbp_pagebreak" id="calibre_pb_759"></div>
    </div>
  );
}
