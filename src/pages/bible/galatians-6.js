...
export default function Galatians6() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13981821">
        CHAPTER 6
      </h3>
      ...
      <p className="calibre_18" id="filepos13981996">
        <span className="bold1">
          <sup className="calibre7">1</sup>Brethren, if a man be overtaken in a
          fault{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>For if a man think himself to be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>For every man shall bear his own
          burden.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos13984784">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">TWO DESTINIES</span>
      </p>
      <p className="calibre_18" id="filepos13985257">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For he who sows to his flesh shall of
      ...
      <p className="calibre_20">
        <span className="bold1">GLORIFY GOD</span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>As we have therefore opportunity,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>You see how large a letter I have
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                postscript and signing his name.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>As many as desire to make a fair
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For neither they themselves who are
      ...
      <p className="calibre_21" id="filepos13989509">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>For in Christ Jesus neither
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>From henceforth let no man trouble
          me{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/galatians-5" scrollToId="#filepos13972228">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">5:11</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Brethren, the Grace of our Lord
          Jesus Christ{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1214"></div>
    </div>
  );
}
