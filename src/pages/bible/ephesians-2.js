...
export default function Ephesians2() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14005722">
        CHAPTER 2
      </h3>
      <h3 className="calibre_17">(A.D. 64)</h3>
      <p className="calibre_20">
        <span className="bold1">ALIVE IN CHRIST</span>
      </p>
      <p className="calibre_18" id="filepos14005901">
        <span className="bold1">
          <sup className="calibre7">1</sup>And you{" "}
      ...
      <p className="calibre_21" id="filepos14006265">
        <span className="bold1">
          <sup className="calibre7">2</sup>Wherein in time past you walked
      ...
      <p className="calibre_21" id="filepos14008576">
        <span className="bold1">
          <sup className="calibre7">6</sup>And has raised{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ], and is, in fact, the Foundation on which all Doctrine must be
                built.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_18" id="filepos14010259">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14011362">
        <span className="bold1">
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">11</sup>Wherefore remember, that you{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>That at that time you were without
          Christ{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14013172">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14014457">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">contained</span>
            </span>
          </span>{" "}
          in Ordinances{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos14015385">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And came and preached peace to you
          which were afar off{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14016287">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14017374">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14018178">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1218"></div>
    </div>
  );
}
