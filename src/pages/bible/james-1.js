...
export default function James1() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14609829">
        CHAPTER 1
      </h3>
      ...
      <p className="calibre_18" id="filepos14610760">
        <span className="bold1">
          <sup className="calibre7">2</sup>My Brethren, count it all joy when
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Knowing{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>But let patience have{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                and with promptness in granting our requests.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>For let not that man think that he
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>A double minded man{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos14614276">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>For the sun is no sooner risen with
      ...
      <p className="calibre_20">
        <span className="bold1">ENDURANCE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>Blessed{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ], which we can do with the help of the Holy Spirit, Who
                requires that our Faith ever rest in the Cross [
      ...
      <p className="calibre_20">
        <span className="bold1">TEMPTATION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">13</sup>Let no man say when he is tempted, I
          am tempted of God{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>But every man is tempted, when he is
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                bay by the Believer anchoring his Faith in the Cross of Christ,
                which will then give the Holy Spirit latitude to help)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">GODS GOODNESS</span>
      </p>
      <p className="calibre_18" id="filepos14618089">
        <span className="bold1">
          <sup className="calibre7">17</sup>Every good gift and every perfect
          gift is from above{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Of His Own Will begat He us with the
          Word of Truth{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">CHRISTIAN LIVING</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>Wherefore, my beloved Brethren, let
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>For the wrath of man worketh not the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                which demands that the Cross ever be the Object of our Faith; in
                this capacity, the Holy Spirit, without Whom we cannot function,
                will use His Power on our behalf in order to give us victory)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                exactly what James said not to do, deceiving ourselves.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>For if any be a hearer of the word,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>For he beholds himself, and goes his
          way{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>But whoso looks into the perfect Law
          of Liberty{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>If any man among you seem to be
          religious{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , but deceives his own heart, this mans religion{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1287"></div>
    </div>
  );
}
