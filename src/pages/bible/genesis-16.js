...
export default function Genesis16() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos202790">
        CHAPTER 16
      </h3>
      ...
      <h3 className="calibre_17">SARAH AND HAGAR</h3>
      <p className="calibre_18" id="filepos203009">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now Sarai Abrams wife bore him no
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                sets out the faithfulness of God, this Chapter, the
                faithlessness of Abraham)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And Sarai Abrams wife took Hagar her
          maid the Egyptian{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                are opposed to one another; Ishmael is born as the result of
                mans planning and energy; Isaac is born as the result of Gods
                planning and energy; in the birth of Ishmael, God had nothing to
                do with it and, as regards the birth of Isaac, man was dead; so
                it is today, salvation by works entirely depends on mans
                capacity to produce them; Salvation by Faith upon Gods ability
                to perform them; under a covenant of works, God stands still in
                order to see what man can do; under the Covenant of Grace, man
                stands still to see what God has done; the two covenants are
                opposed; it must be either Hagar or Sarah; if Hagar, God has
                nothing to do with it; if Sarah, man has nothing to do with it
                Williams)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                lives that which God desires to do? Or worse still, how much
                does it delay us with what He desires to do?)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And Sarai said unto Abram, My wrong
          be upon you{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                were it for Abraham and the world had he never been born! It is
                disastrous when the self-will plans of the Christian succeed)
              </span>
            </span>
          </span>
          : I have given my maid into your bosom; and when she saw that she had
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>But Abram said unto Sarai, Behold,
          your maid is in your hand; do to her as it pleases you. And when Sarai
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>And the Angel of the LORD found her
          by a fountain of water in the wilderness, by the fountain in the way
          to Shur{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And He said, Hagar, Sarais maid, from
          where did you come? and where will you go? And she said, I flee from
          the face of my mistress Sarai.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And the Angel of the LORD said unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And the Angel of the LORD said unto
          her, I will multiply your seed exceedingly, that it shall not be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And the Angel of the LORD said unto
          her, Behold, you are with child, and you shall bear a son, and shall
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                which was Isaac. Ishmael means God hears; however, it has
                nothing to do with Ishmael, but rather the plight of Hagar.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And he will be a wild man; his hand
          will be against every man, and every mans hand against him; and he
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                the presence of all his brethren [Israel], but do not subdue
                them and, in fact, never will subdue them!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And she called the name of the LORD
          Who spoke unto her{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , your God sees me: for she said, Have I also here looked after Him
          Who sees me?{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                self-will overrode her faith. She wanted her son, Ishmael, to be
                the heir of Promise, but that was not to be. She would even go
                so far, even as we will see, to try to kill Isaac. And so do all
                who reject the Cross follow in her footsteps.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Wherefore the well was called
      ...
      <p className="calibre_21" id="filepos210866">
        <span className="bold1">
          <sup className="calibre7">15</sup>And Hagar bore Abram a son: and
      ...
      <p className="calibre_20">
        <span className="bold1">ISHMAEL IS BORN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">16</sup>And Abram was fourscore and six
          years old{" "}
          <span className="italic1">
            <span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_26"></div>
    </div>
  );
}
