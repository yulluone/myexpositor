...
export default function Acts06() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos12848221">
        CHAPTER 6
      </h3>
      <h3 className="calibre_17">(A.D. 33)</h3>
      <p className="calibre_20">
        <span className="bold1">THE FIRST DEACONS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And in those days, when the number of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Wherefore, brethren, look ye out
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>But we will give ourselves
      ...
      <p className="calibre_21" id="filepos12850578">
        <span className="bold1">
          <sup className="calibre7">5</sup>And the saying pleased the whole
          multitude{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/numbers-27" scrollToId="#filepos2020520">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 27:18-23</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_20">
        <span className="bold1">STEPHEN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Then there arose certain of the
          Synagogue, which is called{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">the Synagogue</span>
            </span>
          </span>{" "}
          of the Libertines{" "}
          <span className="italic1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                hometown of Paul, was in that region)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And they were not able to resist the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                great knowledge of the Law; the difference is that the Holy
                Spirit anointed Stephen!)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And they stirred up the people, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And set up false witnesses, which
          said{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , This man ceases not to speak blas phemous words against this holy
          place, and the Law{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/matthew-24" scrollToId="#filepos11219566">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 24:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1133"></div>
    </div>
  );
}
