...
export default function Acts14() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13016135">
        CHAPTER 14
      </h3>
      <h3 className="calibre_17">(A.D. 45)</h3>
      <p className="calibre_20">
        <span className="bold1">ICONIUM</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And it came to pass in Iconium, that
      ...
      <p className="calibre_21" id="filepos13017273">
        <span className="bold1">
          <sup className="calibre7">3</sup>Long time therefore abode they
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>But the multitude of the city was
          divided{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And when there was an assault made
      ...
      <p className="calibre_20">
        <span className="bold1">LYSTRA</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And there sat a certain man at
          Lystra, impotent in his feet, being a cripple from his mothers womb,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                not only as the Saviour, but the Healer as well)
              </span>
            </span>
          </span>
          ,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And when the people saw what Paul
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And they called Barnabas, Jupiter;
          and Paul, Mercurius{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Then the priest of Jupiter, which
      ...
      <p className="calibre_21" id="filepos13021867">
        <span className="bold1">
          <sup className="calibre7">14</sup>
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And saying, Sirs, why do you these
          things?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                working themselves into a frenzy as someone beats a drum?)
              </span>
            </span>
          </span>{" "}
          ...
          , and preach unto you that you should turn from these vanities unto
          the living God{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Nevertheless He left not Himself
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And with these sayings scarce
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>And there came thither{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Howbeit, as the Disciples stood
          round about him{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And when they had preached the
          Gospel to that city{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          , they returned again to Lystra, and{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13026539">
        <span className="bold1">
          <sup className="calibre7">22</sup>Confirming the souls of the
          Disciples{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And when they had ordained them
          Elders{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE HOME CHURCH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">24</sup>And after they had passed throughout
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And when they had preached the Word
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">27</sup>And when they were come, and had
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1141"></div>
    </div>
  );
}
