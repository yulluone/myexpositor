...
export default function Corinthians210() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13867666">
        CHAPTER 10
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">WARFARE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now I Paul myself beseech you by the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>But I beseech{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13868914">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13869255">
        <span className="bold1">
          <sup className="calibre7">4</sup>(For the weapons of our warfare{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And having in a readiness to revenge
          all disobedience{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Do ye look on things after the
          outward appearance?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          If any man trust to himself that he is Christs, let him of himself
          think this again{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For though I should boast somewhat
          ...
          , which the Lord has given us for edification, and not for your
          destruction{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>That I may not seem as if I would
      ...
      <p className="calibre_21" id="filepos13872179">
        <span className="bold1">
          <sup className="calibre7">10</sup>For{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , that, such as we are in word by letters when we are absent, such{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">will we be</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">PAULS AUTHORITY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>For we dare not make ourselves of
          the number{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>But we will not boast of things
          without{" "}
          <span className="italic1">
            <span>
          ...
          , but according to the measure of the rule which God has distributed
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>For we stretch not ourselves beyond{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">our measure,</span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">preaching</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Not boasting of things without{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">our</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>To Preach the Gospel in the{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">regions</span>
            </span>
          </span>{" "}
          beyond you,{" "}
          <span className="italic1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                have to parasite Pauls converts.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos13876298">
        <span className="bold1">
          <sup className="calibre7">17</sup>But he who glories, let him Glory in
          the Lord.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>For not he who commends himself is
          approved{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1203"></div>
    </div>
  );
}
