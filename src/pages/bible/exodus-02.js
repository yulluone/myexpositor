...
export default function Exodus02() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos691154">
        CHAPTER 2
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(1571 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">THE BIRTH OF MOSES</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And there went a man of the house of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And the woman conceived, and bore a
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Concerning Moses, Pink says, From Adam to Christ there is none
                greater than Moses. He is one of the few characters of Scripture
                whose course is sketched from his infancy to his death. The
                fierce light of criticism has been turned upon him for
                generations, but he is still the most commanding figure of the
                ancient world.
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                In character, and faith, in the unique position assigned him as
                the mediator of the Old Covenant, and in achievements, he stands
                first among the heroes of the Old Testament.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                All of Gods early dealings with Israel were transacted through
                Moses. He was a Prophet, Priest, and King in one person, and so
                united all the great and important functions which later were
                distributed among a plurality of persons. The history of such an
                one is worthy of the strictest attention, and his remarkable
                life deserves the closest study.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And his sister stood afar off, to
          witness what would be done to him.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">MOSES EARLY YEARS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>And the daughter of Pharaoh came down
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And Pharaohs daughter said to her,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And Pharaohs daughter said unto her,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And the child grew, and she brought
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                so Moses was being raised to be the Pharaoh of Egypt.)
              </span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">THE EGYPTIAN</span>
      </p>
      <p className="calibre_18" id="filepos696954">
        <span className="bold1">
          <sup className="calibre7">11</sup>And it came to pass in those days,
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-11" scrollToId="#filepos153805">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Hebrews 11:24</span>
                    </span>
                  </span>
                </ScrollLink>
                , it is clear that a time came when Moses had the choice of
                accepting or refusing the throne of Egypt; he refused, and cast
                in his lot with the hated and oppressed Hebrews)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And he looked this way and that way,
          and when he saw that there was no man, he killed the Egyptian, and hid
          him in the sand.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And when he went out the second day,
          behold, two men of the Hebrews strove together: and he said to him who
          did the wrong, Why do you smite your fellow?
        </span>
      </p>
      <p className="calibre_21" id="filepos698138">
        <span className="bold1">
          <sup className="calibre7">14</sup>And he said, Who made you a prince
          and a judge over us? do you intend to kill me, as you killed the
          Egyptian? And Moses feared, and said, Surely this thing is known.
        </span>
      </p>
      <p className="calibre_21" id="filepos698359">
        <span className="bold1">
          <sup className="calibre7">15</sup>Now when Pharaoh heard this thing,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Targums say that Moses was a General in the Egyptian army], that
                he might take advantage of his good fortune and try to subvert
                their government. So, when Moses, in defending the Hebrew,
                killed an Egyptian, this was the proverbial straw that broke the
                camels back.)
              </span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                palace. He inherited poverty, and enjoyed unlimited wealth. He
                was the leader of armies, and the keeper of flocks. He was the
                mightiest of warriors, and the meekest of men. He was educated
                in the court of Egypt, and yet dwelt in the desert. He had the
                wisdom of Egypt, and the faith of a child. He was fitted for the
                city, and wandered in the wilderness. He was tempted with the
                pleasures of sin, and endured the hardships of virtue. He was
                backward in speech, and yet talked with God. He had the rod of a
                shepherd, and the power of the Infinite. He was a fugitive from
                Pharaoh, and an ambassador from Heaven. He was the giver of the
                Law, and the forerunner of Grace.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Now the priest of Midian had seven
          daughters{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And the shepherds came and drove
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And when they came to Reuel their
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And they said, An Egyptian delivered
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And he said unto his daughters, And
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And Moses was content to dwell with
      ...
      <p className="calibre_21" id="filepos701765">
        <span className="bold1">
          <sup className="calibre7">22</sup>And she bore him a son, and he
      ...
      <p className="calibre_21" id="filepos702163">
        <span className="bold1">
          <sup className="calibre7">23</sup>And it came to pass in process of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                continued, as it was during the time of Joseph. At times, the
                Lord has to allow difficulties, in order for us to become
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And God heard their groaning, and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of His Covenants and Promises to their fathers. God always keeps
                His Word!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And God looked upon the Children of
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos702163">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 23-25</span>
                    </span>
                  </span>
                </ScrollLink>
                . As yet, He was not now known to Israel as Jehovah. That would
                come a little later. Five is the number of Grace. No moral
                excellence in the Children of Israel attracted Gods love; it was
                their misery that drew out His Heart to them: A. He heard their
                groaning; B. He remembered His Covenant; C. He looked upon them;
                and, D. He had respect unto them.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_66"></div>
    </div>
  );
}
