...
export default function Galatians1() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13911882">
        CHAPTER 1
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(A.D. 58)</span>
        </span>
      </h3>
      <h3 className="calibre_17">INTRODUCTION</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Paul, an Apostle, (not of men,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And all the Brethren which are with
      ...
      <p className="calibre_21" id="filepos13913016">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>To Whom{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">be</span>
            </span>
      ...
      <p className="calibre_20">
        <span className="bold1">NO OTHER GOSPEL</span>
      </p>
      <p className="calibre_18" id="filepos13913730">
        <span className="bold1">
          <sup className="calibre7">6</sup>I marvel that you are so soon removed
          from Him{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13914638">
        <span className="bold1">
      ...
      <p className="calibre_18" id="filepos13916356">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13916751">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For you have heard of my
          conversation{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And profited in the Jews religion
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>But when it pleased God, who
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Neither went I up to Jerusalem to
      ...
      <p className="calibre_21" id="filepos13919824">
        <span className="bold1">
          <sup className="calibre7">18</sup>Then after three years I went up to
      ...
      <p className="calibre_21" id="filepos13920225">
        <span className="bold1">
          <sup className="calibre7">19</sup>But other of the Apostles saw I
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Now the things which I write unto
          you, behold, before God, I lie not.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Afterwards I came into the regions
          of Syria and Cilicia;
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And was unknown by face unto the
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1209"></div>
    </div>
  );
}
