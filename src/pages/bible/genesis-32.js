...
export default function Genesis32() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos442446">
        CHAPTER 32
      </h3>
      ...
      <p className="calibre_18" id="filepos442654">
        <span className="bold1">
          <sup className="calibre7">1</sup>And Jacob went on his way, and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , he said, This is Gods Host: and he called the name of that place
          Mahanaim{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And Jacob sent messengers before him
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And he commanded them, saying, Thus
          shall you speak unto my lord Esau; Your servant Jacob says thus, I
          have sojourned with Laban, and stayed there until now:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And I have oxen, and asses, flocks,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And the messengers returned to Jacob,
          saying, We came to your brother Esau, and also he comes to meet you,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Then Jacob was greatly afraid and
          distressed{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          : and he divided the people who were with him, and the flocks, and
          herds, and the camels, into two bands;
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And said, If Esau come to the one
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And Jacob said, O God of my father
          Abraham, and God of my father Isaac, the LORD which said unto me,
          Return unto your country, and to your kindred, and I will deal well
          with you:{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                heart with a thousand fears, and robs the Christian of
                confidence toward God and dignity before man.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>I am not worthy of the least of all
          the mercies{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          , and of all the truth, which you have showed unto your servant; for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Deliver me, I pray you, from the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                just been committing himself? But, as stated, before we
                criticize him, we had best look into the glass of our own
                hearts.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And You said, I will surely do you
          good, and make your seed as the sand of the sea, which cannot be
          numbered for multitude.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And he lodged there that same night;
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Hence, the two things are perfectly incompatible, they virtually
                cancel out each other. When my eyes fill with my own management
                of things, I am not prepared to see God acting for me; and, in
                that case, prayer is not the utterance of my need, but the mere
                superstitious performance of something which I think ought to be
                done, or it may be asking God to sanctify my plans. This will
                never do. The life of Faith is not asking God to sanctify and
                bless my means, but it is asking Him to do it all Himself)
              </span>
            </span>
          </span>
          ;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Two hundred she goats, and twenty he
          goats, two hundred ewes, and twenty rams,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Thirty milk camels with their colts,
          forty cattle, and ten bulls, twenty she asses, and ten foals.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And he delivered them into the hand
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          Whom do you work? and where are you going? and whose are these before
          you?
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Then you shall say, They be your
          servant Jacobs; it is a present sent unto my lord Esau: and, behold,
          also he{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And so commanded he the second, and
          the third, and all that followed the droves, saying, On this manner
          shall you speak unto Esau, when you find him.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And say ye moreover, Behold, your
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                came to Jacob in peace. No sooner had the Patriarch quit
                praying, that he started planning, which means that he wasnt
                really trusting the Lord as he should have been.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>So went the present over before him:
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And he rose up that night, and took
      ...
      <p className="calibre_18" id="filepos450605">
        <span className="bold1">
          <sup className="calibre7">24</sup>And Jacob was left alone; and there
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], this Man is called God, the Angel, Elohim Sabaoth, and
                Jehovah. In this scenario, we find that it was not with Esau,
                his brother, with whom he had to contend, but with Jehovah
                Himself. This is always the case with every Believer.)
              </span>
            </span>
          </span>
        </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                rise upon a limping Israel than to set upon a lying Jacob.
                Jacob, for his misconduct, was exiled from the Promised Land,
                having nothing but his staff. He returns a wealthy prince, but
                lamed. So, Israel, cast out of Jehovahs Land because of her sin,
                will return with abundance, but broken and contrite in spirit.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos452167">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                portrayed. True Faith requires that we admit what we are, before
                we can receive what He is!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>And Jacob asked Him, and said, Tell
          me, I pray You, Your Name. And He said, Wherefore is it that you do
          ask after My name?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And Jacob called the name of the
          place Peniel{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And as he passed over Penuel the sun
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>Therefore the children of Israel eat
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Achillis, because it reaches the heel. So, the heel-catcher
                became a Prince with God.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_42"></div>
    </div>
  );
}
