...
export default function Galatians2() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13921637">
        CHAPTER 2
      </h3>
      <h3 className="calibre_17">(A.D. 52)</h3>
      <p className="calibre_20">
        <span className="bold1">THE CHURCH</span>
      </p>
      <p className="calibre_18" id="filepos13921811">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then fourteen years after I went up
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/acts-15" scrollToId="#filepos13029810">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 15:1-35</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>But neither Titus, who was with me,
          being a Greek{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And that because of false brethren
          unawares brought in{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos13923889">
        <span className="bold1">
          <sup className="calibre7">5</sup>To whom we gave place by subjection,
          no, not for an hour{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          to me: God accepts no mans person:) for they who seemed{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">to be somewhat</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>But contrariwise, when they saw that
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">the Gospel</span>
            </span>
          </span>{" "}
          of the Circumcision{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>(For He Who wrought effectually in
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">should go</span>
            </span>
          </span>{" "}
          unto the heathen{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Only{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">they would</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For before that certain came from
          James{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                whatsoever. This ultimately occasioned the necessity of Paul
                writing the Epistle to the Hebrews.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>But when I saw that they walked not
          ...
          , If you, being a Jew, live after the manner of Gentiles, and not as
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>We{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Knowing that a man is not justified
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>But if, while we seek to be
          Justified by Christ{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>For if I build again the things
          which I destroyed{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13932184">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13933223">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1210"></div>
    </div>
  );
}
