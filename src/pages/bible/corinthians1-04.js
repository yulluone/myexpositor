...
export default function Corinthians104() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13572813">
        CHAPTER 4
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Let a man so account of us, as of the
          Ministers of Christ{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Moreover it is required in Stewards,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>But with me it is a very small thing
      ...
      <p className="calibre_21" id="filepos13574261">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Therefore judge nothing before the
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">6</sup>And these things, Brethren, I have in
          ...
          ; that you might learn in us not to think{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>For who makes you to differ{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For I think that God has set forth us
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>We{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          we both hunger, and thirst, and are naked, and are buffeted, and have
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And labour, working with our own
          hands{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">and are</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">14</sup>I write not these things to shame
          you{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            ...
            <span>
              <span className="explanation">
                ...
                fall out to their hurt if continued.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>For though you have ten thousand
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">have you</span>
            </span>
          </span>{" "}
          not many fathers{" "}
          <span className="italic1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                unfortunately, all Preachers then, as now, were not Preaching
                the Cross; hence the admonition of the Apostle)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>For this cause have I sent unto you
          Timothy{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>But I will come to you shortly, if
          the Lord will{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>For the Kingdom of God{" "}
          <span className="italic1">
            <span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1179"></div>
    </div>
  );
}
