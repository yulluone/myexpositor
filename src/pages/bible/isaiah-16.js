...
export default function Isaiah16() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7442341">
        CHAPTER 16
      </h3>
      ...
      <p className="calibre_18" id="filepos7442554">
        <span className="bold1">
          <sup className="calibre7">1</sup>Send you the lamb to the ruler of the
          land from Sela{" "}
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/matthew-24" scrollToId="#filepos11225514">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 24:15-24</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>For it shall be, that, as a wandering
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Take counsel, execute judgment; make
          your shadow as the night in the midst of the noonday; hide the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Let My outcasts dwell with you, Moab;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The Holy Spirit requests of Moab at the time of the invasion by
                the Antichrist that His outcasts dwell with them. The place that
                is being spoken of is Petra, which is in present-day Jordan. For
                this reason, the Holy Spirit will cause the country of Jordan to
                escape out of the hand of the Antichrist [
                <ScrollLink href="/daniel-11" scrollToId="#filepos9942677">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Dan. 11:40-45</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And in mercy shall the throne be
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/acts-15" scrollToId="#filepos13036916">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 15:13-18</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_18" id="filepos7445863">
        <span className="bold1">
          <sup className="calibre7">6</sup>We have heard of the pride of Moab;
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos7445863">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 6 through 12</span>
                    </span>
                  </span>
                </ScrollLink>
                . These Prophecies as well compare with the Prophecies in{" "}
                <ScrollLink href="/isaiah-15" scrollToId="#filepos7437282">
                  <span className="calibre_19">
                    <span>
                ...
                . This concerns the soon coming invasion by Assyria.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Therefore shall Moab howl for Moab,
          every one shall howl: for the foundations of Kir-hareseth shall you
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For the field of Heshbon languish,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Therefore I will bewail with the
          weeping of Jazer the vine of Sibmah: I will water you with my tears, O
          Heshbon, and Elealeh: for the shouting for your summer fruits and for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And gladness is taken away, and joy
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Wherefore my bowels shall sound like
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And it shall come to pass, when it
          is seen that Moab is weary on the high place, that he shall come to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>This is the Word that the LORD has
      ...
      <p className="calibre_21" id="filepos7449369">
        <span className="bold1">
          <sup className="calibre7">14</sup>But now the LORD has spoken, saying,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                latter days, and in fact presently occupies modern Jordan, and
                for the express purpose of protecting Israel, which she will do
                in the latter half of the Great Tribulation.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_758"></div>
    </div>
  );
}
