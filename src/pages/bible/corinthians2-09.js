...
export default function Corinthians209() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13859287">
        CHAPTER 9
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">ENCOURAGEMENT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>For as touching the Ministering to
          the Saints{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>For I know the forwardness of your
          mind{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13855943"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Cor. 8:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink
                  href="/corinthians2-08"
                  scrollToId="#filepos13857286"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">22-23</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Lest haply if they of Macedonia come
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Therefore I thought it necessary to
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">a matter of</span>
            </span>
          </span>{" "}
          bounty{" "}
          <span className="italic1">
      ...
      <p className="calibre_18" id="filepos13862609">
        <span className="bold1">
          <sup className="calibre7">6</sup>But this{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Every man according as he purposes in
          his heart,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And God{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/psalm-112" scrollToId="#filepos6501057">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 112:9</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Now he who Ministers seed to the
          sower{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Being enriched in every thing to all
          bountifulness{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For the administration of this
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>While by the experiment of this
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Thanks{" "}
          <span className="italic1">
            <span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1202"></div>
    </div>
  );
}
