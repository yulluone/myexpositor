...
export default function Corinthians116() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13758790">
        CHAPTER 16
      </h3>
      <h3 className="calibre_17">(A.D. 59)</h3>
      <p className="calibre_20">
        <span className="bold1">FINANCIAL HELP</span>
      </p>
      ...
      <p className="calibre_21" id="filepos13759397">
        <span className="bold1">
          <sup className="calibre7">2</sup>Upon the first{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13760036">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                these men accompany him [
                <ScrollLink
                  href="/corinthians2-01"
                  scrollToId="#filepos13779627"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Cor. 1:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/romans-15" scrollToId="#filepos13517554">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 15:25</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_20">
        <span className="bold1">PAULS FUTURE PLANS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>Now I will come unto you, when I
      ...
      <p className="calibre_21" id="filepos13761686">
        <span className="bold1">
          <sup className="calibre7">6</sup>And it may be that I will abide, yes,
          and winter with you{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>But I will tarry at Ephesus until
          Pentecost.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For a great door and effectual is
          opened unto me{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">TIMOTHY AND APOLLOS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>Now if Timothy come, see that he may
          ...
          : for he works the Work of the Lord, as I also{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>As touching{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_18" id="filepos13764787">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Let all your things be done with
          charity{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>I beseech you, Brethren, (ye know
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , and to every one who helps with{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>I am glad of the coming of Stephanas
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>For they have refreshed my spirit
          and yours{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">SALUTATION AND BENEDICTION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">21</sup>The salutation of{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13768702">
        <span className="bold1">
          <sup className="calibre7">22</sup>If any man love not the Lord Jesus
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>My love{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">be</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1191"></div>
    </div>
  );
}
