...
export default function Isaiah23() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7499396">
        CHAPTER 23
      </h3>
      <h3 className="calibre_17">(715 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE MESSAGE TO TYRE: DESOLATION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>The burden of Tyre. Howl, you ships
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Be still, you inhabitants of the
          isle; you whom the merchants of Zidon, who pass over the sea, have
          replenished.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And by great waters the seed of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Be you ashamed, O Zidon: for the sea
          has spoken, even the strength of the sea, saying, I travail not, nor
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Zidon was considered to be Tyres mother. Zidon would be so
                weakened by Tyres fall that she declared that she would never
                found or begin another city.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>As at the report concerning Egypt, so
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Pass you over to Tarshish; howl, you
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                taken, even after a thirteen-year siege, Nebuchadnezzar found
                very little of value. It so enraged him that he destroyed the
                place completely.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Is this your joyous city, whose
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Who has taken this counsel against
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>The LORD of Hosts has purposed it, to
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                abase the pride of all human glory and cover with contempt the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Pass through your land as a river, O
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>He stretched out His Hand over the
          sea, He shook the kingdoms: the LORD has given a commandment against
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And he said, You shall no more
          rejoice, O you oppressed virgin, daughter of Zidon: arise, pass over
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Behold the land of the Chaldeans;
          this people was not, till the Assyrian founded it for them who dwell
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Howl, you ships of Tarshish: for
      ...
      <p className="calibre_20">
        <span className="bold1">RESTORATION AFTER SEVENTY YEARS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>And it shall come to pass in that
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Take an harp, go about the city, you
          harlot who has been forgotten; make sweet melody, sing many songs,
      ...
      <p className="calibre_21" id="filepos7506936">
        <span className="bold1">
          <sup className="calibre7">17</sup>And it shall come to pass after the
          end of seventy years, that the LORD will visit Tyre, and she shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And her merchandise and her hire
          shall be holiness to the LORD: it shall not be treasured nor laid up;
          for her merchandise shall be for them who dwell before the LORD, to
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                In essence, this Verse looks forward to the coming Millennium,
                when Tyre will then be blessed by Christ, with the old times
                then forgotten.)
              </span>
            </span>
          </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_765"></div>
    </div>
  );
}
