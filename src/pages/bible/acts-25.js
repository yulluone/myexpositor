...
export default function Acts25() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13213914">
        CHAPTER 25
      </h3>
      <h3 className="calibre_17">(A.D. 62)</h3>
      <p className="calibre_20">
        <span className="bold1">PAUL BEFORE FESTUS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now when Festus was come into the
          Province{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Then the High Priest and the Chief of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And desired favour against him, that
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                kill Paul [
                <ScrollLink href="/acts-23" scrollToId="#filepos13193428">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 23:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>But Festus answered, that Paul should
          be kept at Caesarea, and that he himself would depart shortly{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                thither (seems to imply that the Governor had about had his fill
                of the hatred and hypocrisy of these Jews)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Let them therefore, said he, which
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And when he had tarried among them
          more than ten days, he went down unto Caesarea; and the next day
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And when he was come, the Jews which
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                hints, but which Luke did not specify)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>While he answered for himself,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>But Festus, willing to do the Jews a
          ...
          , Will you go up to Jerusalem, and there be judged of these things
          before me?{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">CAESAR</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>Then said Paul, I stand at Caesars
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>For if I be an offender, or have
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Then Festus, when he had conferred
      ...
      <p className="calibre_20">
        <span className="bold1">AGRIPPA AND FESTUS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-12" scrollToId="#filepos12973976">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 12:1</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And when they had been there many
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>About whom, when I was at Jerusalem,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>To whom I answered, It is not the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Therefore, when they were come
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Against whom when the accusers stood
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>But had certain questions against
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                check if he so desired; as well, Roman soldiers made the Tomb
                secure; all of this, as stated, was a matter of record)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And because I doubted of such manner
          of questions{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>But when Paul had appealed to be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Then Agrippa said unto Festus, I
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And on the morrow, when Agrippa was
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And Festus said, King Agrippa, and
          all men which are here present with us, you see this man, about whom
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>But when I found that he had
          committed nothing worthy of death, and that he himself has appealed to
          Augustus, I have determined to send him.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>Of whom I have no certain thing to
          write unto my lord{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          you, O king Agrippa, that, after examination had, I might have
          somewhat to write{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>For it seems to me unreasonable to
          send a prisoner, and not withal to signify the crimes{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">laid</span>
            </span>
          </span>{" "}
          against him{" "}
          <span className="italic1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1152"></div>
    </div>
  );
}
