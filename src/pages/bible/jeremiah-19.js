...
export default function Jeremiah19() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos8413813">
        CHAPTER 19
      </h3>
      <h3 className="calibre_17">(605 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">THE LESSON FROM THE BROKEN POTTERY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Thus says the LORD, Go and get a
          potters earthen bottle, and take of the ancients of the people, and of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                after pronouncing judgment, break the bottle in their sight,
                symbolizing therewith the breaking and destruction of Judah and
                Jerusalem)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And go forth unto the valley of the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                quenched, because that on which they feed shall never be
                annihilated; thereby will Hell be different from the valley of
                Hinnom [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And say, Hear you the Word of the
          LORD, O kings of Judah, and inhabitants of Jerusalem; Thus says the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                I will bring evil, refers to the sovereignty and ability of God,
                which are unlimited. It speaks of His total control over all
                things. Nebuchadnezzar, the heathen monarch, would think the
                plan is his; but, in reality, he was but a tool!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Because they have forsaken Me, and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                little children, offered up in sacrifice to Moloch)
              </span>
            </span>
          </span>
          ;
      ...
      <p className="calibre_21" id="filepos8416771">
        <span className="bold1">
          <sup className="calibre7">5</sup>They have built also the high places
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos8416771">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 5 through 6</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                repeat{" "}
                <ScrollLink href="/jeremiah-07" scrollToId="#filepos8251692">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">7:31-32</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Therefore, behold, the days come,
          says the LORD, that this place shall no more be called Tophet, nor The
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                slaughter, and even on a far greater scale! Jesus plainly said,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And I will make void the counsel of
          Judah and Jerusalem in this place; and I will cause them to fall by
          the sword before their enemies, and by the hands of them who seek
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                by the appalling slaughter carried out by the Chaldeans on the
                men who made it. There were they justly punished for the blood
                of the tortured children burned alive in sacrifice to Moloch.
                Such cruelty to children, especially by Gods chosen People,
                never was contemplated by the loving heart of God.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And I will make this city desolate,
          and an hissing; everyone who passes thereby shall be astonished and
      ...
      <p className="calibre_21" id="filepos8419446">
        <span className="bold1">
          <sup className="calibre7">9</sup>And I will cause them to eat the
          ...
          wherewith their enemies, and they who seek their lives, shall straiten
          them.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/deuteronmy-28" scrollToId="#filepos2397817">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 28:53</span>
                    </span>
                  </span>
                </ScrollLink>
                . The words, in the siege, refer to the coming siege of
                Jerusalem by Nebuchadnezzar. As a result, the city was shut up
                tight, with no traffic coming in or out. The food, therefore,
                quickly ran out!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Then shall you break the bottle in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And shall say unto them, Thus s ays
          the LORD of Hosts; Even so will I break this people and this city, as
          one breaks a potters vessel, that cannot be made whole again: and they
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                That cannot be made whole again, refers to the utter destruction
                of Judah and Jerusalem. In fact, they have never been whole from
                that day until this!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Thus will I do unto this place, says
          the LORD, and to the inhabitants thereof, and even make this city as
          Tophet:
        </span>
      </p>
      <p className="calibre_21" id="filepos8421480">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the houses of Jerusalem, and the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/deuteronmy-04" scrollToId="#filepos2161450">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 4:19</span>
                    </span>
                  </span>
                </ScrollLink>
                . These other gods were either Baal or a derivative of Baal,
                such as Chemosh, etc.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Then came Jeremiah from Tophet,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                doubt, desires to draw attention to the fact that while the
                people are pouring out drink offerings unto other gods, they are
                also worshipping Jehovah in the Temple! In their minds, because
                of doing this, they are even more religious; but in Gods Mind,
                they are abominable!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Thus says the LORD of Hosts, the God
      ...
      <div className="mbp_pagebreak" id="calibre_pb_829"></div>
    </div>
  );
}
