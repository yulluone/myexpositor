...
export default function Chronicles203() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos4679272">
        CHAPTER 3
      </h3>
      <h3 className="calibre_17">(1012 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">SOLOMON BEGINS TO BUILD THE TEMPLE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then Solomon began to build the House
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/genesis-22" scrollToId="#filepos286245">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 22:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ; it is never mentioned after this; it is where Abraham was to
                offer up Isaac)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/samuel2-24" scrollToId="#filepos3669995">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Sam. 24:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ], now turned into a place of Blessing, all by the Grace of God)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And he began to build in the second
          day of the second month, in the fourth year of his reign.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">DIMENSIONS AND MATERIALS OF THE TEMPLE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">3</sup>Now these are the things wherein
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And the porch that was in the front
          of the House, the length of it was according to the breadth of the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/kings1-06" scrollToId="#filepos3753950">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 6:2</span>
                    </span>
                  </span>
                </ScrollLink>
                , it states that the height was 30 cubits, or 45 feet, counting
                18 inches to the cubit; this would be normal for the highest
                part of the Temple, and for the three stories of chambers [
                <ScrollLink href="/kings1-06" scrollToId="#filepos3757283">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 6:8</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21" id="filepos4682086">
        <span className="bold1">
          <sup className="calibre7">5</sup>And the greater house he cieled with
          fir tree, which he overlaid with fine gold, and set thereon palm trees
          and chains{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And he garnished the house with
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>He overlaid also the House, the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                speak of the prefect rest found only in Christ, with the chains
                of that Verse speaking of the never-ceasing link of the Child of
                God with the Lord Jesus Christ.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE HOLY OF HOLIES</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          ...
          , the length whereof was according to the breadth of the House, twenty
          cubits{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And the weight of the nails was fifty
          shekels of gold{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          he made two Cherubims of image work, and overlaid them with gold.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And the wings of the Cherubims were
          twenty cubits long{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">(30 feet)</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And one wing of the other Cherub was
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>The wings of these Cherubims spread
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                In Moses Tabernacle, the Cherubim looked down upon the
                blood-sprinkled Mercy Seat, for only there could their eyes rest
                with satisfaction all around, being under the reign of sin and
                death. But here the new Cherubim looked outward upon a kingdom
                governed in Righteousness by the King of Righteousness.)
              </span>
            </span>
          </span>
        </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/kings1-06" scrollToId="#filepos3766167">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 6:31</span>
                    </span>
                  </span>
                </ScrollLink>
                , the Holy Spirit records the fact that there were doors made of
                olive wood between the Most Holy Place and the Holy Place. It
                does not mention the Veil. In this Passage, it mentions the
                Veil, but does not mention the doors. Quite possibly, the Veil
                hung immediately behind the doors. Therefore, when the doors
                were opened, the Veil would remain, and continue to hide the
                Holy of Holies from the inquisitive stare)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_20">
        <span className="bold1">THE TWO PILLARS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>Also he made before the House two
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , as in the Oracle, and put them on the heads of the pillars; and made
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And he reared up the pillars before
      ...
      <div className="mbp_pagebreak" id="calibre_pb_414"></div>
    </div>
  );
}
