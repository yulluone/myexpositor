...
export default function Ezekiel46() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos9694920">
        CHAPTER 46
      </h3>
      <h3 className="calibre_17">(574 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">
          SABBATH AND NEW MOON OFFERINGS; DUTIES OF THE PRINCE
        </span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Thus says the Lord GOD; The Gate of
          the Inner Court that looks toward the east shall be shut the six
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/isaiah-60" scrollToId="#filepos8015854">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isa. 60:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And the Prince shall enter by the way
          of the Porch of that Gate without, and shall stand by the post of the
          Gate, and the Priests shall prepare his Burnt Offering and his Peace
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Leviticus, they numbered four, and with wine.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Likewise the people of the land shall
          worship at the door of this Gate before the LORD in the Sabbaths and
          in the new moons.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                only in Christ, which Israel will truly have in the coming
                Kingdom Age. The New Moon signifies the perpetuity of this rest,
                guaranteeing its existence forever.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And the Burnt Offering that the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And the Meat Offering shall be an
          ephah for a ram, and the Meat Offering for the lambs as he shall be
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Christ as the Bread that came down, and comes down, from Heaven,
                whereof if a man eat, he shall never die [
                <ScrollLink href="/john-06" scrollToId="#filepos12419790">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 6:50-51</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And in the day of the new moon it
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And he shall prepare a Meat Offering,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And when the Prince shall enter, he
          shall go in by the way of the Porch of that Gate, and he shall go
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>But when the people of the land shall
          come before the LORD in the solemn Feasts, he who enters in by the way
          of the north Gate to worship shall go out by the way of the south
          Gate; and he who enters by the way of the south Gate shall go forth by
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And the Prince in the midst of them,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                with the people in the Incarnation. However, He did not become
                one with them in their sin; this is represented here by the
                Prince associating with the worship of the people only on a
                certain level, and at certain times.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">RULES GOVERNING OFFERINGS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">11</sup>And in the Feast and in the
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/numbers-15" scrollToId="#filepos1866831">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 15:1-9</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. Such typifies the fulfillment of the Promise, whereas the Law
                of Moses typified the Promise of the fulfillment.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now when the Prince shall prepare a
          voluntary Burnt Offering or Peace Offerings voluntarily unto the LORD,
          one shall then open him the Gate that looks toward the east, and he
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                its significance and meaning among the people, and will continue
                to portray the reason for our deliverance and blessing.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>You shall daily prepare a Burnt
          Offering unto the LORD of a lamb of the first year without blemish:
          you shall prepare it every morning.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Thus shall they prepare the lamb,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Lamb; for to that Day there will be no evening.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">RULES CONCERNING INHERITANCES</span>
      </p>
      <p className="calibre_18" id="filepos9702785">
        <span className="bold1">
          <sup className="calibre7">16</sup>Thus says the Lord GOD, If the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>But if he give a gift of his
          inheritance to one of his servants, then it shall be his to the Year
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Gift will be returned to the Prince.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>Moreover the Prince shall not take
          of the peoples inheritance by oppression, to thrust them out of their
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/" scrollToId="#filepos9702785">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 16 through 18</span>
                    </span>
                  </span>
                </ScrollLink>
                ; and His Loving Care for the physical needs of His Servants is
                shown in{" "}
                <ScrollLink href="/" scrollToId="#filepos9704422">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 19 through 24</span>
                    </span>
                  </span>
                </ScrollLink>
                .)
      ...
      <p className="calibre_20">
        <span className="bold1">PLACE FOR PREPARING THE OFFERINGS</span>
      </p>
      <p className="calibre_18" id="filepos9704422">
        <span className="bold1">
          <sup className="calibre7">19</sup>After he brought me through the
          entry, which was at the side of the Gate, into the Holy Chambers of
          the Priests, which looked toward the north: and, behold, there was a
          place on the two sides westward.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Then said He unto me, This is the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                . In service for the Lord, this distinction must be observed;
                and the richer will be the ministry to man if that to God be
                given first place.
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The idea of this Verse is: Such Offerings as specified here were
                for the Priests only, and thereby, typified their personal
                worship of the Lord. This also typified that even though they
                were Gods Chosen, and even Priests, still, they were sinners
                and, therefore, desperately needing a Saviour.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Then He brought me forth into the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>In the four corners of the Court
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And there was a row of building
          round about in them, round about them four, and it was made with
          boiling places under the rows round about.
        </span>
      </p>
      <p className="calibre_21" id="filepos9706572">
        <span className="bold1">
          <sup className="calibre7">24</sup>Then said He unto me, These are the
          places of them who boil, where the Ministers of the House shall boil
      ...
      <div className="mbp_pagebreak" id="calibre_pb_917"></div>
    </div>
  );
}
