...
export default function Genesis05() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos79540">
        CHAPTER 5
      </h3>
      ...
      <h3 className="calibre_17">ADAMS DESCENDANTS</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>This is the book of the generations
          of Adam{" "}
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13806677"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Cor. 4:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. Through the Fall, man lost that glory; however, at the First
                Resurrection of Life, every Believer will regain that glory [
      ...
      <p className="calibre_21" id="filepos81238">
        <span className="bold1">
          <sup className="calibre7">3</sup>And Adam lived an hundred and thirty
          years, and begat{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of their original parent, Adam, a product of his fallen nature;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And the days of Adam after he had
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And all the days that Adam lived were
      ...
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF SETH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">6</sup>And Seth lived an hundred and five
          years, and begat{" "}
          <span className="italic1">
            <span>
              <span className="explanation">(fathered)</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And Seth lived after he begat Enos
          eight hundred and seven years, and begat sons and daughters:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And all the days of Seth were nine
          hundred and twelve years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF ENOS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">9</sup>And Enos lived ninety years, and
          begat Cainan:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And Enos lived after he begat Cainan
          eight hundred and fifteen years, and begat sons and daughters:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And all the days of Enos were nine
          hundred and five years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF CAINAN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>And Cainan lived seventy years, and
          begat Mahalaleel:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And Cainan lived after he begat
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And all the days of Cainan were nine
          hundred and ten years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF MAHALALEEL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>And Mahalaleel lived sixty and five
          years, and begat Jared:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And Mahalaleel lived after he begat
          Jared eight hundred and thirty years, and begat sons and daughters:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And all the days of Mahalaleel were
          eight hundred ninety and five years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF JARED</span>
      </p>
      <p className="calibre_18" id="filepos85067">
        <span className="bold1">
          <sup className="calibre7">18</sup>And Jared lived an hundred sixty and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And Jared lived after he begat Enoch
          eight hundred years, and begat sons and daughters:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And all the days of Jared were nine
          hundred sixty and two years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF ENOCH</span>
      </p>
      <p className="calibre_18" id="filepos85766">
        <span className="bold1">
          <sup className="calibre7">21</sup>And Enoch lived sixty and five
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Methuselah was a living, walking testimony that judgment was
                coming upon the Earth because of its terrible wickedness;
                however, only Noah and his family believed; so the flood came a
                little less than a thousand years after Methuselah was born)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21" id="filepos86389">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos86389">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 5:22</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; he witnessed for God [Jude,{" "}
                <ScrollLink href="/jude-1" scrollToId="#filepos14875780">
                  <span className="calibre_19">
                    <span>
                ...
                <ScrollLink href="/hebrews-11" scrollToId="#filepos14556128">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 11:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And all the days of Enoch were three
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And Enoch walked with God: and he
      ...
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF METHUSELAH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">25</sup>And Methuselah lived an hundred
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And Methuselah lived after he begat
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And all the days of Methuselah were
      ...
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF LAMECH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">28</sup>And Lamech lived an hundred eighty
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ultimately come through his lineage, the Son of God, Who would
                remove the greater curse the curse of the broken Law [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And Lamech lived after he begat Noah
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And all the days of Lamech were
          seven hundred seventy and seven years: and he died.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE FAMILY OF NOAH</span>
      </p>
      <p className="calibre_18" id="filepos90335">
        <span className="bold1">
          <sup className="calibre7">32</sup>And Noah was five hundred years old:
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                descendant of either Shem, Ham, or Japheth)
              </span>
            </span>
          </span>
        </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_15"></div>
    </div>
  );
}
