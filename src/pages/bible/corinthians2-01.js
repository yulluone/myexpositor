...
export default function Corinthians201() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13770383">
        CHAPTER 1
      </h3>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Who comforts us in all our
          tribulation{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>For as the sufferings of Christ
          abound in us{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And our hope of you{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
          </span>{" "}
          stedfast, knowing, that as you are partakers of the sufferings,{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">you shall be</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For we would not, Brethren, have you
      ...
      <p className="calibre_21" id="filepos13775079">
        <span className="bold1">
          <sup className="calibre7">9</sup>But we had the sentence of death in
          ourselves{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/jeremiah-17" scrollToId="#filepos8386829">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jer. 17:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Who delivered us from so great a
          death{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>You also helping together by prayer
          for us{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/romans-15" scrollToId="#filepos13519823">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 15:30-31</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/philippians-1" scrollToId="#filepos14087717">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Phil. 1:19</span>
                    </span>
                  </span>
                </ScrollLink>
                ; Phile.,{" "}
                <ScrollLink href="/" scrollToId="#filepos13782890">
                  <span className="calibre_19">
                    <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">bestowed</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">POSTPONEMENT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13878392"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Cor. 11:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For we write none other things unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>As also you have acknowledged us in
          part{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And in this confidence I was minded
      ...
      <p className="calibre_21" id="filepos13779627">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13761686"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 16:6</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>When I therefore was thus minded,
          did I use lightness?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos13781034">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>For the Son of God, Jesus Christ,
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/samuel1-15" scrollToId="#filepos3207286">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Sam. 15:29</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
      ...
      <p className="calibre_21" id="filepos13782890">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>Moreover I call God for a record
          upon my soul{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                way to address the problems at Corinth.)
              </span>
            </span>
          </span>
        </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1194"></div>
    </div>
  );
}
