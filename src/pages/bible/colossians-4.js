...
export default function Colossians4() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14176977">
        CHAPTER 4
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Masters, give unto{" "}
      ...
      <p className="calibre_18" id="filepos14177614">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14178019">
        <span className="bold1">
          <sup className="calibre7">3</sup>Withal praying also for us, that God
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-16" scrollToId="#filepos13053910">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 16:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ], it is also subject to Satanic hindrances [
                <ScrollLink
                  href="/thessalonians1-1"
                  scrollToId="#filepos14200927"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Thess. 2:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Walk in wisdom toward them who are
          without{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14179481">
        <span className="bold1">
          <sup className="calibre7">6</sup>Let your speech{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">BRETHREN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>All my state shall Tychicus declare
          unto you,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Whom I have sent unto you for the
          same purpose{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>With Onesimus, a faithful and beloved
          Brother, who is{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">are done</span>
            </span>
          </span>{" "}
          here{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Aristarchus my fellow-prisoner
          salutes you{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , (touching whom you received commandments: if he come unto you,
          receive him;){" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-15" scrollToId="#filepos13048673">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 15:37-40</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And Jesus, which is called Justus,
          who are of the Circumcision. These only{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">are my</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Epaphras, who is{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">one</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For I bear him record, that he has a
          great zeal for you, and them{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/timothy2-4" scrollToId="#filepos14372184">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Tim. 4:10</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">Epistle</span>
            </span>
          </span>{" "}
          from Laodicea.{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And say to Archippus, Take heed to
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                . Tradition says he was the son of Philemon, and maybe the
                Pastor of the Church that was in their house in the city of
                Colosse.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>The salutation by the hand of me
          Paul{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1234"></div>
    </div>
  );
}
