...
export default function Exodus29() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos1092588">
        CHAPTER 29
      </h3>
      ...
      <h3 className="calibre_17">CONSECRATION</h3>
      <p className="calibre_18" id="filepos1092804">
        <span className="bold1">
          <sup className="calibre7">1</sup>And this is the thing that you shall
          do unto them to hallow them, to minister unto Me in the Priests
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                bullock symbolized the Manhood of Christ, while the two rams
                symbolized His Kingly Nature.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And unleavened bread, and cakes
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]. The flour symbolized the purity and glory of Christ.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And you shall put them into one
      ...
      <p className="calibre_20">
        <span className="bold1">CLEANSING</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">4</sup>And Aaron and his sons you shall
          bring unto the door of the Tabernacle of the congregation, and shall
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Word of God [
                <ScrollLink
                  href="/corinthians1-06"
                  scrollToId="#filepos13598749"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 6:11</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_20">
        <span className="bold1">THE HIGH PRIEST</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>And you shall take the garments, and
          put upon Aaron the Coat, and the Robe of the Ephod, and the Ephod, and
          the Breastplate, and gird him with the Curious Girdle of the Ephod:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And you shall put the Mitre upon his
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                character of the High Priest, who, as the main Type of Christ in
                the Mosaic Law, was bound to be Prophet, Priest, and King. But
                yet, all of these things were but types, and carry no reality,
                except by Faith. Everything looked forward to the One Who was to
                come, Who would redeem humanity, and do so by going to the
                Cross.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Then you shall take the anointing
      ...
      <p className="calibre_20">
        <span className="bold1">THE ORDER</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">8</sup>And you shall bring his sons, and put
          Coats upon them.
        </span>
      </p>
      <p className="calibre_21" id="filepos1096352">
        <span className="bold1">
          <sup className="calibre7">9</sup>And you shall gird them with Girdles,
          Aaron and his sons, and put the Bonnets on them: and the Priests
          office shall be theirs for a perpetual Statute: and you shall
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Christ, Who, in virtue of what He was in His Own Person, was
                anointed with the Holy Spirit long before the work of the Cross
                was accomplished. The sons of Aaron, even as we shall see, on
                the other hand, who in a sense represent Believers, were not
                anointed until after the blood was shed, presenting the fact
                that the Holy Spirit could not come until after the Cross.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE SIN OFFERING</span>
      </p>
      <p className="calibre_18" id="filepos1097284">
        <span className="bold1">
          <sup className="calibre7">10</sup>And you shall cause a bullock to be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And you shall kill the bullock
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                from before the foundation of the world. It was the very purpose
                for why Christ came [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And you shall take of the blood of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], and that this great Salvation would be for all of humanity,
                hence, the horns pointing in all directions)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And you shall take all the fat that
          covers the inwards, and the caul that is above the liver, and the two
      ...
      <p className="calibre_21" id="filepos1099962">
        <span className="bold1">
          <sup className="calibre7">14</sup>But the flesh of the bullock, and
          his skin, and his dung, shall you burn with fire without the camp: it
          is a Sin Offering.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                the Sin-Offering. He suffered without the camp, i.e., without
                the gate [
                <ScrollLink href="/hebrews-13" scrollToId="#filepos14600754">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 13:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>You shall also take one ram; and
          Aaron and his sons shall put their hands upon the head of the ram.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And you shall slay the ram, and you
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos1097284">
                  <span className="calibre_19">
                    <span>
                ...
                represented Christ at the height of His Manhood giving Himself
                for the sin of the world, the ram represented Christ in His
                position as King. The ram signified that the death of Christ was
                not merely the death of just anyone, it was the death of the Son
      ...
      <p className="calibre_21" id="filepos1102595">
        <span className="bold1">
          <sup className="calibre7">18</sup>And you shall burn the whole ram
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>And you shall take the other ram;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Then shall you kill the ram, and
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-14" scrollToId="#filepos12613771">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 14:24</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          , and upon the tip of the right ear of his sons, and upon the thumb of
          their right hand{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And you shall take of the blood that
          is upon the Altar, and of the anointing oil, and sprinkle it upon
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Holy Spirit works; He works entirely within the parameters of
                the great Sacrifice of Christ, typified by the blood [
                <ScrollLink href="/romans-08" scrollToId="#filepos13388498">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 8:2-3</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Also you shall take of the ram the
          fat and the rump, and the fat that covers the inwards, and the caul
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And one loaf of bread, and one cake
          of oiled bread, and one wafer out of the basket of the unleavened
          bread that is before the LORD:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And you shall put all in the hands
          of Aaron, and in the hands of his sons; and shall wave them for a Wave
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And you shall receive them of their
          hands, and burn them upon the Altar for a Burnt Offering, for a Sweet
      ...
      <p className="calibre_20">
        <span className="bold1">THE PEACE OFFERINGS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">26</sup>And you shall take the breast of the
          ram of Aarons consecration, and wave it for a Wave Offering before the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>And you shall sanctify the breast of
          the Wave Offering, and the shoulder of the Heave Offering, which is
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And it shall be Aarons and his sons
          by a Statute for ever from the Children of Israel: for it is an Heave
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                had accepted the Offerings, and Peace with God was restored. A
                part of the flesh of the Peace Offering was to be given to the
                Priests and, as well, to the individuals who offered up the
                Sacrifice. They were then to have a feast, celebrating the
                restored Peace. Under the New Covenant, we do the same thing
                now, by simply praising the Lord; however, all of this tells us
                that our praises must ever be based on the fact of what Christ
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>And the holy garments of Aaron shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And that son that is Priest in his
          stead shall put them on seven days, when he comes into the Tabernacle
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                The consecration which lasted for seven days, seven being Gods
                number of perfection, all typified the Perfection of Christ [
                <ScrollLink href="/hebrews-07" scrollToId="#filepos14498995">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 7:26-27</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And you shall take the ram of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>And Aaron and his sons shall eat the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-06" scrollToId="#filepos12421893">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">John 6:53-63</span>
                    </span>
                  </span>
                </ScrollLink>
                ; this is symbolic of one accepting all that Christ did at the
                Cross)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-10" scrollToId="#filepos12508598">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 10:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>And they shall eat those things
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>And if ought of the flesh of the
          consecrations, or of the bread, remain unto the morning, then you
          shall burn the remainder with fire: it shall not be eaten, because it
          is holy.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>And thus shall you do unto Aaron,
          and to his sons, according to all things which I have commanded you:
          seven days shall you consecrate them.
        </span>
      </p>
      <p className="calibre_21" id="filepos1112442">
        <span className="bold1">
          <sup className="calibre7">36</sup>And you shall offer every day a
          bullock for a Sin Offering for Atonement: and you shall cleanse the
          Altar, when you have made an Atonement for it, and you shall anoint
          it, to sanctify it.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                that Jesus died spiritually while on the Cross. This meant He
                died as a sinner and went to the burning side of Hell, which is
                not taught in the Bible. The Bible doesnt teach that Redemption
                was afforded in Hell, but rather on the Cross [
                <ScrollLink href="/ephesians-2" scrollToId="#filepos14013172">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Eph. 2:13-18</span>
                ...
                ]. Despite the fact that the Cross was a place where sin was
                atoned, still, Christ, by His Perfection, sanctified it in
                totality.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">37</sup>Seven days you shall make an
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]. All of this tells us that there is no holiness for Believers
      ...
      <p className="calibre_20">
        <span className="bold1">THE DAILY OFFERINGS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">38</sup>Now this is that which you shall
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/luke-09" scrollToId="#filepos11907007">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lk. 9:23-24</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">39</sup>The one lamb you shall offer in the
          morning{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                evening sacrifice [
                <ScrollLink href="/luke-23" scrollToId="#filepos12247206">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lk. 23:44-46</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">40</sup>And with the one lamb a tenth deal
          of the flour{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of the olives [
                <ScrollLink href="/matthew-03" scrollToId="#filepos10857256">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 3:16</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/matthew-04" scrollToId="#filepos10858743">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">4:1-11</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/peter1-1" scrollToId="#filepos14675325">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Pet. 1:8</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">41</sup>And the other lamb you shall offer
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/matthew-03" scrollToId="#filepos10858056">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 3:17</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">42</sup>This shall be a continual Burnt
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">43</sup>And there I will meet with the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/hebrews-10" scrollToId="#filepos14539500">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 10:10</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">44</sup>And I will sanctify the Tabernacle
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Priests were sanctified, because they were Types of Christ; it
                must be noted that it is all in Christ and what He did at the
                Cross)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE PROMISE</span>
      </p>
      <p className="calibre_18" id="filepos1118821">
        <span className="bold1">
          <sup className="calibre7">45</sup>And I will dwell among the Children
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">46</sup>And they shall know that I am the
          LORD their God, Who brought them forth out of the land of Egypt, that
      ...
      <div className="mbp_pagebreak" id="calibre_pb_93"></div>
    </div>
  );
}
