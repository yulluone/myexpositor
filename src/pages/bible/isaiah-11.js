...
export default function Isaiah11() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7397010">
        CHAPTER 11
      </h3>
      ...
      <p className="calibre_18" id="filepos7397250">
        <span className="bold1">
          <sup className="calibre7">1</sup>And there shall come forth a Rod out
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                branch, which means a tender shoot sprouting out of the root of
                a dead, fallen tree, referring both to humanity in general and
                Israel in particular. Jesse was Davids father, and through this
                family the Messiah would come; and so He did!)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21" id="filepos7397919">
        <span className="bold1">
          <sup className="calibre7">2</sup>And the Spirit of the LORD shall rest
          upon Him{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And shall make Him of quick
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]. As a result, His Judgment of all things will be perfect)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21" id="filepos7399049">
        <span className="bold1">
          <sup className="calibre7">4</sup>But with Righteousness shall He judge
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And Righteousness shall be the girdle
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                will witness perfection. In fact, the Man Christ Jesus will be
                girdled with Perfection.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">CONDITIONS DURING THE MILLENNIUM</span>
      </p>
      <p className="calibre_18" id="filepos7400224">
        <span className="bold1">
          <sup className="calibre7">6</sup>The wolf also shall dwell with the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And the sucking child shall play on
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-03" scrollToId="#filepos54208">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 3:14</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_20">
        <span className="bold1">EXTENT OF MESSIAHS REIGN</span>
      </p>
      <p className="calibre_18" id="filepos7401648">
        <span className="bold1">
          <sup className="calibre7">9</sup>They shall not hurt nor destroy in
      ...
      <p className="calibre_21" id="filepos7402143">
        <span className="bold1">
          <sup className="calibre7">10</sup>And in that day there shall be a
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The root of Jesse refers to David and the Promise made by the
                Lord to David in II Sam., Chpt.{" "}
                ...
                . Hence, Christ is really the root of Jesse, the Son of David.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">ISRAEL, GODS PEOPLE, TO BE RESTORED</span>
      </p>
      <p className="calibre_18" id="filepos7403058">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Medo-Persian Empire and brought back to the Promised Land. In a
                sense, the second gathering began in 1948. It will be fulfilled
                in totality at the beginning of the Kingdom Age, when Jews all
                over the world will recognize Christ as their Messiah and,
                thereby, desire to come to Israel and live near Him.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And He shall set up an ensign for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The central theme of this Verse is Christ. Israel will now
                [during the Kingdom Age] recognize Him, and Him Alone, as their
                True Messiah. Jerusalem, the place of His Crucifixion, will now
                be the place of His Glory. The Jews will come to this Glory from
      ...
      <p className="calibre_21" id="filepos7404795">
        <span className="bold1">
          <sup className="calibre7">13</sup>The envy also of Ephraim shall
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Kingdom. The Holy Spirit is saying that the old envy between the
                two will be forever dissipated. The nation will be one again,
                but only in Christ.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>But they shall fly upon the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ;{" "}
                <ScrollLink href="/numbers-34" scrollToId="#filepos2090324">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 34:1-12</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/isaiah-60" scrollToId="#filepos8021977">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isa. 60:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/ezekiel-47" scrollToId="#filepos9718350">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ezek. 47:13</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/ezekiel-48" scrollToId="#filepos9739199">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">48:35</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And the LORD shall utterly destroy
          the tongue of the Egyptian sea; and with His mighty Wind shall He
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And there shall be an highway for
          the remnant of His People, which shall be left, from Assyria; like as
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The whole of this part of the world is presently gripped in the
                Satanic maw of Islam. The prediction is that not only will the
                topography of the Middle East be changed, but the demonic
                control of the region will be dispelled, as well.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_753"></div>
    </div>
  );
}
