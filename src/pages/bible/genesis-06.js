...
export default function Genesis06() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos90766">
        CHAPTER 6
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(2448 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">WICKEDNESS OF MANKIND</h3>
      <p className="calibre_18" id="filepos90990">
        <span className="bold1">
          <sup className="calibre7">1</sup>And it came to pass, when men began
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Earth at that time.{" "}
                <ScrollLink href="/" scrollToId="#filepos90990">
                ...
                is not meant to imply that the births of baby girls were more
                than that of baby boys, but is rather meant to set up the
                narrative for that which is about to be said)
              </span>
            </span>
          </span>
          ,
      ...
      <p className="calibre_21" id="filepos91685">
        <span className="bold1">
          <sup className="calibre7">2</sup>That the sons of God saw the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                human lineage through which the Messiah would ultimately come,
                they would seek to corrupt that lineage, and to do so by
                marrying the daughters of men, thereby producing a mongrel race,
                so to speak, of which at least some of these offspring turned
                out to be giants; at any rate, all who were the result of such a
                union were tainted; the term sons of God in the Old Testament,
                at least as it is used here, is never used of human beings, but
                always of Angels, whether righteous or fallen [
                <ScrollLink href="/job-01" scrollToId="#filepos5348024">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Job 1:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                ...
                ]; in his short Epistle, Jude mentions these particular Angels.
                He said that they kept not their first estate, but left their
                own habitation; he then said what their sin was: going after
                strange flesh. Concerning this, Jude also said that God has
                reserved [them] in everlasting chains unto darkness unto the
                Judgment of the great day [Jude,{" "}
                <ScrollLink href="/" scrollToId="#filepos95777">
                  <span className="calibre_19">
                    <span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE WARNING OF GOD</span>
      </p>
      <p className="calibre_18" id="filepos93417">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Flood; however, it has nothing to do with the Flood, as we will
                later prove)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos94308">
        <span className="bold1">
          <sup className="calibre7">4</sup>There were giants in the Earth in
          those days{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And God saw that the wickedness of
      ...
      <p className="calibre_21" id="filepos95777">
        <span className="bold1">
          <sup className="calibre7">6</sup>And it repented the LORD that He had
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And the LORD said, I will destroy man
      ...
      <p className="calibre_20">
        <span className="bold1">NOAH AND THE ARK</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">8</sup>But Noah found Grace in the sight of
          the LORD{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/hebrews-11" scrollToId="#filepos14557759">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 11:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And Noah begat three sons, Shem,
          Ham, and Japheth{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-05" scrollToId="#filepos90335">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verse</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                of the previous Chapter that these sons were not born to Noah
                until he was some 500 years old)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>The Earth also was corrupt before
      ...
      <p className="calibre_21" id="filepos98934">
        <span className="bold1">
          <sup className="calibre7">12</sup>And God looked upon the Earth, and,
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/psalm-014" scrollToId="#filepos5727186">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 14:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/psalm-033" scrollToId="#filepos5850536">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">33:13-14</span>
                    </span>
                  </span>
                </ScrollLink>
                ]
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                through an uncorrupted lineage. Other than Noah and his family,
                the entirety of the human race was polluted)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And God said unto Noah, The end of
      ...
      <p className="calibre_21" id="filepos100754">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And this is the fashion which you
          shall make it of: The length of the Ark shall be three hundred cubits,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>A window shall you make to the Ark,
          and in a cubit shall you finish it above; and the door of the Ark
          shall you set in the side thereof; with lower, second, and third
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                but also of ventilating it; it probably was an open space about
                18 inches high, running all around the Ark, which would have
                given a sufficient supply of air, and would have been protected
                by the overhanging eaves of the roof; as well, it is believed
                that the door probably extended throughout the three floors or
                stories. The Ark would probably have displaced about 30,000 tons
                or more; consequently, it was a monstrous ship)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And, behold, I, even I, do bring a
          flood of waters upon the Earth, to destroy all flesh, wherein is the
          breath of life, from under heaven; and everything that is in the Earth
          shall die{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>But with you will I establish My
          Covenant{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          ; and you shall come into the Ark, you, and your sons, and your wife,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And of every living thing of all
          flesh, two of every sort shall you bring into the Ark, to keep them
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                equal number of birds be added and 12 cubic feet allotted to
                each animal and to each bird, the total number of cubic feet so
                used would be about one million, leaving approximately two
                million cubic feet for provisions; so I think it should be
                obvious that there was an abundance of room in the Ark for its
                inhabitants)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos104161">
        <span className="bold1">
          <sup className="calibre7">20</sup>Of fowls after their kind, and of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And take you unto you of all food
          that is eaten, and you shall gather it to you; and it shall be for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Thus did Noah; according to all that
      ...
      <div className="mbp_pagebreak" id="calibre_pb_16"></div>
    </div>
  );
}
