...
export default function Corinthians205() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13814010">
        CHAPTER 5
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">WITH THE LORD</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>For we know that if our earthly house
          of{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>If so be that being clothed we shall
          not be found naked{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13747673"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 15:41-42</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>For we who are in{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">this</span>
            </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  href="/corinthians1-15"
                  scrollToId="#filepos13744285"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 15:35-54</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Now He Who has wrought us for the
          selfsame thing{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Therefore{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13817725">
        <span className="bold1">
          <sup className="calibre7">8</sup>We are confident,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">LABOR</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>For we must all appear before the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">done</span>
            </span>
          </span>{" "}
          in{" "}
          <span className="italic1">
          ...
          body, according to that he has done, whether{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Knowing therefore the terror of the
          Lord{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For we commend not ourselves again
          unto you{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">answer</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>For whether we be beside ourselves,{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">RECONCILIATION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Wherefore henceforth know we no man
          after the flesh{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos13822721">
        <span className="bold1">
          <sup className="calibre7">17</sup>Therefore if any man{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And all things{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13824181">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Now then we are Ambassadors for
          Christ{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos13825725">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1198"></div>
    </div>
  );
}
