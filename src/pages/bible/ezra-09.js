...
export default function Ezra09() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos5109489">
        CHAPTER 9
      </h3>
      <h3 className="calibre_17">(457 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">SIN IS DISCOVERED AND SORROW EXPRESSED</span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>For they have taken of their
          ...
          those lands: yes, the hand of the princes and rulers has been chief in
          this trespass{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                He intended them to be, whether they were, in fact, that or not)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And when I heard this thing, I rent
          my garment and my mantle, and plucked off the hair of my head and of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Then were assembled unto me every one
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                divinely inspired Repentance always brings the soul to Calvary)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_20">
        <span className="bold1">EZRAS PRAYER AND CONFESSION OF SIN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>And at the evening Sacrifice I arose
      ...
      <p className="calibre_21" id="filepos5112511">
        <span className="bold1">
          <sup className="calibre7">6</sup>And said, O my God, I am ashamed and
          blush to lift up my face to You, my God: for our iniquities are
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Since the days of our fathers have we
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And now for a little space grace has
          been showed from the LORD our God, to leave us a remnant to escape,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                appreciated, for the truth is, they deserve no Grace at all)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For we were bondmen; yet our God has
          not forsaken us in our bondage, but has extended mercy unto us in the
          sight of the kings of Persia, to give us a reviving, to set up the
          House of our God, and to repair the desolations thereof, and to give
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                State of Israel is limited, and we speak of the Arabs, which
                occupy a good part of the Land of Israel)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And now, O our God, what shall we
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Which You have commanded by Your
          servants the Prophets, saying, The land, unto which you go to possess
      ...
      <p className="calibre_21" id="filepos5115571">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now therefore give not your
          daughters unto their sons, neither take their daughters unto your
          sons, nor seek their peace or their wealth for ever: that you may be
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And after all that is come upon us
          for our evil deeds, and for our great trespass, seeing that You our
          God have punished us less than our iniquities deserve, and have given
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Should we again break Your
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                result, the entire nation was destroyed, which took place in
                A.D. 70, and is only now beginning to come back, which began in
                1948.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>O LORD God of Israel, You are
          righteous: for we remain yet escaped, as it is this day: behold, we
          are before You in our trespasses: for we cannot stand before You
          because of this{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_458"></div>
    </div>
  );
}
