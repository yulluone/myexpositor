...
export default function Acts12() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos12973800">
        CHAPTER 12
      </h3>
      <h3 className="calibre_17">(A.D. 44)</h3>
      <p className="calibre_20">
        <span className="bold1">PERSECUTION</span>
      </p>
      <p className="calibre_18" id="filepos12973976">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And he killed James the brother of
          John with the sword{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                in Office; in other words, there is no such thing as Apostolic
                Succession, as taught by some)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">3</sup>And because he saw it pleased the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And when he had apprehended him, he
          put{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-04" scrollToId="#filepos12810344">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 4:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/acts-05" scrollToId="#filepos12835789">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">5:18-19</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Peter therefore was kept in prison:
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And when Herod would have brought him
          forth{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/john-21" scrollToId="#filepos12744654">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 21:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>And, behold, the Angel of the Lord
          came upon{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">him</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And the Angel said unto him, Gird
          yourself, and bind on your sandals. And so he did. And he said unto
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          ; and wist not that it was true which was done by the Angel; but
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>When they were past the first and
          the second ward{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                made all of this invisible to these individuals)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">PETERS ACCOUNT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>And when he had considered{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">the thing,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And as Peter knocked at the door of
          the gate{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">the door,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>But he, beckoning unto them with the
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">18</sup>Now as soon as it was day, there was
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And when Herod had sought for him,
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Herod was highly displeased with
          ...
          ; because their country was nourished by the kings{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And upon a set day Herod, arrayed in
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">saying, It is</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And immediately the Angel of the
          Lord smote him{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>But the Word of God grew and
          multiplied{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And Barnabas and Saul returned from
          Jerusalem{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1139"></div>
    </div>
  );
}
