...
export default function Deuteronmy05() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos2171106">
        CHAPTER 5
      </h3>
      <h3 className="calibre_17">(1451 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">ISRAEL AND GODS COVENANT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And Moses called all Israel, and said
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>The LORD our God made a Covenant with
          us in Horeb.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>The LORD made not this Covenant with
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>The LORD talked with you face to face
          in the Mount of the midst of the fire,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>(I stood between the LORD and you at
          that time, to show you the Word of the LORD: for you were afraid by
          reason of the fire, and went not up into the Mount;) saying,
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE TEN COMMANDMENTS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">6</sup>I am the LORD your God, which brought
          you out of the land of Egypt, from the house of bondage.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>You shall have none other gods before
          Me.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                There is but one God, and that God is Jehovah, the self-existent
                and eternal, Who yet has personal relations with men.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>You shall not make you any graven
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>You shall not bow down yourself unto
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                the Salvation of one person in such a family breaks such a
                curse, not only for the person, but greatly ameliorates the
                effect on the unsaved members of the family also [
                <ScrollLink
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And showing mercy unto thousands of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>You shall not take the Name of the
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/leviticus-19" scrollToId="#filepos1543790">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lev. 19:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Keep the Sabbath day to sanctify it,
          as the LORD your God has commanded you.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Six days you shall labor, and do all
          your work:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>But the seventh day is the Sabbath
          ...
          your ox, nor your ass, nor any of your cattle, nor your stranger that
          is within your gates; that your manservant and your maidservant may
          rest as well as you.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And remember that you were a servant
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                the defenseless. Israel is enjoined here to remember that she
                herself was a slave in the land of Egypt. Presently, all who
                accept Christ, Who in effect is the Sabbath, in essence keep the
                Sabbath. The Sabbath in its entirety speaks of rest, which is a
                type of the rest which is found only in Christ [
      ...
      <p className="calibre_21" id="filepos2176567">
        <span className="bold1">
          <sup className="calibre7">16</sup>Honour your father and your mother,
          as the LORD your God has commanded you; that your days may be
          prolonged, and that it may go well with you, in the land which the
      ...
      <p className="calibre_21" id="filepos2177076">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>Neither shall you bear false witness
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Neither shall you desire your
          neighbours wife, neither shall you covet your neighbours house, his
      ...
      <p className="calibre_20">
        <span className="bold1">GODS PRESENCE</span>
      </p>
      <p className="calibre_18" id="filepos2178343">
        <span className="bold1">
          <sup className="calibre7">22</sup>These words the LORD spoke unto all
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And it came to pass, when you heard
          the Voice out of the midst of the darkness, (for the mountain did burn
          with fire,) that you came near unto me, even all the heads of your
          Tribes, and your Elders;
        </span>
      </p>
      <p className="calibre_21" id="filepos2179071">
        <span className="bold1">
          <sup className="calibre7">24</sup>And you said, Behold, the LORD our
          God has showed us His Glory and His Greatness, and we have heard His
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>Now therefore why should we die? for
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>For who is there of all flesh, who
          has heard the Voice of the Living God speaking out of the midst of the
          fire, as we have, and lived?
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>Go thou near, and hear all that the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And the LORD heard the voice of your
          words, when you spoke unto me; and the LORD said unto me, I have heard
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>O that there were such an heart in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>Go say to them, Get you into your
          tents again{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos2181472">
        <span className="bold1">
          ...
          Commandments, and the Statutes, and the Judgments, which you shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>You shall observe to do therefore as
          the LORD your God has commanded you: you shall not turn aside to the
          right hand or to the left.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>You shall walk in all the ways which
          the LORD your God has commanded you, that you may live, and that it
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                consequently, all of this pertains to our Salvation. When we
                read these Old Testament accounts, we should understand that
                each happening brings us a few steps closer to the Redemption we
                now possess in Christ. Understanding it in that fashion makes it
                much more important actually, the single most important thing in
                the world.)
              </span>
            </span>
          </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_184"></div>
    </div>
  );
}
