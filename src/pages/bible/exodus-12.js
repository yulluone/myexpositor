...
export default function Exodus12() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos820488">
        CHAPTER 12
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(1491 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">THE PASSOVER</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And the LORD spoke unto Moses and
      ...
      <p className="calibre_21" id="filepos820944">
        <span className="bold1">
          <sup className="calibre7">2</sup>This month shall be unto you the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Prescribed Order of Victory, which is Faith in Christ and the
                Cross exclusively, which then gives the Holy Spirit latitude to
                work, thereby bringing about the graces of the Fruit of the
                Spirit [
                ...
                ;{" "}
                <ScrollLink href="/galatians-5" scrollToId="#filepos13974801">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gal. 5:16-25</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. All Believers have more abundant life [
                ...
                ], but all Believers are not enjoying more abundant life and, in
                fact, cannot until they learn Gods Prescribed Order of Victory,
                which is the Cross [
                <ScrollLink
      ...
      <p className="calibre_21" id="filepos822857">
        <span className="bold1">
          <sup className="calibre7">3</sup>Speak ye unto all the congregation of
          Israel, saying{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                and ecclesiastical, was received by Divine Revelation, commanded
                by God, and merely established by the agency of the two
                brothers. This proclaims the fact that Salvation is all of God
                and none of man. This problem presents itself when man attempts
                to insert his means and ways into that which God has devised,
                which, in fact, the modern Church is now doing)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-04" scrollToId="#filepos62716">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Fourth Chapter</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                of Genesis, it is a lamb for each person. Now it is a lamb for
                each house. Upon the giving of the Law, it would be a lamb for
                the entirety of the nation. But when Jesus came, He would be the
                Lamb for the entirety of the world [
                ...
                ]. The offering up of the Lamb in Sacrifice was a Type of
                Christ, and what He would do at the Cross, all on our behalf.
                The lamb represented innocence and gentleness. The Prophets
                represented the tender compassion of God for His people under
                the figure of the Shepherd and the Lamb [
                <ScrollLink href="/isaiah-40" scrollToId="#filepos7726451">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isa. 40:11</span>
                    </span>
                  </span>
                </ScrollLink>
                ], and ultimately the intention of God for His people used the
                lamb as an important symbol; therefore, the Lamb was a worthy
                symbol of our Saviour, Who, in innocence, patiently endured
                suffering as our Substitute [
                <ScrollLink href="/peter1-1" scrollToId="#filepos14682758">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Pet. 1:19</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And if the household be too little
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                It is the same as it regards Salvation, which is always very
                personal.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos825488">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos826406">
        <span className="bold1">
          <sup className="calibre7">6</sup>And you shall keep it up until the
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos822857">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Vs. 3</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; it was to be minutely inspected during these four days, that
                no trace of illness would be observed; representing Christ, it
                had to be perfect)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Cross of Calvary [
                <ScrollLink href="/matthew-27" scrollToId="#filepos11317905">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 27:46</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21" id="filepos827316">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13589232"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Corinthians 5:7-8</span>
                    </span>
                  </span>
                </ScrollLink>
                , we have the Divine Authority for our regarding the contents of
                Exodus,{" "}
                <ScrollLink href="/" scrollToId="#filepos820488">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Chapter 12</span>
                    </span>
                  </span>
                </ScrollLink>
                , as typical of what our Blessed Saviour did on the Cross; at
                the deliverance of the Children of Israel from Egypt, the blood,
                which represented the shed Blood of Christ, was to be put on the
                side posts and the upper posts of the house; later, it would be
                applied to the Mercy Seat on the Great Day of Atonement; now, by
                Faith, it is applied to our hearts [
      ...
      <p className="calibre_21" id="filepos828569">
        <span className="bold1">
          <sup className="calibre7">8</sup>And they shall eat the flesh in that
          night{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-06" scrollToId="#filepos12421893">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">John 6:53-55</span>
                    </span>
                  </span>
                </ScrollLink>
                ; of course, He wasnt speaking of His flesh literally being
                eaten, but was speaking rather of our Faith in Him and what He
                would do for us at the Cross; our Faith must be in the entirety
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/hebrews-07" scrollToId="#filepos14498995">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 7:26</span>
                    </span>
                  </span>
                </ScrollLink>
                ], of which the lack of leaven was a Type)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-01" scrollToId="#filepos687138">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 1:14</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; as well, the Cross ever reminds us presently of that from
                which we were redeemed, abject slavery to Satan)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Eat not of it raw, nor sodden at all
          with water{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                partaking of all of the Cross. Sin goes to the very vitals;
                therefore, for sin to be properly addressed, and in every
                capacity, everything that Christ did at the Cross must be
                accepted, and without fail.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And you shall let nothing of it
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                example, even a miracle worker, but they care not for the Cross;
                if Christ is to be had at all, He can only be had by and through
                the Cross; otherwise, we have another Jesus [
                <ScrollLink
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                is the Source, while the Cross is the Means.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos831872">
        <span className="bold1">
          <sup className="calibre7">11</sup>And thus shall you eat it; with your
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                more we lay hold by simple Faith of what the Cross meant to God,
                the more stable will be our peace, and the deeper our joy and
                praise. The Passover was ever a Type of the Cross. In{" "}
                <ScrollLink
                  href="/corinthians1-05"
                  scrollToId="#filepos13589232"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Corinthians 5:7</span>
                    </span>
                  </span>
                </ScrollLink>
                , we read: Christ our Passover. He is now our Passover, because
                He was first the LORDs Passover.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For I will pass through the land of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                According to{" "}
                <ScrollLink href="/" scrollToId="#filepos844689">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Exodus 12:23</span>
                    </span>
                  </span>
                </ScrollLink>
                , the Lord did not personally go through the land of Egypt that
                particular night, but rather that He used an Angel. The beasts
                were included, because animal worship was an important part of
                the religion of the Egyptians. So, the Lord directed His
                judgment against every facet of Egyptian life and living.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos834321">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the blood shall be to you for a
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                come, Who would redeem mankind by the shedding of His Lifes
                Blood)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                in the house would be spared; it was not a question of personal
                worthiness, self had nothing whatever to do in the matter; it
                was a matter of faith; all under the cover of the blood were
                safe, just as all presently under the cover of the Blood are
                safe; this means that they were not merely in a savable state,
                but rather that they were saved; as well, they were not partly
                saved and partly exposed to judgment, they were wholly saved,
                and because there is no such thing as partial Justification; the
                Lord didnt say, When I see you, or, When I see your good works,
                etc., but, When I see the blood; this speaks of Christ and what
                He would do at the Cross in order that we might be saved, which
                pertained to Him giving Himself in Sacrifice, which necessitated
                the shedding of His Precious Blood [
                <ScrollLink href="/peter1-1" scrollToId="#filepos14682045">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Pet. 1:18-19</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21" id="filepos836297">
        <span className="bold1">
          <sup className="calibre7">14</sup>And this day shall be unto you for a
            ...
            <span>
              <span className="explanation">
                ...
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 5:7-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. In this way, the Passover may be regarded as still continuing
                unto Christianity, and is intended to continue, at least
                throughout the Kingdom Age, which is yet to come. The Passover
                per se is not continued, simply because it represented the Type,
                which was carried out through the offering of clean animals. Now
                that Christ has come and fulfilled the Type, it would not be
                proper to eat the Passover as it once was celebrated, and
                because all that it symbolized or represented was fulfilled in
                Christ.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Seven days shall you eat unleavened
          bread{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                in totality; in other words, He was not Perfect just some of the
                time, but was Perfect all of the time)
              </span>
            </span>
          </span>
          ; even the first day you shall put away leaven out of your houses: for
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                from the domination of sin, which can only be done by one ever
                making the Cross the object of ones Faith, which then gives the
                Holy Spirit latitude to work in ones life; otherwise, it cannot
                be done [
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And in the first day there shall be
          an holy convocation{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos839874">
        <span className="bold1">
          <sup className="calibre7">17</sup>And you shall observe the Feast of
          Unleavened Bread; for in this selfsame day have I brought your armies
          out of the land of Egypt: therefore shall you observe this day in your
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>In the first month, on the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                but rather the Foundation of all Doctrine [
                <ScrollLink href="/peter1-1" scrollToId="#filepos14682045">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Pet. 1:18-19</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>Seven days shall there be no leaven
          found in your houses: for whosoever eats that which is leavened, even
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                for the entirety of the world, and the only answer!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>Then Moses called for all the Elders
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                institution and ritual of the Passover supply us with one of the
                most striking and blessed foreshadowments of the Cross-work of
                Christ to be found anywhere in the Old Testament. Its importance
                may be gathered from the frequency which the title of Lamb is
                afterwards applied to the Saviour, a title which looks back to
                what is before us in Exodus 12 [
                <ScrollLink href="/john-01" scrollToId="#filepos12298674">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 1:29</span>
      ...
      <p className="calibre_21" id="filepos843168">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                a type of grass which grew in crevices between the rocks)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                to His sin-bearing; it was the grand and only scene of
                sin-bearing; He did not bear our sins anywhere else; He did not
                bear them in the manger, nor in the wilderness, nor in the
                Garden, but only on the Tree [
                <ScrollLink href="/peter1-2" scrollToId="#filepos14702003">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Pet. 2:24</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                application, just as there is no safety presently outside of
                this application.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos844689">
        <span className="bold1">
          <sup className="calibre7">23</sup>For the LORD will pass through to
          smite the Egyptians; and when He sees the blood upon the lintel, and
      ...
      <p className="calibre_21" id="filepos845191">
        <span className="bold1">
          <sup className="calibre7">24</sup>And you shall observe this thing for
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos836297">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 12:14</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/" scrollToId="#filepos839874">
                  <span className="calibre_19">
                    <span>
                ...
                ,{" "}
                <ScrollLink href="/" scrollToId="#filepos845191">
                  <span className="calibre_19">
                    <span>
                ...
                <ScrollLink href="/exodus-13" scrollToId="#filepos864601">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Exodus 13:10</span>
                    </span>
                  </span>
                </ScrollLink>
                . In essence, this tells us that the Work of Christ on the Cross
                was, and is, a Finished Work, which means that it will never
                have to be repeated, and there will never have to be anything
                added.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And it shall come to pass, when you
          be come to the land which the LORD will give you, according as He has
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And it shall come to pass, when your
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>That you shall say, It is the
          sacrifice of the LORDs Passover, who passed over the houses of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And the Children of Israel went
      ...
      <p className="calibre_20">
        <span className="bold1">DEATH OF THE FIRSTBORN</span>
      </p>
      <p className="calibre_18" id="filepos847917">
        <span className="bold1">
          <sup className="calibre7">29</sup>And it came to pass, that at
          midnight the LORD smote all the firstborn in the land of Egypt, from
          the firstborn of Pharaoh who sat on his throne unto the firstborn of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And Pharaoh rose up in the night,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                soul. The great cry was not only for their dead, but, as well,
                that Pharaoh would let Israel go.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And he called for Moses and Aaron by
          night, and said, Rise up, and get you forth from among my people, both
          you and the Children of Israel; and go, serve the LORD, as you have
          said.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-05" scrollToId="#filepos733469">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">5:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. He now knows as to exactly Who is the Lord!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>Also take your flocks and your
      ...
      <p className="calibre_21" id="filepos849867">
        <span className="bold1">
          <sup className="calibre7">33</sup>And the Egyptians were urgent upon
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>And the people took their dough
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>And the Children of Israel did
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">36</sup>And the LORD gave the people favour
      ...
      <p className="calibre_20">
        <span className="bold1">THE EXODUS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">37</sup>And the Children of Israel journeyed
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">38</sup>And a mixed multitude went up also
          with them{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-10" scrollToId="#filepos811511">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">10:26,</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">39</sup>And they baked unleavened cakes of
      ...
      <p className="calibre_21" id="filepos852732">
        <span className="bold1">
          <sup className="calibre7">40</sup>Now the sojourning of the Children
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                are reckoned. They actually spent some 215 years in Egypt
                proper.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">41</sup>And it came to pass at the end of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">42</sup>It is a night to be much observed
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ceremonial institutions, was superseded and abolished, was a
                night of the Lord much more to be observed; when a yoke, heavier
                than that of Egypt, was broken from off our necks, and a land
                better than that of Canaan, set before us. That first Passover
                was a temporal deliverance to be celebrated in their generation;
                this an eternal Redemption to be celebrated in the praises of
                glorious Saints, world without end Matthew Henry.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">43</sup>And the LORD said unto Moses and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                partake of Him without accepting Him as Saviour and Lord)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">44</sup>But every mans servant who is bought
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                crucified with Christ; nevertheless the Church lives by the Life
                of Christ known and exhibited on Earth, through the Power of the
                Holy Spirit [
                <ScrollLink href="/romans-08" scrollToId="#filepos13387535">
                  <span className="calibre_19">
                    <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">45</sup>A foreigner and a hired servant
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                boundary between the Church and the world.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos856300">
        <span className="bold1">
          <sup className="calibre7">46</sup>In one house shall it be eaten; you
          shall not carry forth ought of the flesh abroad out of the house;
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                it be known, there is no Salvation out of this house. As well,
                not a bone of Christ was broken in the Crucifixion, signifying
                that the True Body of Christ is one.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">47</sup>All the congregation of Israel shall
          keep it.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">48</sup>And when a stranger shall sojourn
          with you, and will keep the Passover to the LORD, let all his males be
          circumcised, and then let him come near and keep it; and he shall be
          as one who is born in the land: for no uncircumcised person shall eat
          thereof.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                be, they must exhibit Faith in Christ and what He has done for
                us at the Cross.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">49</sup>One law shall be to him who is
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">50</sup>Thus did all the Children of Israel;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">51</sup>And it came to pass the selfsame
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Him, they possessed great power.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_76"></div>
    </div>
  );
}
