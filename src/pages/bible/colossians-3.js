...
export default function Colossians3() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14164912">
        CHAPTER 3
      </h3>
      <h3 className="calibre_17">(A.D. 64)</h3>
      <p className="calibre_20">
        <span className="bold1">NEW LIFE</span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>When Christ,{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="calibre_19">
                ...
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Cor. 15:51-57</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
      ...
      <p className="calibre_20">
        <span className="bold1">PUT OFF</span>
      </p>
      <p className="calibre_18" id="filepos14167229">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Spirit latitude to work in our lives)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>For which things sake the Wrath of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>In the which you also walked some
          time{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">PUT ON</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">10</sup>And have put on the new{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Where there is neither Greek nor
          Jew, Circumcision nor uncircumcision, Barbarian, Scythian, bond{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">nor</span>
            </span>
          </span>{" "}
          free{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Put on therefore, as the Elect of
          God{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And above all these things{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">put on</span>
            </span>
          </span>{" "}
          charity{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And let the Peace of God rule in
          your hearts{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Let the Word of Christ dwell in you
          ...
          ; teaching and admonishing one an other in Psalms and Hymns and
          Spiritual Songs{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And whatsoever you do in word or
          deed,{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">do</span>
      ...
      <p className="calibre_20">
        <span className="bold1">DOMESTIC LIFE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">18</sup>Wives, submit yourselves unto your
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>Husbands, love{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">CHILDREN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">20</sup>Children, obey{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">your</span>
            </span>
      ...
      <p className="calibre_20">
        <span className="bold1">FATHERS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">21</sup>Fathers, provoke not your children{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">to anger,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And whatsoever you do, do{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>Knowing that of the Lord you shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>But he who does wrong shall receive
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1233"></div>
    </div>
  );
}
