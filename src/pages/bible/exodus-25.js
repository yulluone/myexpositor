...
export default function Exodus25() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos1025496">
        CHAPTER 25
      </h3>
      ...
      <h3 className="calibre_17">THE TABERNACLE</h3>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          that they bring Me an Offering: of every man who gives it willingly
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/" scrollToId="#filepos1025496">
                  <span className="calibre_19">
                    <span>
                ...
                to the end of{" "}
                <ScrollLink href="/exodus-40" scrollToId="#filepos1263267">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Chapter 40</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                except the important parenthesis in 32 to 34 the Holy Spirit has
                given us a detailed description of the Tabernacle, its
                structure, furniture, and Priesthood. When we consider, and
                understand, that more space is devoted to the account of the
                Tabernacle than to any other single object or subject treated in
                the Bible, we then begin to understand its vast significance. It
                took but two Chapters to portray the record of Gods Work in
                creating this Earth, and fitting it for human habitation. By
                comparison, some 12 Chapters are needed to tell us about the
                Tabernacle.
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The reason? Everything about the Tabernacle pointed to Christ,
                and was a Type of Christ in some way.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And this is the Offering which you
          shall take of them; gold, and silver, and brass,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And blue, and purple, and scarlet,
          and fine linen, and goats hair,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And rams skins dyed red, and badgers
          skins, and shittim wood,
        </span>
      </p>
      <p className="calibre_21" id="filepos1027634">
        <span className="bold1">
          <sup className="calibre7">6</sup>Oil for the light, spices for
          anointing oil, and for sweet incense,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Onyx stones, and stones to be set in
      ...
      <p className="calibre_21" id="filepos1028123">
        <span className="bold1">
          <sup className="calibre7">8</sup>And let them make Me a Sanctuary:
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                from plans furnished by direct Revelation from God [
                <ScrollLink href="/genesis-06" scrollToId="#filepos100754">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 6:14-16</span>
                    </span>
                  </span>
                </ScrollLink>
                ; I{" "}
                <ScrollLink href="/genesis-28" scrollToId="#filepos386493">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Chron. 28:11-12</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/genesis-28" scrollToId="#filepos390474">
                  <span className="calibre_19">
                    <span>
                ...
                ]. Since the Fall of man in the Garden of Eden, the Lord has
                been working steadily to bring man back to Himself. He longs to
                dwell with us, and that He now does, all made possible by the
                Cross.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>According to all that I show you,
      ...
      <p className="calibre_20">
        <span className="bold1">ARK OF THE COVENANT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And you shall overlay it with Pure
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And you shall cast four rings of
          gold for it{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And you shall make staves of Shittim
          Wood{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                which makes His perpetual Presence possible)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And you shall put the staves into
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>The staves shall be in the rings of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                staves [
                <ScrollLink href="/kings1-08" scrollToId="#filepos3793041">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 8:6-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And you shall put into the Ark the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And you shall make a Mercy Seat of
          Pure Gold{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Blood-sprinkled Mercy Seat that God spoke when He said: There
                will I meet with you; here, in Type, was the only meeting place
                between God and the sinner; here, Righteousness and Peace kissed
                each other; it was all gold, signifying the Deity of Christ,
                signifying also that His Deity was not marred by Him becoming
                Man; Christ is the Mercy Seat)
              </span>
            </span>
          </span>
          : two cubits and a half shall be the length thereof{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And you shall make two Cherubims of
          gold{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , of beaten work shall you make them, in the two ends of the Mercy
          Seat.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Cherubim looked down on the Mercy Seat.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos1034444">
        <span className="bold1">
          <sup className="calibre7">19</sup>And make one Cherub on the one end,
          and the other Cherub on the other end: even of the Mercy Seat shall
          you make the Cherubims on the two ends thereof.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And the Cherubims shall stretch
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And you shall put the Mercy Seat
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And there I will meet with you, and
          I will commune with you from above the Mercy Seat, from between the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Righteousness and Holiness. Concerning this, Mackintosh says:
                Thus it is that the soul of the believing sinner finds peace. He
                sees that Gods Righteousness and His Justification rest upon
                precisely the same basis, namely Christs accomplished Work. When
                man, under the powerful action of the Truth of God, takes his
                place as a sinner, God can, in the exercise of Grace, take His
                place as a Saviour, and then every question is settled, for the
                Cross having answered all the claims of Divine Justice, Mercys
                copious streams can flow unhindered. When a Righteous God and a
                ruined sinner meet on a Blood-sprinkled platform, all is settled
                forever settled in such a way as perfectly glorifies God, and
                eternally saves the sinner.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">TABLE OF SHEWBREAD</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">23</sup>You shall also make a Table of
          Shittim Wood{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And you shall overlay it with Pure
          Gold{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And you shall make unto it a border
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/john-10" scrollToId="#filepos12521317">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 10:28</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Israel was instructed by the Lord to move. This speaks of the
                security of the Believer, all in Christ.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And you shall make for it four rings
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>Over against the border shall the
          rings be for places of the staves to bear the Table.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>And you shall make the staves of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                such as Paul, the Believer can continue to feed on Christ, for
                Christ is ever with him.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">29</sup>And you shall make the dishes
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                to be poured over the Bread, symbolizing the Fragrance and
                Purity of Christ. The bowls were probably cups, and were used in
                connection with the Drink Offerings, which were poured out
                before the Lord in the Holy Place [
                <ScrollLink href="/numbers-28" scrollToId="#filepos2025040">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 28:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And you shall set upon the Table
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/john-06" scrollToId="#filepos12424800">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 6:58</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. Christ is always before the Father, making Intercession for
                us [
      ...
      <p className="calibre_20">
        <span className="bold1">GOLDEN CANDLESTICK</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">31</sup>And you shall make a Candlestick of
          Pure Gold{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                The bowls or cups formed the first ornament on each branch, and
                are likened to almonds, which signify the Resurrection [
                <ScrollLink href="/numbers-17" scrollToId="#filepos1904361">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 17:1-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. The knops could have been translated pomegranates, which
                speak of fruit. The flowers could have been translated lilies,
                and speak of purity. The lily-blossoms supported the lamps,
                which were separate.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>And six branches shall come out of
          the sides of it; three branches of the Lampstand out of the one side,
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/" scrollToId="#filepos1044218">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verse 36</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                tells us that the entirety of the Lampstand was one beaten work
                of pure gold, meaning that these branches were not welded or
                fastened to the side of the main stem, but were rather a part of
                the main stem; this speaks of our being in Christ)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>Three bowls made like unto almonds,
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                represents Resurrection, which speaks of the Cross, is the
                foundation on which everything is based. This is where the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>And in the Lampstand shall be four
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>And there shall be a knop under two
          ...
          that proceed out of the Lampstand.
        </span>
      </p>
      <p className="calibre_21" id="filepos1044218">
        <span className="bold1">
          <sup className="calibre7">36</sup>Their knops and their branches shall
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                with the branch closest to the stem being the shortest. But yet,
                all of them had the same number of ornamentation.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                This tells us that all Believers can enjoy Resurrection Life,
                bear fruit, and develop purity. All done by the Holy Spirit,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">37</sup>And you shall make the seven lamps
          there of{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">38</sup>And the tongs thereof, and the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">39</sup>Of a talent of pure gold shall he
      ...
      <p className="calibre_21" id="filepos1046276">
        <span className="bold1">
          <sup className="calibre7">40</sup>And look that you make them after
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                carried out strictly on Gods Terms, and His Terms alone.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_89"></div>
    </div>
  );
}
