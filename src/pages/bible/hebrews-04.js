...
export default function Hebrews04() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14447661">
        CHAPTER 4
      </h3>
      ...
      <p className="calibre_18" id="filepos14447833">
      ...
      <p className="calibre_21" id="filepos14448468">
        <span className="bold1">
          <sup className="calibre7">2</sup>For unto us was the Gospel Preached,
          ...
          , not being mixed with Faith in them who heard{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>For we which have believed do enter
          into rest{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/genesis-02" scrollToId="#filepos29752">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 2:3</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And in this{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/psalm-095" scrollToId="#filepos6353406">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 95:7-11</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21" id="filepos14451023">
        <span className="bold1">
          <sup className="calibre7">6</sup>Seeing therefore it remains that some
          must enter therein{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                that the Israelites of Old had the same Gospel preached unto
                them as we do, but to no avail)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21" id="filepos14451568">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Let us labour therefore to enter
          into that Rest{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For the Word of God{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                can only be in Christ; as well, the Word of God portrays to us
                the Holy Spirit and His Power, and proclaims the fact that He
                Alone can quicken our mortal bodies [
                ...
                ], which refers to giving us power to yield this physical body
                to that which is Righteous [
                <ScrollLink href="/romans-06" scrollToId="#filepos13353573">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 6:12-13</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Neither is there any creature that
      ...
      <p className="calibre_20">
        <span className="bold1">HIGH PRIEST</span>
      </p>
      <p className="calibre_18" id="filepos14456661">
        <span className="bold1">
          <sup className="calibre7">14</sup>Seeing then that we have a Great
          High Priest{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14457329">
        <span className="bold1">
          <sup className="calibre7">15</sup>For we have not an High Priest Who
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">we are, yet</span>
            </span>
          </span>{" "}
          without sin{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos14457876">
        <span className="bold1">
          <sup className="calibre7">16</sup>Let us therefore come boldly unto
          the Throne of Grace{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1275"></div>
    </div>
  );
}
