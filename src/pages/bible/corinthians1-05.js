...
export default function Corinthians105() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13584838">
        CHAPTER 5
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>It is reported commonly{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">that there is</span>
            </span>
          </span>{" "}
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink
                  ...
                  scrollToId="#filepos13844995"
                >
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Cor. 7:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21" id="filepos13585798">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">JUDGMENT OF SIN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">3</sup>For I verily, as absent in body, but
          present in spirit{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , have judged al ready, as though I were present,{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">concerning</span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                ]. Paul is judging an action here, as all Believers are called
                upon to do, i.e., Fruit [
      ...
      <p className="calibre_21" id="filepos13587360">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13588070">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Church than He will by an individual)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">LEAVEN</span>
      </p>
      <p className="calibre_18" id="filepos13588783">
        <span className="bold1">
          <sup className="calibre7">6</sup>Your glorying{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21" id="filepos13589232">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13590131">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">SOCIAL RELATIONS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Yet not altogether with the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>But now I have written unto you not
          to keep company{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , if any man who is called a brother be a fornicator, or covetous, or
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For what have I to do to judge them
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1180"></div>
    </div>
  );
}
