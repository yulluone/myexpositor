...
export default function Acts18() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13091420">
        CHAPTER 18
      </h3>
      <h3 className="calibre_17">(A.D. 54)</h3>
      <p className="calibre_20">
        <span className="bold1">CORINTH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>After these things Paul departed from
          Athens{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And found a certain Jew named Aquila,
      ...
      <p className="calibre_21" id="filepos13092484">
        <span className="bold1">
          <sup className="calibre7">3</sup>And because he was of the same craft,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And he reasoned in the Synagogue
          every Sabbath{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">SILAS AND TIMOTHY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>And when Silas and Timothy were come
          from Macedonia{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos13093884">
        <span className="bold1">
          <sup className="calibre7">6</sup>And when they opposed themselves, and
          blasphemed{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/acts-19" scrollToId="#filepos13111228">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 19:8</span>
                    </span>
                  </span>
                </ScrollLink>
                ], but that the thrust would be toward the Gentiles)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_20">
        <span className="bold1">THE HOUSE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And Crispus, the Chief Ruler of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Then spoke the Lord to Paul in the
          night by a Vision{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>For I am with you, and no man shall
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And he continued{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And when Gallio was the deputy of
          Achaia{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , the Jews made insurrection with one ac cord against Paul, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Saying, This{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And when Paul was now about to open{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">his</span>
            </span>
          ...
          , If it were a matter of wrong or wicked lewdness, O{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>But if it be a question of words and
          names, and{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                to it (in effect, tells them to settle this thing themselves
                because it had no place in a Roman Court);
              </span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                matters (in essence says, you will not use a Roman Court to
                carry forth your personal schemes!).
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And he drove them from the judgment
          seat{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos13099442">
        <span className="bold1">
          <sup className="calibre7">17</sup>Then all the Greeks took Sosthenes,
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">18</sup>And Paul{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">after this</span>
            </span>
          </span>{" "}
          tarried{" "}
          <span className="italic1">
      ...
      <p className="calibre_20">
        <span className="bold1">ANTIOCH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">THIRD MISSIONARY JOURNEY</span>
      </p>
      <p className="calibre_18" id="filepos13103227">
        <span className="bold1">
          <sup className="calibre7">23</sup>And after he had spent some time{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">there,</span>
            </span>
      ...
      <p className="calibre_20">
        <span className="bold1">APOLLOS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">24</sup>And a certain Jew named Apollos,
      ...
      <p className="calibre_21" id="filepos13104252">
        <span className="bold1">
          <sup className="calibre7">25</sup>This man was instructed in the Way
          of the Lord{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          , he spoke and taught diligently the things of the Lord, knowing only
          the Baptism of John{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And he began to speak boldly in the
      ...
      <p className="calibre_21" id="filepos13105438">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>For he mightily convinced the Jews,{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">and that</span>
            </span>
          </span>{" "}
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1145"></div>
    </div>
  );
}
