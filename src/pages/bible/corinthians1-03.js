...
export default function Corinthians103() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13560396">
        CHAPTER 3
      </h3>
      <h3 className="calibre_17">(A.D. 59)</h3>
      <p className="calibre_20">
        <span className="bold1">THE CARNAL STATE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And I, Brethren, could not speak unto
      ...
      <p className="calibre_21" id="filepos13561088">
        <span className="bold1">
          <sup className="calibre7">2</sup>I have fed you with milk, and not
          with meat{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">to bear it,</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>For while one said, I am of Paul; and
          another, I{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_20">
        <span className="bold1">LABORERS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">5</sup>Who then is Paul, and who{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>So then neither is he who plants any
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Now he who plants and he who waters
          are one{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For we are labourers together with
          God{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">you are</span>
            </span>
          </span>{" "}
          Gods building{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos13565011">
        <span className="bold1">
          <sup className="calibre7">10</sup>According to the Grace of God which
      ...
      <p className="calibre_20">
        <span className="bold1">FOUNDATION</span>
      </p>
      <p className="calibre_18" id="filepos13565823">
        <span className="bold1">
          <sup className="calibre7">11</sup>For other foundation can no man lay
          than that is laid{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now if any man build upon this
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Every mans work shall be made
          manifest{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/revelation-02" scrollToId="#filepos14907537">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rev. 2:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. He Alone knows our very motives!)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos13567498">
        <span className="bold1">
          <sup className="calibre7">14</sup>If any mans work abide which he has
          built thereupon{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>If any mans work shall be burned, he
          shall suffer loss{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_18" id="filepos13568447">
        <span className="bold1">
          <sup className="calibre7">16</sup>Know you not that you are the Temple
          of God{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/romans-12" scrollToId="#filepos13469426">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 12:1</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>For the wisdom of this world is
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/job-05" scrollToId="#filepos5384132">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Job 5:13</span>
                    </span>
                  </span>
                </ScrollLink>
                )
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/psalm-094" scrollToId="#filepos6345081">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 94:11</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>Whether Paul, or Apollos, or Cephas,
      ...
      <p className="calibre_21" id="filepos13572283">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1178"></div>
    </div>
  );
}
