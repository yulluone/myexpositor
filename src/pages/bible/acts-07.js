...
export default function Acts07() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos12856871">
        CHAPTER 7
      </h3>
      <h3 className="calibre_17">(A.D. 33)</h3>
      <p className="calibre_20">
        <span className="bold1">STEPHENS DEFENSE</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then said the High Priest, Are these
          things so?{" "}
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                [
                <ScrollLink href="/genesis-15" scrollToId="#filepos194771">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 15:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And said unto him, Get thee out of
          your country{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Then came he out of the land of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">so much as</span>
            </span>
          </span>{" "}
          to set his foot on{" "}
          <span className="italic1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">as yet</span>
            </span>
          </span>{" "}
          he had no child{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos12859861">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-12" scrollToId="#filepos852732">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 12:40</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/galatians-3" scrollToId="#filepos13941154">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gal. 3:14-17</span>
                    </span>
                  </span>
                </ScrollLink>
                ];
            ...
            <span>
              <span className="calibre_19">
                the 400 years of{" "}
                <ScrollLink href="/genesis-15" scrollToId="#filepos198285">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 15:13</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/" scrollToId="#filepos12859861">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 7:6</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                are to
            ...
            <span>
              <span className="calibre_19">
                be reckoned from the confirmation of Isaac as the seed when
                Ishmael was cast out [
                <ScrollLink href="/genesis-21" scrollToId="#filepos275508">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 21:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/galatians-4" scrollToId="#filepos13965794">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gal. 4:30</span>
                    </span>
                  </span>
                </ScrollLink>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And the nation to whom they shall be
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-01" scrollToId="#filepos680921">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 1:1-14</span>
                    </span>
                  </span>
                </ScrollLink>
                ; 31])
      ...
      <p className="calibre_21">
        <span className="bold1">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-12" scrollToId="#filepos156936">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 12:1-3</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-17" scrollToId="#filepos215756">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">17:9-27</span>
                    </span>
                  </span>
                </ScrollLink>
                , and not the Mosaic Covenant which continued Circumcision, but
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">begat</span>
            </span>
          </span>{" "}
          Jacob; and Jacob{" "}
          <span className="italic1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And the Patriarchs, moved with envy,
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/chronicles1-05" scrollToId="#filepos4415664">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Chron. 5:1-2</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And delivered him out of all his
          afflictions{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Now there came a dearth over all the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>But when Jacob heard that there was
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And at the second{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-45" scrollToId="#filepos598222">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 45:1-28</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Then sent Joseph, and called his
          father Jacob to{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-46" scrollToId="#filepos620469">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 46:27</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/deuteronmy-10" scrollToId="#filepos2225802">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 10:22</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                mention seventy people who went into Egypt, but did not include
                these five)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>So Jacob went down into Egypt, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And were carried over into Sychem,
          and laid in the sepulchre that Abraham bought for a sum of money of
          the sons of Emmor{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">the father</span>
            </span>
          </span>{" "}
          of Sychem{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-23" scrollToId="#filepos300960">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 23:6-20</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-33" scrollToId="#filepos461129">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">33:19</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-47" scrollToId="#filepos635706">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">47:30</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-49" scrollToId="#filepos664791">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">49:29</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-50" scrollToId="#filepos669715">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">50:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ; Ex.{" "}
                <ScrollLink href="/exodus-13" scrollToId="#filepos858885">
                  <span className="calibre_19">
                    <span>
                ...
                ;{" "}
                <ScrollLink href="/exodus-19" scrollToId="#filepos951705">
                  <span className="calibre_19">
                    <span>
                ...
                ;{" "}
                <ScrollLink href="/joshua-24" scrollToId="#filepos2720696">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Josh. 24:32</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; this was in Canaan)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>But when the time of the Promise
          drew near{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>The same dealt subtilly with our
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And Moses was learned in all the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And seeing one{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>For he supposed his brethren would
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And the next day he showed himself
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">27</sup>But he who did his neighbour wrong
          thrust him{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">28</sup>Will you kill me, as you did the
          Egyptian yesterday?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-02" scrollToId="#filepos698138">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 2:14-15</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-02" scrollToId="#filepos701765">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 2:22</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/exodus-18" scrollToId="#filepos941529">
                  <span className="calibre_19">
                    <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-03" scrollToId="#filepos704806">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 3:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/exodus-04" scrollToId="#filepos723863">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">4:17</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>When Moses saw{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          the God of your fathers, the God of Abraham, and the God of Isaac, and
          the God of Jacob{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          , Put off your shoes from your feet: for the place where you stand is
          Holy Ground{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>I have seen, I have seen the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">35</sup>This Moses whom they refused,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">37</sup>This is that Moses, which said unto
          the Children of Israel{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos12878381">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">40</sup>Saying unto Aaron, Make us gods to
          go before us{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          this Moses, which brought us out of the land of Egypt, we know not
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">42</sup>Then God turned, and gave them up to
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">by the space of</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21" id="filepos12881408">
        <span className="bold1">
          <sup className="calibre7">43</sup>Yes, you took up the tabernacle of
          Moloch{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/deuteronmy-18" scrollToId="#filepos2293883">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 18:10</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/kings2-16" scrollToId="#filepos4228341">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Ki. 16:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ; 26:6;{" "}
                ...
                ;{" "}
                <ScrollLink href="/jeremiah-19" scrollToId="#filepos8416771">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jer. 19:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/jeremiah-32" scrollToId="#filepos8627386">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">32:35</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          , and the star of your god Remphan, figures which you made to worship
          them{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/amos-5" scrollToId="#filepos10196170">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Amos 5:25-27</span>
                    </span>
                  </span>
                </ScrollLink>
                ; however, he used the name Babylon while Amos used the name
                Damascus; both were correct)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">44</sup>Our fathers had the tabernacle of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">45</sup>Which also our fathers who came
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/samuel2-06" scrollToId="#filepos3445787">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Sam. 6:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/psalm-132" scrollToId="#filepos6622104">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 132:6</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">48</sup>Howbeit the most High dwells not in
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/kings1-08" scrollToId="#filepos3802878">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">I Ki. 8:27</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">49</sup>Heaven{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">50</sup>Has not My Hand made all these
          things?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21" id="filepos12886550">
        <span className="bold1">
          <sup className="calibre7">51</sup>You stiffnecked and uncircumcised in
          heart and ears{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
          ...
          , you do always resist the Holy Spirit: as your fathers{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">52</sup>Which of the Prophets have not your
          fathers persecuted?{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/matthew-05" scrollToId="#filepos10877977">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 5:12</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/matthew-23" scrollToId="#filepos11214214">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">23:30-31</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/matthew-23" scrollToId="#filepos11215749">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">34-37</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/luke-13" scrollToId="#filepos12025255">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Lk. 13:33-34</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/psalm-068" scrollToId="#filepos6103971">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 68:17</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_20">
        <span className="bold1">THEIR ANSWER</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">54</sup>When they heard these things, they
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">55</sup>But he, being full of the Holy
          Spirit{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/acts-06" scrollToId="#filepos12850578">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Acts 6:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ], but here He is seen standing, as rising to welcome His
                Faithful martyr and to place on his head the Crown of Life)
              </span>
            </span>
          </span>
          ,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">56</sup>And said, Behold, I see the Heavens
          opened{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-01" scrollToId="#filepos12310204">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 1:51</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-17" scrollToId="#filepos12656869">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 17:5</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                ...
                <ScrollLink href="/hebrews-01" scrollToId="#filepos14418043">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 1:3-4</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">58</sup>And cast{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">him</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">59</sup>And they stoned Stephen, calling
          upon{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">60</sup>And he kneeled down, and cried with
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1134"></div>
    </div>
  );
}
