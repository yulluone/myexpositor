...
export default function Corinthians112() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13682416">
        CHAPTER 12
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now concerning Spiritual{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Wherefore I give you to understand,
      ...
      <p className="calibre_20">
        <span className="bold1">DIVERSITIES</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And there are differences of
          Administrations{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And there are diversities of
          Operations{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">PURPOSE</span>
      </p>
      <p className="calibre_18" id="filepos13685329">
        <span className="bold1">
      ...
      <p className="calibre_20">
        <span className="bold1">NINE GIFTS</span>
      </p>
      <p className="calibre_18" id="filepos13685803">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13686864">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ]; this has nothing to do with the Office of the Prophet)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">divers</span>
            </span>
          </span>{" "}
          kinds of Tongues{" "}
          <span className="italic1">
      ...
      <p className="calibre_20">
        <span className="bold1">DISTRIBUTION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">11</sup>But all these work that one and the
          selfsame Spirit{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">ONE BODY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos13688941">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">we be</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>If the foot shall say, Because I am
          not the hand, I am not of the body; is it therefore not of the body?
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And if the ear shall say, Because I
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>If the whole body{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>But now has God set the members
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And if they were all one member,
          where{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">were</span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>But now{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And the eye cannot say unto the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>No, much more those members of the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And those{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">members</span>
            </span>
          </span>{" "}
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">parts</span>
            </span>
          </span>{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>For our comely{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">parts</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>That there should be no schism in
          the body{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">26</sup>And whether one member suffer, all
      ...
      <p className="calibre_21" id="filepos13694438">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                taken their place in the realm of Leadership; as well, this is
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of Tongues, which all do not have, although Baptized with the
                Spirit.)
              </span>
            </span>
          </span>{" "}
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1187"></div>
    </div>
  );
}
