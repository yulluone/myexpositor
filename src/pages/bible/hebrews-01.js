...
export default function Hebrews01() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14416809">
        CHAPTER 1
      </h3>
      ...
      <h3 className="calibre_17">JESUS CHRIST</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>God, Wh o at sundry times and in
          divers manners{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          <span className="italic1">
            ...
            <span>
              <span className="calibre_19">Church Age)</span>
            </span>
          </span>{" "}
          spoken unto us by{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos14418043">
        <span className="bold1">
          <sup className="calibre7">3</sup>Who being the brightness of{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">His</span>
            </span>
      ...
      <p className="calibre_20">
        <span className="bold1">ANGELS</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">4</sup>Being made so much better than the
          Angels{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                greater than the Angels, but this is speaking of Him here as
                man)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/psalm-002" scrollToId="#filepos5675789">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 2:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21" id="filepos14420464">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And of the Angels He said, Who makes
          His Angels spirits{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14421351">
        <span className="bold1">
          <sup className="calibre7">8</sup>But unto the Son{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">He said,</span>
            </span>
          </span>{" "}
          Your Throne, O God,{" "}
          <span className="italic1">
      ...
      <p className="calibre_21" id="filepos14421946">
        <span className="bold1">
          <sup className="calibre7">9</sup>You have loved Righteousness, and
          hated iniquity{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos14422356">
        <span className="bold1">
          <sup className="calibre7">10</sup>And, You, Lord, in the beginning
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And as a vesture shall You fold them
      ...
      <p className="calibre_21" id="filepos14424107">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1272"></div>
    </div>
  );
}
