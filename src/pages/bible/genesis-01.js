...
export default function Genesis01() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos10813">
        CHAPTER 1
      </h3>
      ...
      <h3 className="calibre_17">THE ORIGINAL CREATION</h3>
      <p className="calibre_18" id="filepos11037">
      ...
      <p className="calibre_20">
        <span className="bold1">CHAOS</span>
      </p>
      <p className="calibre_18" id="filepos11766">
        <span className="bold1">
          <sup className="calibre7">2</sup>And the Earth was without form, and
      ...
      <p className="calibre_20">
        <span className="bold1">FIRST DAY</span>
      </p>
      <p className="calibre_18" id="filepos12480">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                says, And the LORD God said [
                <ScrollLink href="/genesis-02" scrollToId="#filepos39090">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 2:18</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/john-01" scrollToId="#filepos12285986">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 1:4-9</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; Gods Word is of such magnitude that light continues to expand
                in the universe at the rate of 186,000 miles a second)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And God saw the light, that it was
          good{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">SECOND DAY</span>
      </p>
      <p className="calibre_18" id="filepos14150">
        <span className="bold1">
          <sup className="calibre7">6</sup>And God said, Let there be a
      ...
      <p className="calibre_20">
        <span className="bold1">THIRD DAY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">9</sup>And God said, Let the waters under
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And God said, Let the Earth bring
          forth grass{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And the Earth brought forth grass,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the evening and the morning were
          the third day{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">FOURTH DAY</span>
      </p>
      <p className="calibre_18" id="filepos17774">
        <span className="bold1">
          <sup className="calibre7">14</sup>And God said, Let there be lights in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And let them be for lights in the
      ...
      <p className="calibre_21" id="filepos18614">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                [regulated them] as light-holders, as measurers of time, and as
                vehicles of revelation [
                <ScrollLink href="/psalm-019" scrollToId="#filepos5757924">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ps. 19</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And God set them in the firmament of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And to rule over the day and over
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>And the evening and the morning were
          the fourth day.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">FIFTH DAY</span>
      </p>
      <p className="calibre_18" id="filepos20297">
        <span className="bold1">
          <sup className="calibre7">20</sup>And God said, Let the waters bring
          forth abundantly the moving creature that has life, and fowl that may
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                contradict the well-known Truth that plants are living
                organisms; only that the life principle of the animal kingdom is
                different from that of the vegetable kingdom)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And God created great whales, and
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                of Genesis, the phrase, after his kind, or similar is used; this
                completely shoots down the theory of evolution; Science has
                never been able to cross that barrier and, in fact, will never
                be able; in other words, there is no such thing as an animal
                that is half fish and half land animal; as well, there is no
                such thing as a fish that is half whale and half shark; the
                barrier regarding the different kinds remains, and ever shall
                remain)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">22</sup>And God blessed them, saying, Be
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                namely, that from living bodies come forth other similar living
                bodies, which is not true of trees and plants; the pear tree,
                for example, does not bring forth another pear tree, but only a
                pear, while a bird produces a bird and a fish a fish, etc.;
                here, then, is a new creative work, for a living body propagates
                others out of itself; in fact, the Blessing of God means
                propagation; His Blessing is just as powerful to propagate as
                His curse is to cut off)
              </span>
            </span>
          </span>
          .
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>And the evening and the morning were
          the fifth day.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">THE SIXTH DAY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">24</sup>And God said, Let the Earth bring
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And God made the beast of the Earth
      ...
      <p className="calibre_21" id="filepos23626">
        <span className="bold1">
          <sup className="calibre7">26</sup>And God said, Let Us make man in Our
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                creative work; image and likeness enable us to have fellowship
                with God; however, it does not mean we are gods, or can become
                gods; in Our Image after Our Likeness actually refers to true
                Righteousness and Holiness [
                <ScrollLink href="/ephesians-4" scrollToId="#filepos14045979">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Eph. 4:24</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                lordship is from the lowest to the highest of the subjects
                placed beneath his sway)
              </span>
            </span>
          </span>
          .
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                ; these are not, therefore, two accounts of the creation of man,
                but one Divine statement)
              </span>
            </span>
          </span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/isaiah-14" scrollToId="#filepos7420917">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isaiah 14</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/ezekiel-28" scrollToId="#filepos9406813">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ezekiel 28</span>
                    </span>
                  </span>
                </ScrollLink>
                , Lucifer ruled this world for an undetermined period of time,
                and did so in Righteousness and Holiness as a beautiful Angel
                created by God; if, in fact, he did rule the world at that time,
                it would stand to reason that there had to be some type of
                creation on the Earth for him to rule; the word replenish refers
                to that creation)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos27178">
        <span className="bold1">
          <sup className="calibre7">29</sup>And God said, Behold, I have given
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                after the Flood [
                <ScrollLink href="/genesis-09" scrollToId="#filepos126006">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 9:3</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And to every beast of the Earth, and
          to every fowl of the air, and to every thing that creeps upon the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And God saw every thing that He had
      ...
      <div className="mbp_pagebreak" id="calibre_pb_11"></div>
    </div>
  );
}
