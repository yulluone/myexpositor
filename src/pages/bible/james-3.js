...
export default function James3() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14636189">
        CHAPTER 3
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">THE TONGUE</span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Behold, we put bits in the horses
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>Behold also the ships, which though{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And the tongue{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>For every kind of beasts, and of
          birds, and of serpents, and of things in the sea, is tamed, and has
      ...
      <p className="calibre_21" id="filepos14639928">
        <span className="bold1">
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                parameters of the Finished Work of Christ on the Cross; He
                demands that we ever make the Cross the Object of our Faith, and
                then He can do mighty things within our lives [
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                changed, but it can only be so by and through the Cross.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos14641034">
        <span className="bold1">
          <sup className="calibre7">9</sup>Therewith bless we God, even the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Out of the same mouth proceeds
      ...
      <p className="calibre_21" id="filepos14641910">
        <span className="bold1">
          <sup className="calibre7">11</sup>Does a fountain send forth at the
          same place sweet{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>Can the fig tree, my Brethren, bear
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">13</sup>Who{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>But if you have bitter envying and
      ...
      <p className="calibre_21" id="filepos14643853">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>For where envying and strife{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is,</span>
            </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>But the wisdom that is from above is
          first pure{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And the Fruit of Righteousness is
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1289"></div>
    </div>
  );
}
