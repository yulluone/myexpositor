...
export default function Corinthians213() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos13904526">
        CHAPTER 13
      </h3>
      <h3 className="calibre_17">(A.D. 60)</h3>
      <p className="calibre_20">
        <span className="bold1">THE PROPOSED VISIT</span>
      </p>
      <p className="calibre_18" id="filepos13904709">
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/deuteronmy-19" scrollToId="#filepos2304032">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Deut. 19:15</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>I told you before, and foretell you,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Since you seek a proof of Christ
          speaking in me{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>For though He was Crucified through
          weakness{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_20">
        <span className="bold1">WARNING OF SIN</span>
      </p>
      <p className="calibre_18" id="filepos13907050">
        <span className="bold1">
          <sup className="calibre7">5</sup>Examine yourselves, whether you be in
          the Faith{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>But I trust that you shall know that
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>For we can do nothing against the
          Truth{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>For we are glad, when we are weak,
          and you are strong{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Therefore I write these things being
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">11</sup>Finally, Brethren, farewell. Be
          perfect{" "}
          <span className="italic1">
            <span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1206"></div>
    </div>
  );
}
