...
export default function Isaiah21() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos7478228">
        CHAPTER 21
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>The burden of the desert of the sea.
          As whirlwinds in the south pass through; so it comes from the desert,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>A grievous vision is declared unto
          me; the treacherous dealer deals treacherously, and the spoiler
          spoils. Go up, O Elam: besiege, O Media; all the sighing thereof have
          I made to cease.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                the command to Elam and to Media to go up and besiege Babylon
                was a Divine command. This was done because of Babylons
                treatment of Israel.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Therefore are my loins filled with
          pain: pangs have taken hold upon me, as the pangs of a woman who
          travails: I was bowed down at the hearing of it; I was dismayed at the
          seeing of it.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>My heart panted, fearfulness
          affrighted me: the night of my pleasure has he turned into fear unto
          me.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Prepare the table, watch in the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>For thus has the Lord said unto me,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And he saw a chariot with a couple of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And he cried, A lion: My lord, I
          stand continually upon the watchtower in the daytime, and I am set in
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And, behold, here comes a chariot of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                fulfillment of the Prophecy. It, in fact, happened exactly as
                stated!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>O my threshing, and the corn of my
          floor: that which I have heard of the LORD of Hosts, the God of
      ...
      <p className="calibre_20">
        <span className="bold1">THE MESSAGE TO DUMAH (EDOM)</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">11</sup>The burden of Dumah. He calls to me
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Evidently, the Edomites appealed to the Prophet as to their
                future. The answer would not be to their liking.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>The watchman said, The morning
          comes, and also the night: if you will enquire, enquire you: return,
          come.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                and are inquiring sincerely, then turn away from your idols and
                come to the Light. But Edom refused the gracious invitation and
                has passed away into the eternal night.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE FATE OF ARABIA</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">13</sup>The burden upon Arabia. In the
          forest in Arabia shall you lodge, O you travelling companies of
          Dedanim.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                silence. And so they have continued unto this day!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>The inhabitants of the land of Tema
          brought water to him who was thirsty, they prevented with their bread
          him who fled.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>For they fled from the swords, from
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>For thus has the Lord said unto me,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And the residue of the number of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                However, they have sinned greatly, and now they were sinning
                against Light, because the Holy Spirit through the Prophet was
                pinpointing to them exactly what was going to take place in the
                near future, even in a year.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_763"></div>
    </div>
  );
}
