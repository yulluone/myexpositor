...
export default function Ezekiel35() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos9519629">
        CHAPTER 35
      </h3>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Israel, which was not only regarded as personal, but was also
                expressive of mans enmity against the People of God in every
                age)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos9520457">
        <span className="bold1">
          <sup className="calibre7">3</sup>And say unto it, Thus says the Lord
          GOD; Behold, O Mount Seir, I am against you, and I will stretch out My
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>I will lay your cities waste, and you
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/ezekiel-25" scrollToId="#filepos9376585">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">25:12-14</span>
                    </span>
                  </span>
                </ScrollLink>
                ], but that Prophecy was several years before the fall of
                Jerusalem. This Prophecy is after the fall of the city and
                concerns itself with Edoms disposition at that time, along with
                their previous sins against Gods People.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Because you have had a perpetual
          hatred, and have shed the blood of the Children of Israel by the force
          of the sword in the time of their calamity, in the time that their
          iniquity had an end{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/genesis-25" scrollToId="#filepos339549">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 25:22</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/genesis-27" scrollToId="#filepos376135">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">27:37</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; however, that which brought all of this to a head was that
                Edom rejoiced at the fall of Jerusalem, and they actually helped
                the Babylonians to kill Israelites. When they did that, they
                crossed the line!)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>Therefore, as I live, says the Lord
          GOD, I will prepare you unto blood, and blood shall pursue you: since
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>Thus will I make Mount Seir most
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>And I will fill his mountains with
          his slain men: in your hills, and in your valleys, and in all your
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>I will make you perpetual
          desolations, and your cities shall not return: and you shall know that
          I am the LORD.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Because you have said, These two
          nations and these two countries shall be mine, and we will possess it;
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                world except this Land. The Palestinians and the Arabs should
                read this Passage, as well!)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Therefore, as I live, says the Lord
          GOD, I will even do according to your anger, and according to your
          envy which you have used out of your hatred against them; and I will
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                her own land, and would in fact perish forever as a nation.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          LORD, and that I have heard all your blasphemies which you have spoken
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>Thus with your mouth you have
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>Thus sa ys the Lord GOD; When the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>As you did rejoice at the
          inheritance of the House of Israel, because it was desolate, so will I
          do unto you: you shall be desolate, O Mount Seir, and all Idumea, even
      ...
      <div className="mbp_pagebreak" id="calibre_pb_906"></div>
    </div>
  );
}
