...
export default function Genesis08() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos115531">
        CHAPTER 8
      </h3>
      ...
      <h3 className="calibre_17">THE WATERS RECEDE</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>And God remembered Noah, and every
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                addressed, whether of judgment or of blessing)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                falls thereon; Noah, on the other hand, is a figure of the
                remnant of Israel, who shall be brought through the deep waters
                of affliction, and through the fire of judgment, and led into
                the full enjoyment of Millennial bliss, in virtue of Gods
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>The fountains also of the deep and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And the waters returned from off the
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/genesis-01" scrollToId="#filepos14150">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Gen. 1:6-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ], it took much longer as it regards the flood of Noahs time;
                while both of these floods were caused by sin, the first by the
                rebellion of Angels, and the second by the rebellion of men, we
                find that the rebellion caused by men requires a far greater
                extent of attention by the Lord; the reason? God gave far
                greater dominion to Adam, i.e., mankind, than He did the Angelic
                creation)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And the Ark rested in the seventh
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                on the seventeenth day of Abib, Christ, our Lord, rose again
                from the dead)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos118535">
        <span className="bold1">
          <sup className="calibre7">5</sup>And the waters decreased continually
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>And it came to pass at the end of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                following year three hundred and sixty-five days)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">7</sup>And he sent forth a raven, which went
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Also he sent forth a dove from him,
          to see if the waters were abated from off the face of the ground;
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>But the dove found no rest for the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And he stayed yet other seven days;
          and again he sent forth the dove out of the Ark;
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And the dove came in to him in the
          evening; and, lo, in her mouth was an olive leaf plucked off: so Noah
          knew that the waters were abated from off the Earth.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>And he stayed yet other seven days;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And it came to pass in the six
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And in the second month, on the
          seven and twentieth day of the month, was the Earth dried.
        </span>
      </p>
      <p className="calibre_20">
        <span className="bold1">LEAVING THE ARK</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>Go forth of the Ark, you, and your
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Bring forth with you every living
          thing that is with you, of all flesh, both of fowl, and of cattle, and
          of every creeping thing that creeps upon the Earth; that they may
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And Noah went forth, and his sons,
          and his wife, and his sons wives with him:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>Every beast, every creeping thing,
          and every fowl, and whatsoever creeps upon the Earth, after their
      ...
      <p className="calibre_20">
        <span className="bold1">NOAHS SACRIFICE</span>
      </p>
      <p className="calibre_18" id="filepos123345">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Noah built an Altar unto the
      ...
      <p className="calibre_21" id="filepos123711">
        <span className="bold1">
          ...
          ; for the imagination of mans heart is evil from his youth; neither
      ...
      <p className="calibre_21" id="filepos124642">
        <span className="bold1">
          <sup className="calibre7">22</sup>While the Earth remained, seedtime
      ...
      <div className="mbp_pagebreak" id="calibre_pb_18"></div>
    </div>
  );
}
