...
export default function Ezekiel17() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos9232275">
        CHAPTER 17
      </h3>
      <h3 className="calibre_17">(594 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">PARABLE OF A GREAT EAGLE: NEBUCHADNEZZAR</span>
      </p>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Son of man, put forth a riddle, and
      ...
      <p className="calibre_21" id="filepos9232913">
        <span className="bold1">
          <sup className="calibre7">3</sup>And say, Thus says the Lord GOD; A
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                highest branch of the cedar, speaks of Jehoiachin being taken
                captive after serving only three months as king of Judah [
                <ScrollLink href="/kings2-24" scrollToId="#filepos4351618">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Ki. 24:8</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
                <ScrollLink href="/kings2-24" scrollToId="#filepos4354577">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">15-16</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21" id="filepos9233765">
        <span className="bold1">
          <sup className="calibre7">4</sup>He cropped off the top of his young
          twigs, and carried it into a land of traffic; he set it in a city of
          merchants.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>He took also of the seed of the land,
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                fruitful, with the land of Judah enjoying prosperity, that is,
                if he had only submitted himself to Nebuchadnezzar, as the Lord
                had directed. However, this he did not do.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos9234712">
        <span className="bold1">
          <sup className="calibre7">6</sup>And it grew, and became a spreading
      ...
      <p className="calibre_20">
        <span className="bold1">THE SECOND GREAT EAGLE: PHARAOH</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>There was also another great eagle
          with great wings and many feathers: and, behold, this vine did bend
          her roots toward him, and shot forth her branches toward him, that he
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>It was planted in a good soil by
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                prosperity. The vine might have borne fruit.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">ZEDEKIAHS REBELLION</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">9</sup>Say you, Thus says the Lord GOD;
          Shall it prosper? shall he not pull up the roots thereof, and cut off
          the fruit thereof, that it wither? it shall wither in all the leaves
          of her spring, even without great power or many people to pluck it up
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Ye s, behold, being planted, shall
          it prosper? shall it not utterly wither, when the east wind touches
      ...
      <p className="calibre_20">
        <span className="bold1">JEHOIACHINS CAPTIVITY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos9237430">
        <span className="bold1">
          <sup className="calibre7">12</sup>Say now to the rebellious house,
          Know you not what these things mean? tell them, Behold, the king of
          Babylon is come to Jerusalem, and has taken the king thereof, and the
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                and{" "}
                <ScrollLink href="/" scrollToId="#filepos9233765">
                  <span className="calibre_19">
                    <span>
                ...
                , which speak of Nebuchadnezzar taking Jehoiachin and the
                princes to Babylon)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And has taken of the kings seed, and
          made a covenant with him, and has taken an oath of him: he has also
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                the Lord expected him to keep it)
              </span>
            </span>
          </span>
          :
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>That the kingdom might be base, that
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                witness for Him. So should they have been His recognized People
                and a Light to lighten the Gentiles. But their rebellion lost
                this prosperity and that glory.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">15</sup>But he rebelled against him in
      ...
      <p className="calibre_21" id="filepos9239734">
        <span className="bold1">
          <sup className="calibre7">16</sup>As I live, says the Lord GOD, surely
          in the place where the king dwells who made him king, whose oath he
          despised, and whose covenant he broke, even with him in the midst of
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                Zedekiah and his counselors were at their highest point, when
                the Chaldeans had in fact raised the siege of Jerusalem in
                anticipation of the arrival of the Egyptian army [
                <ScrollLink href="/jeremiah-37" scrollToId="#filepos8691778">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jer. 37:5-11</span>
                    </span>
                  </span>
                </ScrollLink>
                ]. Ezekiel, like Jeremiah, declared that the relief would be but
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>Neither shall Pharaoh with his
      ...
      <p className="calibre_21" id="filepos9240977">
        <span className="bold1">
          <sup className="calibre7">18</sup>Seeing he despised the oath by
          breaking the covenant, when, lo, he had given his hand, and has done
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">19</sup>Therefore thus says the Lord GOD; As
          I live, surely My Oath that he has despised, and My Covenant that he
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And I will spread My net upon him,
          and he shall be taken in My snare, and I will bring him to Babylon,
          and will plead with him there for his trespass that he has trespassed
          against Me.{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/jeremiah-32" scrollToId="#filepos8613459">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jer. 32:5</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                and{" "}
                <ScrollLink href="/jeremiah-34" scrollToId="#filepos8649029">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">34:4-5</span>
                    </span>
                  </span>
                </ScrollLink>
                , suggest that in his Earthly prison and physical blindness,
                Grace gave Zedekiah inward eyesight and spiritual freedom. In
                other words, it seems that he finally made his peace with God,
                even after long years of rebellion.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And all his fugitives with all his
          bands shall fall by the sword, and they who remain shall be scattered
      ...
      <p className="calibre_18" id="filepos9243085">
        <span className="bold1">
          <sup className="calibre7">22</sup>Thus says the Lord GOD; I will also
          take of the highest branch of the high cedar, and will set it; I will
          crop off from the top of his young twigs a tender one, and will plant
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/" scrollToId="#filepos9243085">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Verses 22 through 24</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                is that of the Messiah. It will take place in the coming Kingdom
                Age)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">23</sup>In the mountain of the height of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And all the trees of the field shall
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                flourish, becoming the most powerful nation in the world. As
                stated, this will be in the coming Kingdom Age.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <div className="mbp_pagebreak" id="calibre_pb_888"></div>
    </div>
  );
}
