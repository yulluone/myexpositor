...
export default function Genesis25() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos331724">
        CHAPTER 25
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(1800 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">KETURAH</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Then again Abraham took a wife, and
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/hebrews-09" scrollToId="#filepos14520659">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Heb. 9:13</span>
                    </span>
                  </span>
                </ScrollLink>
                ], that is, the Jewish Covenant of works, Keturah, the Gentile,
                now appears with her sons; thus is the future pictured)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And she bore him Zimran, and Jokshan,
          and Medan, and Midian, and Ishbak, and Shuah.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>And Jokshan begat Sheba and Dedan.
          And the sons of Dedan were Asshurim, and Letushim, and Leummim.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>And the sons of Midian; Ephah, and
          Epher, and Hanoch, and Abidah, and Eldaah. All these were the children
          of Keturah.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                carried over for many more years, which it no doubt did. With
                God all things are possible! This having been accomplished, the
                nations of the Earth [represented by Keturah and her sons] will
                be raised up as children of Abraham and receive their
                inheritance, which of course speaks of the Church.)
              </span>
            </span>
          </span>
        </span>
      </p>
      <p className="calibre_21" id="filepos333361">
        <span className="bold1">
          <sup className="calibre7">5</sup>And Abraham gave all that he had unto
          Isaac{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>But unto the sons of the concubines,
          which Abraham had, Abraham gave gifts, and sent them away from Isaac
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                fellowship with those who follow the way of the flesh)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">ABRAHAMS DEATH AND BURIAL</span>
      </p>
      <p className="calibre_18" id="filepos334175">
        <span className="bold1">
          <sup className="calibre7">7</sup>And these are the days of the years
          of Abrahams life which he lived, an hundred threescore and fifteen
          years{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Then Abraham gave up the ghost, and
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                which characterized his person and his life was that of Faith,
                and we speak of Faith in Christ and what Christ would do to
                redeem the fallen sons of Adams lost race. It could be said of
                him as it was said of Paul, He fought a good fight, finished the
                course, and kept the faith [
                <ScrollLink href="/timothy2-4" scrollToId="#filepos14370531">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">II Tim. 4:7-8</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>And his sons Isaac and Ishmael buried
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>The field which Abraham purchased of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                Israel, would belong to him; and it yet shall, in the coming
                Kingdom Age.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And it came to pass after the death
          of Abraham, that God blessed his son Isaac; and Isaac dwelt by the
          well Lahai-roi{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_20">
        <span className="bold1">DESCENDANTS OF ISHMAEL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">12</sup>Now these are the generations of
          Ishmael, Abrahams son, whom Hagar the Egyptian, Sarahs handmaid, bore
          unto Abraham{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And these are the names of the sons
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And Mishma, and Dumah, and Massa,
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>Hadar, and Tema, Jetur, Naphish, and
          Kedemah:
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>These are the sons of Ishmael, and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">17</sup>And these are the years of the life
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">18</sup>And they dwelt from Havilah unto
          Shur, that is before Egypt, as you go toward Assyria: and he died in
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                filled the void. That false deity was Muhammad, who has enslaved
                the Arab people from then until now. For there is no freedom
                outside of Christ.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">ESAU AND JACOB</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>And these are the generations of
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Isaac was forty years old when
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">21</sup>And Isaac intreated the LORD for his
      ...
      <p className="calibre_21" id="filepos339549">
        <span className="bold1">
          <sup className="calibre7">22</sup>And the children struggled together
          within her{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                nature and Divine Nature, within the Believer)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                appeared perplexing to her that such an answer to prayer should
                be accompanied by such mysterious suffering)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21" id="filepos340369">
        <span className="bold1">
          <sup className="calibre7">23</sup>And the LORD said unto her, Two
          nations are in your womb, and two manner of people shall be separated
          from your bowels{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                victorious living, which is Jesus Christ and Him Crucified, the
                elder shall serve the younger, meaning that the Divine nature
                will be victorious over the sin nature)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">24</sup>And when her days to be delivered
          were fulfilled, behold, there were twins in her womb.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">25</sup>And the first came out red, all over
      ...
      <p className="calibre_21" id="filepos341837">
        <span className="bold1">
          <sup className="calibre7">26</sup>And after that came his brother out,
      ...
      <p className="calibre_20">
        <span className="bold1">THE BIRTHRIGHT</span>
      </p>
      <p className="calibre_18" id="filepos342533">
        <span className="bold1">
          <sup className="calibre7">27</sup>And the boys grew: and Esau was a
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">30</sup>And Esau said to Jacob, Feed me, I
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">31</sup>And Jacob said, Sell me this day
          your birthright.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                years in the future. It referred to the possession of the
                Covenant Blessing, which included his seed being as the stars of
                the sky and all the families of the Earth being blessed in him.
                As well, it was the progenitorship of the Promised Seed, which
                was the greatest Blessing of all, and spoke of Christ. The
                firstborn was to receive the birthright, and Esau was the
                firstborn.)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">32</sup>And Esau said, Behold, I am at the
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">33</sup>And Jacob said, Swear to me this
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                fulfilled to him, and without the degradation and suffering
                which his own scheming brought upon him.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">34</sup>Then Jacob gave Esau bread and
          pottage of lentiles; and he did eat and drink, and rose up, and went
      ...
      <div className="mbp_pagebreak" id="calibre_pb_35"></div>
    </div>
  );
}
