...
export default function Hebrews08() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos14501833">
        CHAPTER 8
      </h3>
      ...
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Now of the things which we have
          spoken{" "}
      ...
      <p className="calibre_21" id="filepos14502559">
        <span className="bold1">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>For every High Priest is ordained to
      ...
      <p className="calibre_21" id="filepos14503813">
        <span className="bold1">
              ...
              <span className="explanation">
                ...
                <ScrollLink href="/exodus-25" scrollToId="#filepos1046276">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Ex. 25:40</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/numbers-08" scrollToId="#filepos1779223">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Num. 8:4</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_20">
        <span className="bold1">MEDIATOR</span>
      </p>
      <p className="calibre_18" id="filepos14505595">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos14506439">
        <span className="bold1">
          <sup className="calibre7">7</sup>For if that first{" "}
          <span className="italic1">
            <span>
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/jeremiah-31" scrollToId="#filepos8604811">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jer. 31:31</span>
                    </span>
                  </span>
                </ScrollLink>
                )
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">9</sup>Not according to the Covenant that I
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>For this{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="explanation">
                ...
                forever in the hearts and lives of Believers [
            ...
            <span>
              <span className="explanation">
                ...
                <ScrollLink href="/zechariah-08" scrollToId="#filepos10648646">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Zech. 8:8</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>And they shall not teach every man
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>For I will be merciful to their
          unrighteousness{" "}
          <span className="italic1">
            <span>
              <span className="explanation">
      ...
      <p className="calibre_21">
        <span className="bold1">
          ...
          . Now that which decays and waxes old{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">is</span>
            </span>
      ...
      <div className="mbp_pagebreak" id="calibre_pb_1279"></div>
    </div>
  );
}
