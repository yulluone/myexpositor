...
export default function Hosea08() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos10028701">
        CHAPTER 8
      </h3>
      <h3 className="calibre_17">(780 B.C.)</h3>
      <p className="calibre_20">
        <span className="bold1">IDOLATRY OF ISRAEL</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Set the trumpet to your mouth. He
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                He shall come as an eagle against the House of the LORD, refers
                to the Assyrian Monarch. The cause of this, as the last phrase
                implies, was disobedience to the Bible.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>Israel shall cry unto Me, My God, we
          know You.{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/matthew-07" scrollToId="#filepos10930848">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Mat. 7:22</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/john-08" scrollToId="#filepos12486590">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 8:54-55</span>
                    </span>
                  </span>
                </ScrollLink>
                ].)
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">3</sup>Israel has cast off the thing that is
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">4</sup>They have set up kings, but not by
          Me: they have made princes, and I knew it not: of their silver and
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>Your calf, O Samaria, has cast you
          off; My Anger is kindled against them: how long will it be ere they
          attain to innocency?{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">6</sup>For from Israel was it also: the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                concerning most of that presently which goes under the guise of
                Christianity, one also would have to say, the workman made it,
                meaning, therefore, it is not of God.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_20">
        <span className="bold1">DISPERSION OF ISRAEL; JUDGMENT</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">7</sup>For they have sown the wind, and they
          shall reap the whirlwind: it has no stalk: the bud shall yield no
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">8</sup>Israel is swallowed up: now shall
      ...
      <p className="calibre_20">
        <span className="bold1">HARLOTRY AND IDOLATRY</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">9</sup>For they are gone up to Assyria, a
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                by itself, even as stupid and stubborn as that animal is, which
                does so to secure its independence.
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <span className="italic1">
            <span>
              <span className="calibre_19">
                Ephraim has hired lovers, portrays her as not even having as
                much sense as a stupid, wild ass. What an indictment!)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>Yes, though they have hired among
          the nations, now will I gather them, and they shall sorrow a little
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                as a vassal in the inscriptions.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">11</sup>Because Ephraim has made many altars
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">12</sup>I have written to him the great
      ...
      <p className="calibre_21" id="filepos10034827">
        <span className="bold1">
          <sup className="calibre7">13</sup>They sacrifice flesh for the
          sacrifices of My Offerings, and eat it; but the LORD accepts them not;
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>For Israel has forgotten his Maker,
          and built temples; and Judah has multiplied fenced cities: but I will
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                portrays her trusting in these fenced cities and not in Jehovah.
      ...
      <div className="mbp_pagebreak" id="calibre_pb_943"></div>
    </div>
  );
}
