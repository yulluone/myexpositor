...
export default function Genesis02() {
  return (
    <div>
      <h3 className="calibre_15" id="filepos28803">
        CHAPTER 2
      </h3>
      <h3 className="calibre_15">
        <span className="calibre3">
          <span className="calibre_16">(4004 B.C.)</span>
        </span>
      </h3>
      <h3 className="calibre_17">SEVENTH DAY</h3>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">1</sup>Thus the heavens and the Earth were
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">2</sup>And on the seventh day God ended His
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/isaiah-40" scrollToId="#filepos7735453">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Isa. 40:28</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; it simply means that He had finished the work)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21" id="filepos29752">
        <span className="bold1">
          <sup className="calibre7">3</sup>And God blessed the seventh day, and
      ...
      <p className="calibre_18" id="filepos30255">
        <span className="bold1">
          <sup className="calibre7">4</sup>These are the generations of the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                reveals Him as Elohim, mans Creator)
              </span>
            </span>
          </span>
          ,
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">5</sup>And every plant of the field before
      ...
      <p className="calibre_21" id="filepos31920">
        <span className="bold1">
          <sup className="calibre7">6</sup>But there went up a mist from the
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                three, and which rain on day three then brought forth)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21" id="filepos32350">
        <span className="bold1">
          <sup className="calibre7">7</sup>And the LORD God formed man of the
          dust of the ground{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                comes automatically at conception)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">THE GARDEN OF EDEN</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">8</sup>And the LORD God planted a Garden
          eastward in Eden{" "}
          <span className="italic1">
            <span>
              <span className="calibre_19">
      ...
      <p className="calibre_21" id="filepos33660">
        <span className="bold1">
          <sup className="calibre7">9</sup>And out of the ground made the LORD
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/genesis-03" scrollToId="#filepos60477">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">3:22</span>
                    </span>
                  </span>
                </ScrollLink>{" "}
                says as much! the Tree of Life had the power of so renewing mans
                physical energies that his body, though formed of the dust of
                the ground and, therefore, naturally mortal, would, by its
                continual use, live on forever; Christ is now to us the Tree of
                Life [
                <ScrollLink href="/revelation-02" scrollToId="#filepos14901072">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rev. 2:7</span>
                    </span>
                  </span>
                </ScrollLink>
                ;{" "}
                <ScrollLink href="/revelation-22" scrollToId="#filepos15152142">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">22:2</span>
                    </span>
                  </span>
                </ScrollLink>
                ]; and the Bread of Life [
                <ScrollLink href="/john-06" scrollToId="#filepos12418968">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Jn. 6:48</span>
                    </span>
                  </span>
                </ScrollLink>
                ,{" "}
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">10</sup>And a river went out of Eden to
      ...
      <p className="calibre_21" id="filepos35329">
        <span className="bold1">
      ...
      <p className="calibre_21" id="filepos35658">
        <span className="bold1">
          <sup className="calibre7">12</sup>And the gold of that land is good:
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                and{" "}
                <ScrollLink href="/" scrollToId="#filepos35658">
                  <span className="calibre_19">
                    <span>
                ...
                present the first mention in the Bible of the precious metal,
                gold; it is mentioned last in the Bible as it refers to the main
                thoroughfare of the New Jerusalem, in which we are told is pure
                gold [
                <ScrollLink href="/revelation-21" scrollToId="#filepos15145686">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rev. 21:21</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">13</sup>And the name of the second river is
          Gihon{" "}
          <span className="italic1">
            <span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">14</sup>And the name of the third river is
          Hiddekel{" "}
          <span className="italic1">
            <span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                drastically changed, while the last two remain basically the
                same. In fact, it is believed that the Garden of Eden may have
                been located, as stated, at the joining of the Tigris and
                Euphrates, which is the site of ancient Babylon.)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">15</sup>And the LORD God took the man, and
          put him into the Garden of Eden to dress it and to keep it.
        </span>
      </p>
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">16</sup>And the LORD God commanded the man,
      ...
      <p className="calibre_21" id="filepos37740">
        <span className="bold1">
          <sup className="calibre7">17</sup>But of the Tree of the Knowledge of
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                devised by men in order to bring about Salvation, to reach God,
                or to better oneself in some way; because it is devised by man,
                it is unacceptable to God; Gods answer to the dilemma of the
                human race is Jesus Christ and Him Crucified [
                <ScrollLink
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                obey the Word of God, which is the cause of every single
                failure; spiritual death ultimately brought on physical death,
                and has, in fact, filled the world with death, all because of
                the Fall)
              </span>
            </span>
          </span>
      ...
      <p className="calibre_20">
        <span className="bold1">GODS FORESIGHT FOR MAN</span>
      </p>
      <p className="calibre_18" id="filepos39090">
        <span className="bold1">
          <sup className="calibre7">18</sup>And the LORD God said, It is not
      ...
      <p className="calibre_20">
        <span className="bold1">ADAM AND THE ANIMAL WORLD</span>
      </p>
      <p className="calibre_18">
        <span className="bold1">
          <sup className="calibre7">19</sup>And out of the ground the LORD God
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                intelligence; to do all of this, Adam had to have a distinct
                knowledge of speech, the meaning of all words, and the capacity
                of attaching words to ideas; why not? Adam had the greatest
                Teacher that man has ever had, the LORD God)
              </span>
            </span>
          </span>
        </span>
      ...
      <p className="calibre_21">
        <span className="bold1">
          <sup className="calibre7">20</sup>And Adam gave names to all cattle,
            ...
            <span>
              <span className="calibre_19">
                ...
                <ScrollLink href="/romans-08" scrollToId="#filepos13401963">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Rom. 8:19-23</span>
                    </span>
                  </span>
                </ScrollLink>
                ])
      ...
      <p className="calibre_20">
        <span className="bold1">THE CREATION OF WOMAN</span>
      </p>
      <p className="calibre_18" id="filepos41163">
        <span className="bold1">
          <sup className="calibre7">21</sup>And the LORD God caused a deep sleep
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                seems to mean God paid even more attention to the creation of
                the woman)
              </span>
            </span>
          </span>
          ...
          <span className="italic1">
            <span>
              <span className="calibre_19">
                ...
                God [
                <ScrollLink href="/proverbs-02" scrollToId="#filepos6735489">
                  <span className="calibre_19">
                    <span>
                      <span className="calibre_19">Prov. 2:17</span>
                    </span>
                  </span>
                </ScrollLink>
                ], indicating that God is the Author of this sacred institution;
                this is the marriage model, and was instituted by God; any other
                model, such as the homosexual marriages, so-called, can be
                constituted as none other than an abomination in the Eyes of God
                [
      ...
      <p className="calibre_20">
        <span className="bold1">THE FIRST MARRIAGE UNION</span>
      </p>
      <p className="calibre_18" id="filepos43032">
        <span className="bold1">
          <sup className="calibre7">23</sup>And Adam said, This is now bone of
      ...
      <p className="calibre_21" id="filepos43637">
        <span className="bold1">
          <sup className="calibre7">24</sup>Therefore shall a man leave his
      ...
      <p className="calibre_20">
        <span className="bold1">THE STATE OF INNOCENCE</span>
      </p>
      <p className="calibre_18" id="filepos44196">
        <span className="bold1">
      ...
      <div className="mbp_pagebreak" id="calibre_pb_12"></div>
    </div>
  );
}
